<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KSAIMB_Login.aspx.cs" Inherits="KSAIMB_Login" %>
                        ...
                        <div class="form-box-padd">
                            <div class="col-md-12 form-row">
                                <div class="form-group col-md-12 form-group-new">
                                    <label class="text-style-new" for="inputEmail3"><i class="fa fa-user"></i>&nbsp Nama Pengguna <span class="style1" style="color:red;">*</span></label>
                                     <asp:Textbox type="text" class="form-username form-control" runat="server" ID="Txtuser" placeholder="Username..." MaxLength="12" ></asp:Textbox>
                                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="You can't leave this Empty" CssClass="requiredFieldValidateStyle" ForeColor="Red" ControlToValidate="Txtuser" Display="Dynamic" ValidationGroup="vgSubmit1_login">
                                    </asp:RequiredFieldValidator>
                                </div>
                                <div class="form-group col-md-12 form-group-new">
                                    <label class="text-style-new" for="inputEmail3"><i class="fa fa-unlock-alt"></i>&nbsp Kata Laluan <span class="style1" style="color:red;">*</span></label>
                                     <asp:Textbox type="password" class="form-password form-control" runat="server" ID="Txtpwd" placeholder="Password..."></asp:Textbox>
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="You can't leave this Empty" CssClass="requiredFieldValidateStyle" ForeColor="Red" ControlToValidate="Txtpwd" Display="Dynamic" ValidationGroup="vgSubmit1_login">
                                    </asp:RequiredFieldValidator>
                                </div>
                                <div class="form-group col-md-12">
                                    <div class="col-md-6"><label  style=" color:#fff; font-size:12px; cursor:pointer;  font-family:sans-serif;"><asp:checkbox runat="server" id="pass" onclick="showpass(this);" ></asp:checkbox>&nbsp; Show Password </label></div>
                                      <div class="col-md-6 text-right"><a href="../ksaimb_forgot_pwd.aspx" style="font-weight:bold; color:#fff;"> <i class="fa fa-angle-right"></i> Forgot Password</a></div>
                                </div>
                                <div class="form-group text-center form-group-new-btn">
                                    <label for="inputEmail3"></label>
                                    <asp:button type="submit" runat="server" class="btn btn-primary" ValidationGroup="vgSubmit1_login" OnClientClick=" if ( Page_ClientValidate() ) { this.value='Please wait..';this.style.display='none';getElementById('bWait1').style.display = '';  }" Text="Log Masuk" OnClick="Button1_Click"></asp:button>
