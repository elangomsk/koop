<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../keanggotan/LK_RINGKASAN.aspx.cs" Inherits="LK_RINGKASAN" %>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                         ...
                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="You can't leave this Empty" CssClass="requiredFieldValidateStyle" ForeColor="Red" ControlToValidate="f_date" ValidationGroup="vgSubmit_lkrn_simp">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="You can't leave this Empty" CssClass="requiredFieldValidateStyle" ForeColor="Red" ControlToValidate="t_date" ValidationGroup="vgSubmit_lkrn_simp">
                                    </asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                  ...
                                  <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">  <asp:Label ID="ps_lbl10" runat="server"></asp:Label> <span style="color: Red">*</span></label>
                                    <div class="col-sm-8">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="You can't leave this Empty" CssClass="requiredFieldValidateStyle" ForeColor="Red" ControlToValidate="DD_STS_ANGGO" ValidationGroup="vgSubmit_lkrn_simp">
                                    </asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>  
                     ...
                     <div class="row">
                            ...
                            <div class="col-md-12 box-body" style="text-align:center;">
                                  <asp:Button ID="Button2" runat="server" class="btn btn-primary" Text="Carian" UseSubmitBehavior="false" onclick="Button2_Click" ValidationGroup="vgSubmit_lkrn_simp"/>                                                                
                ...
                <div class="col-md-8 box-body">
                 ...
                 <div id="divImage" class="text-center" style="display:none; padding-top: 30px; font-weight:bold;">
                     <asp:Image ID="img1" runat="server" ImageUrl="../dist/img/LoaderIcon.gif" />&nbsp;&nbsp;&nbsp;Processing Please wait ... </div>  
                                  <rsweb:ReportViewer ID="RptviwerLKringkasan" runat="server" Width="100%" Height="100%" ZoomMode="PageWidth" SizeToReportContent="True"></rsweb:ReportViewer>
