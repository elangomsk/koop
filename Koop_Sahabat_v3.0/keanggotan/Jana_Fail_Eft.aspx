<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../keanggotan/Jana_Fail_Eft.aspx.cs" Inherits="Jana_Fail_Eft" %>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                          <asp:DropDownList ID="ddbatch" style="width:100%; font-size:13px;" runat="server" class="form-control select2 validate[optional]">
                                                                    </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="You can't leave this Empty" CssClass="requiredFieldValidateStyle" ForeColor="Red" ControlToValidate="ddbatch" ValidationGroup="vgSubmit_jeft_simp">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                          <asp:DropDownList ID="ddkaw" style="width:100%; font-size:13px;" runat="server" class="form-control select2 validate[optional]"                                                                        >
                                                                    </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
        ...
        <ContentTemplate>
                             ...
                             <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                          <asp:DropDownList ID="ddcaw" style="width:100%; font-size:13px;" runat="server" class="form-control select2 validate[optional]" >
                                                                    </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                          <asp:DropDownList ID="ddwil" style="width:100%; font-size:13px;" runat="server" class="form-control select2 validate[optional]"   autopostback="true" onselectedindexchanged="ddwil_SelectedIndexChanged"
                                                                       >
                                                                    </asp:DropDownList>
                                    </div>
                                </div>
                                  ...
                                  <div class="col-md-12">
                                                             ...
                                                             <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-8 col-sm-1">
                                                                    <label>
                                                                        <asp:CheckBox ID="s_bank" runat="server" CssClass="mycheckbox" Text="Tiada Akaun Bank"/>
                                                                    </label>
                                                                </div>
                                                            </div>      
                                      </div>                                                    
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-12 box-body" style="text-align:center;">
                                    <asp:Button ID="Button2" runat="server" class="btn btn-danger" Text="Jana Fail EFT" onclick="ExportTextFile" ValidationGroup="vgSubmit_jeft_simp" />
                                            <asp:Button ID="Button3" runat="server" class="btn btn-danger" Text="Cetak" UseSubmitBehavior="false" Visible="false"/>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="BIL">  
             ...
             <asp:TemplateField HeaderText="TINDAKAN">
                                                             <ItemStyle HorizontalAlign="center" Width="10%"></ItemStyle>
                                                            <ItemTemplate>
                                                             <asp:LinkButton runat="server" ID="lnkView1" OnClick="DownloadFile">
                                                                <asp:Label ID="lbl3" runat="server" Text='Download'></asp:Label>
                                                                </asp:LinkButton>&nbsp; | &nbsp;
                                                                 <asp:LinkButton runat="server" ID="lnkView2" OnClick="DeleteFile" OnClientClick="if (!confirm('Adakah Anda pasti?')) return false;">
