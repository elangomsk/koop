...
public partial class Mak_Dan_Tin_Adu_pih_pa : System.Web.UI.Page
{
    ...
    void bind()
    {
        ...
        string userid = Session["new"].ToString();
            ...
            if (ddlvl1.Rows.Count > 0)
            {
                ...
                ddsha = Con.Ora_Execute_table("update mem_complaint_action set act_feedback='" + txtmak1.Text + "',act_action='" + Txttin1.Text + "',act_sts_cd='" + DDSTS.SelectedItem.Value + "',act_upd_id='" + Txtnama1.Text + "',aact_upd_dt='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "' where act_user_lvl_ind='4' and act_comp_id='" + Label2.Text + "'");
                DataTable ddcom = new DataTable();
            ...
            service.audit_trail("P0217", "Kemaskini", "Pengadu", Txtpen.Text);
            ...
            {
                string Inssql = "insert into mem_complaint_action(act_comp_id,act_feedback,act_action,act_sts_cd,act_user_lvl_ind,act_crt_id,act_crt_dt,act_upd_id)values('" + Label2.Text + "','" + txtmak1.Text + "','" + Txttin1.Text + "','" + DDSTS.SelectedItem.Value + "','4','" + Txtnama1.Text + "' ,'" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "','')";
                Status = Con.Ora_Execute_CommamdText(Inssql);
                DataTable ddcom = new DataTable();
                ddcom = Con.Ora_Execute_table("update mem_complaint set com_sts_cd='" + DDSTS.SelectedItem.Value + "' ,com_upd_dt='" + DateTime.UtcNow.ToString() + "',com_upd_id='" + userid + "' where comp_id='" + Label2.Text + "' and Acc_sts ='Y'");
            Button1.Text = "Kemaskini";
            service.audit_trail("P0217", "Simpan", "Pengadu", Txtpen.Text);
    ...
    {
        Response.Redirect("../keanggotan/Mak_Dan_Tin_Adu_pa.aspx");
    }
