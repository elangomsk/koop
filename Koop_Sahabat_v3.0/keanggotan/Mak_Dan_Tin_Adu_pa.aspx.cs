...
public partial class Mak_Dan_Tin_Adu_pa : System.Web.UI.Page
{
    ...
    void assgn_roles()
    {
        ...
        if (ddokdicno.Rows.Count != 0)
        {
            ...
            ddokdicno_1 = DBCon.Ora_Execute_table("select m1.*,s1.ctrl_type from KK_Role_skrins m1 left join KK_PID_Kumpulan s1 on s1.KK_kumpulan_id=Role_id  where psub_skrin_id='P0217' and Role_id IN ('" + ddokdicno.Rows[0]["KK_roles"].ToString().Replace(",", "','") + "')");
            ...
            if (e.CommandName == "Remove" || e.CommandName == "Add")
            {
                ...
                switch (e.CommandName)
                {
                    case "Add":
                        ...
                        Response.Redirect("~/keanggotan/Mak_Dan_Tin_Adu_pih_pa.aspx?State=" + statename + "", false);
                        if (Session["New"] != null)
                        {
