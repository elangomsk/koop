<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../keanggotan/Daftar_aduan_view.aspx.cs" Inherits="Daftar_aduan_view" %>
                                                                ...
                                                                <asp:TemplateField HeaderText="NO KP BARU" ItemStyle-HorizontalAlign="center" ItemStyle-Width="10%">
                                                                    <ItemTemplate>
                                                                       <%-- <asp:LinkButton runat="server" ID="lnkView" OnClick="lnkView_Click" Font-Bold Font-Underline>--%>
                                                                            <asp:Label ID="gd_1" runat="server" Text='<%# Eval("com_dt") %>'></asp:Label>
                                                                           
                                                                       <%-- </asp:LinkButton>--%>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Jenis Aduan" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="15%">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="gd_2" runat="server" Text='<%# Eval("type1") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:BoundField DataField="kat1" HeaderText="Kategori" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="10%" />
                                                                <asp:BoundField DataField="com_remark" HeaderText="Butiran Aduan" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%" />
                                                            </Columns>
