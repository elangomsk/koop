<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="Lp_Permoh_Tidak_Lulus.aspx.cs" Inherits="keanggotan_Lp_Permoh_Tidak_Lulus" %>
       ...
       <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper">
                    ...
                    <section class="content-header">
                        <h1>  Permohonan Tidak Lulus  </h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i> Laporan Keanggotaan </a></li>
                            <li class="active">  Permohonan Tidak Lulus </li>
                        </ol>
                    </section>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label"> Jenis  Permohonan<span style="color: Red">*</span> </label>
                                    <div class="col-sm-8">
                                             <asp:DropDownList ID="DD_STS_ANGGO" style="width:100%; font-size:13px;" runat="server" class="form-control select2 validate[optional]">
                                                 ...
                                                 <asp:ListItem Value="01">Permohonan Anggota Baharu</asp:ListItem>
                                                 <asp:ListItem Value="02">Permohonan Tambahan Syer</asp:ListItem>
                                                 <asp:ListItem Value="03">Permohonan PST-SHM</asp:ListItem>
