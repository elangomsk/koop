<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../keanggotan/Pegesahan_Tambah_Syer1.aspx.cs" Inherits="Pegesahan_Tambah_Syer1" %>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="form-horizontal">
                           ...
                           <div class="box-body">&nbsp;
                            ...
                            <div class="box-header with-border" id="disp_hdr_txt" runat="server" visible="true">
                             <div class="box-header with-border">
                            <h3 class="box-title"> <asp:Label ID="ps_lbl9" runat="server"></asp:Label> </h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body">&nbsp;</div>
                                     ...
                                     <asp:GridView ID="gvSelected" runat="server" class="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="30" ShowFooter="false" GridLines="None"  OnPageIndexChanging="gvSelected_PageIndexChanging" >
                                        ...
                                        <Columns>
                                            ...
                                            <ItemTemplate>  
                                                ...
                                                <asp:Label Visible="false" ID="Label6" runat="server" Text='<%# Bind("mem_staff_ind") %>'></asp:Label> 
                                                <asp:Label Visible="false" ID="lb_stscd" runat="server" Text='<%# Bind("sha_txn_dt") %>'></asp:Label> 
                                            </ItemTemplate>  
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="JENIS SYER">   
                                            <ItemTemplate>  
                                                <asp:Label ID="Label7" runat="server" Text='<%# Eval("sha_reference_ind").ToString() == "C" ? "TUNAI" : "PST" %>'></asp:Label> 
                                            </ItemTemplate>  
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="JUMLAH SYER MODEL (RM)">   
                                                <ItemStyle HorizontalAlign="Right" /> 
                                            <ItemTemplate  >  
                                                <asp:Label ID="Label8" runat="server" Text='<%# Bind("sha_debit_amt","{0:n}") %>' ></asp:Label> 
                                            </ItemTemplate>  
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="STATUS KELULUSAN" ItemStyle-HorizontalAlign="Center">   
                                            <ItemTemplate>  
                                                <asp:RadioButton ID="chkSelect_1" Text="&nbsp;Sah" runat="server" GroupName="status" Checked="true" />
                                                &nbsp;&nbsp;
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-12 box-body" style="text-align:center;">
                                   <asp:Button ID="Button3" runat="server" class="btn btn-danger" Visible="false" Text="Simpan"  OnClick="submit_button"/>
                                        <asp:Button ID="Button4" runat="server" class="btn btn-default" Visible="false" Text="Set Semula" usesubmitbehavior="false" OnClick="Reset_btn"/>
