<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="Mak_Dan_Tin_Adu_pih.aspx.cs" Inherits="keanggotan_Mak_Dan_Tin_Adu_pih" %>
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                  <label for="inputEmail3" class="col-sm-3 control-label">   Pengadu :</label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="Txtpen" runat="server"  class="form-control validate[optional,custom[onlyLetterNumberSp]] uppercase" MaxLength="12"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                 <label for="inputEmail3" class="col-sm-3 control-label">  Kategori : </label>
                                   ...
                                   <div class="box-header with-border" >
                            <h3 class="box-title"> Maklumbalas Dan Tindakan Penerima Aduan  </h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body">&nbsp;</div>
                           ...
                           <div class="box-header with-border">
                            <h3 class="box-title"> Maklumbalas Dan Tindakan Ketua Jabatan </h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body">&nbsp;</div>
                            ...
                            <div class="col-md-6 box-body">
                              ...
                              <label for="inputEmail3" class="col-sm-3 control-label">     Status :</label>
                                    <div class="col-sm-8">
                                          <asp:DropDownList ID="ddsts1" runat="server" class="form-control" style="text-transform:uppercase;"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-12 col-sm-4" style=" text-align:center;">
                                                <div class="body collapse in">
                                                            <asp:Button ID="Button1" runat="server" class="btn btn-danger" Text="Simpan" onclick="Button1_Click" />
                                                              <asp:Button ID="Button2" runat="server" class="btn btn-danger" UseSubmitBehavior="false" Text="Set Semula" onclick="Button2_Click" />
                                                                <asp:Button ID="Button4" runat="server" class="btn btn-danger" UseSubmitBehavior="false" Text="Kembali" onclick="Button4_Click"  />
                                                                <asp:Button ID="Button3" runat="server" class="btn btn-danger" UseSubmitBehavior="false" Text="Kembali" onclick="Button3_Click" />
                                                                 <asp:Button ID="Button5" runat="server" class="btn btn-danger" OnClientClick="document.forms[0].target ='_blank';"  UseSubmitBehavior="false" Text="Cetak" onclick="Button5_Click"  />
                                            </div>
                                            </div>
                                            </div>
                                             <div class="row">
