<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../keanggotan/LK_Tampahan_yer.aspx.cs" Inherits="LK_Tampahan_yer" %>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                            <asp:DropDownList ID="rpt_type" style="width:100%; font-size:13px;" runat="server" class="form-control select2 validate[optional]">
                                                                    <asp:ListItem Value="01">SENERAI</asp:ListItem>
                                                                    <asp:ListItem Value="02">RINGKASAN</asp:ListItem>
                                                                </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
