<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../keanggotan/LK_SENARI.aspx.cs" Inherits="LK_SENARI" %>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                           ...
                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="You can't leave this Empty" CssClass="requiredFieldValidateStyle" ForeColor="Red" ControlToValidate="f_date" ValidationGroup="vgSubmit_lksn_simp">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                           ...
                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="You can't leave this Empty" CssClass="requiredFieldValidateStyle" ForeColor="Red" ControlToValidate="t_date" ValidationGroup="vgSubmit_lksn_simp">
                                    </asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">   <asp:Label ID="ps_lbl11" runat="server"></asp:Label> <span style="color: Red">*</span> </label>
                                    <div class="col-sm-8">
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-12 box-body" style="text-align:center;">
                                      <asp:Button ID="Button2" runat="server" class="btn btn-primary" Text="Carian"  UseSubmitBehavior="false" onclick="Button2_Click" ValidationGroup="vgSubmit_lksn_simp" />                                                                
