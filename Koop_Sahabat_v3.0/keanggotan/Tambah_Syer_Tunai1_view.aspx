<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../keanggotan/Tambah_Syer_Tunai1_view.aspx.cs" Inherits="Tambah_Syer_Tunai1_view" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper">
                    ...
                    <section class="content-header">
                        <h1>Senerai Tambah Syer Tunai</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>Keanggotaan</a></li>
                            <li class="active">Senerai Tambah Syer Tunai</li>
                        </ol>
                    </section>
