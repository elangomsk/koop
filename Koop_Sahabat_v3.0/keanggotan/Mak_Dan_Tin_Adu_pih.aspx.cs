...
public partial class keanggotan_Mak_Dan_Tin_Adu_pih : System.Web.UI.Page
{
    ...
    void bind()
    {
        ...
        if (level == "4")
        {
            ...
            ddlvl1 = Con.Ora_Execute_table("select act_comp_id from mem_complaint_action where act_comp_id='" + Label2.Text + "' and  act_user_lvl_ind='4'");
            if (ddlvl1.Rows.Count > 0)
            {
                DataTable ddsha = new DataTable();
                ddsha = Con.Ora_Execute_table("update mem_complaint_action set act_feedback='" + txtmak1.Text + "',act_action='" + Txttin1.Text + "',act_sts_cd='" + DDSTS.SelectedItem.Value + "',act_upd_id='" + Txtnama1.Text + "',aact_upd_dt='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "' where act_user_lvl_ind='" + level + "' and act_comp_id='" + Label2.Text + "'");
                DataTable ddcom = new DataTable();
                ddcom = Con.Ora_Execute_table("update mem_complaint set com_sts_cd='" + DDSTS.SelectedItem.Value + "' ,com_upd_dt='" + DateTime.UtcNow.ToString() + "',com_upd_id='" + userid + "' where comp_id='" + Label2.Text + "' and Acc_sts ='Y' ");
                service.audit_trail("P0133", "Kemaskini", "Pengadu", Txtpen.Text);
            ...
            {
                string Inssql = "insert into mem_complaint_action(act_comp_id,act_feedback,act_action,act_sts_cd,act_user_lvl_ind,act_crt_id,act_crt_dt,act_upd_id)values('" + Label2.Text + "','" + txtmak1.Text + "','" + Txttin1.Text + "','" + DDSTS.SelectedItem.Value + "','" + level + "','" + Txtnama1.Text + "' ,'" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "','')";
                Status = Con.Ora_Execute_CommamdText(Inssql);
                DataTable ddcom = new DataTable();
                ddcom = Con.Ora_Execute_table("update mem_complaint set com_sts_cd='" + DDSTS.SelectedItem.Value + "' ,com_upd_dt='" + DateTime.UtcNow.ToString() + "',com_upd_id='" + userid + "' where comp_id='" + Label2.Text + "' and Acc_sts ='Y'");
                service.audit_trail("P0133", "Simpan", "Pengadu", Txtpen.Text);
        ...
        else if (level == "5")
        {
            ...
            {
                DataTable ddsha = new DataTable();
                ddsha = Con.Ora_Execute_table("update mem_complaint_action set act_feedback='" + Txtmak2.Text + "',act_action='" + Txttin2.Text + "',act_sts_cd='" + ddsts1.SelectedItem.Value + "',act_upd_id='" + txtnama2.Text + "',aact_upd_dt='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "' where act_user_lvl_ind='" + level + "' and act_comp_id='" + Label2.Text + "'");
                DataTable ddcom = new DataTable();
                ddcom = Con.Ora_Execute_table("update mem_complaint set com_sts_cd='" + ddsts1.SelectedItem.Value + "' ,com_upd_dt='" + DateTime.UtcNow.ToString() + "',com_upd_id='" + userid + "' where comp_id='" + Label2.Text + "' and Acc_sts ='Y'");
                service.audit_trail("P0133", "Kemaskini", "Pengadu", Txtpen.Text);
                ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "$.Zebra_Dialog('Rekod Berjaya Dikemaskini',{'type': 'confirmation','title': 'Success','auto_close': 2000});", true);
            ...
            {
                string Inssql = "insert into mem_complaint_action(act_comp_id,act_feedback,act_action,act_sts_cd,act_user_lvl_ind,act_crt_id,act_crt_dt,act_upd_id)values('" + Label2.Text + "','" + Txtmak2.Text + "','" + Txttin2.Text + "','" + ddsts1.SelectedItem.Value + "','" + level + "','" + txtnama2.Text + "' ,'" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "','')";
                Status = Con.Ora_Execute_CommamdText(Inssql);
                DataTable ddcom = new DataTable();
                ddcom = Con.Ora_Execute_table("update mem_complaint set com_sts_cd='" + ddsts1.SelectedItem.Value + "' ,com_upd_dt='" + DateTime.UtcNow.ToString() + "',com_upd_id='" + userid + "' where comp_id='" + Label2.Text + "' and Acc_sts ='Y'");
                service.audit_trail("P0133", "Simpan", "Pengadu", Txtpen.Text);
            ...
            DataTable ddlvl1 = new DataTable();
            string sts;
            ddlvl1 = Con.Ora_Execute_table(" select act_comp_id from mem_complaint_action where act_comp_id='" + Label2.Text + "' and  act_user_lvl_ind='5'");
            ...
            if (ddlvl1.Rows.Count > 0)
            {
                ...
                DataTable ddsha = new DataTable();
                ddsha = Con.Ora_Execute_table("update mem_complaint_action set act_action='" + Txttin3.Text + "',act_sts_cd='" + sts + "',act_upd_id='" + txtnama3.Text + "',aact_upd_dt='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "' where act_user_lvl_ind='" + level + "' and act_comp_id='" + Label2.Text + "'");
                DataTable ddcom = new DataTable();
                ddcom = Con.Ora_Execute_table("update mem_complaint set com_sts_cd='" + sts + "' ,com_upd_dt='" + DateTime.UtcNow.ToString() + "',com_upd_id='" + userid + "' where comp_id='" + Label2.Text + "' and Acc_sts ='Y'");
                service.audit_trail("P0133", "Kemaskini", "Pengadu", Txtpen.Text);
                ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "$.Zebra_Dialog('Rekod Berjaya Dikemaskini.',{'type': 'confirmation','title': 'Success','auto_close': 2000});", true);
            }
            else
            {
                string Inssql = "insert into mem_complaint_action(act_comp_id,act_feedback,act_action,act_sts_cd,act_user_lvl_ind,act_crt_id,act_crt_dt,act_upd_id)values('" + Label2.Text + "','','" + Txttin3.Text + "','" + sts + "','" + level + "','" + txtnama3.Text + "' ,'" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "','')";
                Status = Con.Ora_Execute_CommamdText(Inssql);
                DataTable ddcom = new DataTable();
                ddcom = Con.Ora_Execute_table("update mem_complaint set com_sts_cd='" + sts + "' ,com_upd_dt='" + DateTime.UtcNow.ToString() + "',com_upd_id='" + userid + "' where comp_id='" + Label2.Text + "' and Acc_sts ='Y'");
                service.audit_trail("P0133", "Simpan", "Pengadu", Txtpen.Text);                
    ...
    void lvl1()
    {
        ...
        //    Txtnama1.ReadOnly = true;
        //    txtmak1.ReadOnly = true;
        //    Txttin1.Visible = false;
        //    DDSTS.Enabled = false;
        //    txtnama2.ReadOnly = true;
        //    txtcdate1.ReadOnly = true;
        //    Txtmak2.ReadOnly = true;
        //    Txttin2.Visible = false;
        //    Txttin3.Visible = false;
        //    ddsts1.Enabled = false;
        //    txtnama3.ReadOnly = true;
        //    Txtcdate3.ReadOnly = true;
        //    Button1.Enabled = false;
    ...
    void lvl4()
    {
        try
        {
            ...
            if (DDTLVL.Rows.Count != 0)
            {
                ...
                ddsts1.SelectedItem.Text = DDTLVL.Rows[0][3].ToString();
                //ddsts1.Enabled = false;
    ...
    {
        Response.Redirect("../keanggotan/Mak_Dan_Tin_Adu.aspx");
    }
