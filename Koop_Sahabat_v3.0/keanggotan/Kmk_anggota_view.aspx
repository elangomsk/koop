<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../keanggotan/Kmk_anggota_view.aspx.cs" Inherits="Kmk_anggota_view" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper">
                    ...
                    <section class="content-header">
                        <h1>Senerai Kemaskini Kad Keanggotaan</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>Keanggotaan</a></li>
                            <li class="active">Senerai Kemaskini Kad Keanggotaan</li>
                        </ol>
                    </section>
                                                                ...
                                                                <asp:TemplateField HeaderText="NO KP BARU" ItemStyle-HorizontalAlign="center" ItemStyle-Width="10%">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton runat="server" ID="lnkView" OnClick="lnkView_Click" Font-Bold Font-Underline>
                                                                            <asp:Label ID="gd_1" runat="server" Text='<%# Eval("rak_new_icno") %>'></asp:Label>                                                                            
                                                                        </asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="No Akaun" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="15%">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="gd_2" runat="server" Text='<%# Eval("rak_bank_acc_no") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                 <asp:BoundField DataField="Bank_Name" HeaderText="Nama Bank" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="10%" />
                                                                   <asp:TemplateField HeaderText="Tarikh Hantar Borang" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="15%">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="gd_3" runat="server" Text='<%# Eval("com_dt") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>                                                               
                                                                <asp:BoundField DataField="discription" HeaderText="Status Permohonan" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%" />
                                                            </Columns>
