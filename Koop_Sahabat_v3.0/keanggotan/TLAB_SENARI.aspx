<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../keanggotan/TLAB_SENARI.aspx.cs" Inherits="TLAB_SENARI" %>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="form-horizontal">
                           ...
                           <div class="box-body">&nbsp;
                            ...
                            <h3 class="box-title"> Laporan <asp:Label ID="disp_sts" Visible="false" runat="server"></asp:Label> <asp:Label ID="ps_lbl14" runat="server"></asp:Label></h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body">&nbsp;</div>
