<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../keanggotan/Penyelesaian_Anggota1_view.aspx.cs" Inherits="Penyelesaian_Anggota1_view" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper">
                    ...
                    <section class="content-header">
                        <h1>Senerai Penyelesaian Anggota</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>Keanggotaan</a></li>
                            <li class="active">Senerai Penyelesaian Anggota</li>
                        </ol>
                    </section>
