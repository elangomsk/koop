<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../keanggotan/TLAB_SENARI_RK.aspx.cs" Inherits="TLAB_SENARI_RK" %>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                         ...
                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="You can't leave this Empty" CssClass="requiredFieldValidateStyle" ForeColor="Red" ControlToValidate="f_date" ValidationGroup="vgSubmit_divs_simp">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                            <div class="input-group">
                                                      ...
                                                      <asp:TextBox ID="t_date" runat="server" class="form-control datepicker mydatepickerclass"
                                                                    placeholder="PICK DATE"></asp:TextBox>
                                                 <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                       </div>
                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="You can't leave this Empty" CssClass="requiredFieldValidateStyle" ForeColor="Red" ControlToValidate="t_date" ValidationGroup="vgSubmit_divs_simp">
                                    </asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-8">
                                            <asp:DropDownList ID="DD_STS_ANGGO" style="width:100%; font-size:13px;" runat="server" class="form-control select2 validate[optional]">
                                                              <%--  <asp:ListItem Value="00">--- PILIH ---</asp:ListItem>--%>
                                                                    <asp:ListItem Value="SA">SAH</asp:ListItem>
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-12 box-body" style="text-align:center;">
                                      <asp:Button ID="Button2" runat="server" class="btn btn-primary" Text="Carian"  UseSubmitBehavior="false" onclick="Button2_Click" ValidationGroup="vgSubmit_divs_simp" />                                                                
                           ...
                           <div class="box-body">&nbsp;
                            ...
                            <h3 class="box-title">Laporan  <asp:Label ID="disp_sts" runat="server"></asp:Label> <asp:Label ID="ps_lbl14" runat="server"></asp:Label> </h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body">&nbsp;</div>
