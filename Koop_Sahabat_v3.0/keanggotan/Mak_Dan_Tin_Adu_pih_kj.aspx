<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="Mak_Dan_Tin_Adu_pih_kj.aspx.cs" Inherits="Mak_Dan_Tin_Adu_pih_kj" %>
                                                ...
                                                <div class="body collapse in">
                                                           <asp:Button ID="Button1" runat="server" class="btn btn-danger" Text="Simpan" onclick="Button1_Click" />
                                                              <asp:Button ID="Button2" runat="server" class="btn btn-default" UseSubmitBehavior="false" Text="Set Semula" onclick="Button2_Click" />
                                                                <asp:Button ID="Button4" runat="server" class="btn btn-danger" UseSubmitBehavior="false" Visible="false" Text="Kembali" onclick="Button4_Click"  />
