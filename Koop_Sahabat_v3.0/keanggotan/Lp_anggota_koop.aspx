<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../keanggotan/Lp_anggota_koop.aspx.cs" Inherits="Lp_anggota_koop" %>
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content-header">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">  Anggota KOOP </li>
                        </ol>
                    </section>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-4 control-label"> Jenis Anggota <span style="color: Red">*</span> </label>
                                    <div class="col-sm-8">
                                   ...
                                   <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-4 control-label"> Jenis Laporan <span style="color: Red">*</span> </label>
                                    <div class="col-sm-8">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-4 control-label">   <asp:Label ID="ps_lbl7" runat="server"></asp:Label>Kawasan</label>
                                    <div class="col-sm-8">
                                  ...
                                  <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-4 control-label">  <asp:Label ID="ps_lbl8" runat="server"></asp:Label>Wilayah / Pejabat </label>
                                    <div class="col-sm-8">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-4 control-label">   <asp:Label ID="ps_lbl9" runat="server"></asp:Label> Cawangan / Jabatan</label>
                                    <div class="col-sm-8">
