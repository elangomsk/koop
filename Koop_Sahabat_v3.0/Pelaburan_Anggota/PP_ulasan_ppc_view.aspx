<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Pelaburan_Anggota/PP_ulasan_ppc_view.aspx.cs" Inherits="PP_ulasan_ppc_view" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" style="height: 895px;">
                    ...
                    <section class="content-header">
                        <h1>Senarai Uasan Penolong Pengurus Cawangan Dan Keatas</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>Pelaburan Anggota</a></li>
                            <li class="active">Senarai Uasan Penolong Pengurus Cawangan Dan Keatas</li>
                        </ol>
                    </section>
           ...
           <div class="col-md-12 box-body">
                                 <asp:GridView ID="GridView1" runat="server" class="table table-bordered table-striped uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="1000000" OnRowDataBound="GridView1_RowDataBound">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="No Permohonan" ItemStyle-HorizontalAlign="center" ItemStyle-Width="10%">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton runat="server" ID="lnkView" OnClick="lnkView_Click" Font-Bold Font-Underline>
                                                                            <asp:Label ID="gd_1" runat="server" Text='<%# Eval("avi_applcn_no") %>'></asp:Label>
                                                                ...
                                                                <asp:BoundField DataField="avi_koop_name" HeaderText="Nama Koperasi" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="10%" />
                                                                <asp:BoundField DataField="avi_koop_dt" HeaderText="Tarikh" ItemStyle-HorizontalAlign="center" ItemStyle-Width="10%" />
                                                                 <asp:BoundField DataField="avi_aim_name" HeaderText="Nama Anggota" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="10%" />
                                                                <asp:BoundField DataField="avi_aim_dt" HeaderText="Tarikh" ItemStyle-HorizontalAlign="center" ItemStyle-Width="10%" />
                                                            </Columns>
