...
public partial class PP_M_Pjs_view : System.Web.UI.Page
{
    ...
    {
        con.Open();
        qry1 = "select *,case when apj_apply_sts_cd ='01' then 'PERMOHONAN' else 'BATAL PERMOHONAN' end as app_sts from jpa_pjs_application";
    ...
    {
        Response.Redirect("../Pelaburan_Anggota/PP_M_Pjs.aspx");
    }
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../Pelaburan_Anggota/PP_M_Pjs.aspx?edit={0}", name));
            }
            else
            {
                Session["validate_success"] = "";
