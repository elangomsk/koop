...
public partial class PP_L_Pjs_view : System.Web.UI.Page
{
    ...
    {
        con.Open();
        qry1 = "select *,case when apj_apply_sts_cd ='01' then 'PERMOHONAN' else 'BATAL PERMOHONAN' end as app_sts,case when apj_approve_sts_cd ='A' then 'LULUS' when apj_approve_sts_cd ='NA' then 'TOLAK' else '' end as approve_sts from jpa_pjs_application";
    ...
    //{
    //    Response.Redirect("../Pelaburan_Anggota/PP_L_Pjs.aspx");
    //}
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ddokdicno = DBCon.Ora_Execute_table("select * from jpa_pjs_application where apj_applcn_no='" + lblTitle.Text + "' ");
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../Pelaburan_Anggota/PP_L_Pjs.aspx?edit={0}", name));
            }
            else
            {
                Session["validate_success"] = "";
