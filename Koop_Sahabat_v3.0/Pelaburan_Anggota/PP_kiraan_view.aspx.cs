...
public partial class PP_kiraan_view : System.Web.UI.Page
{
    ...
    {
        con.Open();
        qry1 = "select cal_applcn_no,app_new_icno,app_name,cal_approve_amt,cal_approve_dur,ISNULL(cast(cal_profit_rate as varchar),'') as cal_profit_rate from jpa_calculate_fee s1 left join jpa_application s2 on s2.app_applcn_no=s1.cal_applcn_no";
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../Pelaburan_Anggota/PP_kiraan.aspx?edit={0}", name));
            }
            else
            {
                Session["validate_success"] = "";
