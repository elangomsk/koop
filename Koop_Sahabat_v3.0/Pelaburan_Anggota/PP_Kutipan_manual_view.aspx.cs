...
public partial class PP_Kutipan_manual_view : System.Web.UI.Page
{
    ...
    {
        con.Open();
        qry1 = "select s2.Id,app_applcn_no,FORMAT(man_pay_dt,'dd/MM/yyyy', 'en-us') as dt1,app_name,app_new_icno, man_pay_amt,man_bank_acc_no from jpa_collect_manual s2 left join jpa_application s1 on s1.app_applcn_no=man_applcn_no";
    ...
    {
        Response.Redirect("../Pelaburan_Anggota/PP_Kutipan_manual.aspx");
    }
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ddokdicno = DBCon.Ora_Execute_table("select * from jpa_collect_manual where man_applcn_no='" + lblTitle.Text + "' ");
