...
public partial class PP_ulasan_ppc_view : System.Web.UI.Page
{
    ...
    {
        con.Open();
        qry1 = "select s1.avi_applcn_no,s2.app_new_icno,s2.app_name,avi_aim_name, case when FORMAT(avi_aim_dt,'dd/MM/yyyy', 'en-us') = '01/01/1900' then '' else FORMAT(avi_aim_dt,'dd/MM/yyyy', 'en-us') end as avi_aim_dt,avi_koop_name,FORMAT(avi_koop_dt,'dd/MM/yyyy', 'en-us') as avi_koop_dt from jpa_application_visit s1 left join jpa_application s2 on s2.app_applcn_no=s1.avi_applcn_no";
    ...
    {
        Response.Redirect("../Pelaburan_Anggota/PP_ulasan_ppc.aspx");
    }
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../Pelaburan_Anggota/PP_ulasan_ppc.aspx?edit={0}", name));
            }
            else
            {
                Session["validate_success"] = "";
