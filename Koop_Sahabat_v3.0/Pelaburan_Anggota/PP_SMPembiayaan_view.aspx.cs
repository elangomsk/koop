...
public partial class PP_SMPembiayaan_view : System.Web.UI.Page
{
    ...
    {
        con.Open();
        qry1 = "select JA.* from jpa_application as JA Left join mem_member as mm ON mm.mem_new_icno=JA.app_new_icno where JA.app_sts_cd='Y'";
    ...
    {
        Response.Redirect("../Pelaburan_Anggota/PP_SMPembiayaan.aspx");
    }
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../Pelaburan_Anggota/PP_SMPembiayaan.aspx?edit={0}", name));
            }
            else
            {
                Session["validate_success"] = "";
