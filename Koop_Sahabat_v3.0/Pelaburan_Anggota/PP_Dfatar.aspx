<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../Pelaburan_Anggota/PP_Dfatar.aspx.cs" Inherits="PP_Dfatar" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" style="height: 895px;">
                    ...
                    <section class="content-header">
                        <h1>  Pendaftaran Permohonan Pembiayaan</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>  Pelaburan Anggota </a></li>
                            <li class="active">  Pendaftaran Permohonan Pembiayaan</li>
                        </ol>
                    </section>
                        ...
                        <div class="box-body">&nbsp;</div>
                             ...
                             <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                   <textarea id="TextArea2" runat="server" runat="server" rows="3" class="form-control validate[optional,custom[onlyaddress]] uppercase" maxlength="250"></textarea>
                                    </div>
                                </div>
                            </div>
                                  <div class="col-md-6 box-body">
                        ...
                        <div class="box-body">&nbsp;</div>
                             ...
                             <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Nama </label>
                                    <div class="col-sm-8">
                                      <asp:TextBox ID="TextBox19" runat="server"  class="form-control validate[custom[textSp]] uppercase" MaxLength="150"></asp:TextBox> 
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">No KP Baru</label>
                                    <div class="col-sm-8">
                                       <asp:TextBox ID="TextBox21" runat="server" MaxLength="12"  class="form-control validate[custom[onlyLetterNumberSp]] uppercase"></asp:TextBox> 
                             ...
                             <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">No Telefon </label>
                                    <div class="col-sm-8">
                                       <asp:TextBox ID="TextBox23" runat="server" MaxLength="12"  class="form-control validate[custom[phone]] uppercase"></asp:TextBox> 
                                    </div>
                                </div>
                            </div>
                                <div class="col-md-6 box-body">
                        ...
                        <div class="box-body">&nbsp;</div>
                             ...
                             <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Nama <span class="style1">*</span></label>
                                    <div class="col-sm-8">
                                      <asp:TextBox ID="TextBox27" runat="server" MaxLength="150"  class="form-control validate[custom[textSp]] uppercase"></asp:TextBox> 
                                 ...
                                 <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">No Telefon<span class="style1">*</span></label>
                                    <div class="col-sm-8">
                                       <asp:TextBox ID="TextBox35" runat="server"  class="form-control validate[custom[phone]]" MaxLength="12"></asp:TextBox> 
                             ...
                             <div class="col-md-12">
                                   <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Alamat Tetap <span class="style1">*</span></label>
                                    <div class="col-sm-8">
                                       <textarea id="TextArea7" runat="server"  rows="3" class="form-control validate[custom[onlyaddress]] uppercase" maxlength="250"></textarea>
                                    </div>
                                </div>
                            </div>
                                <div class="col-md-6 box-body">
                             ...
                             <div class="col-md-12">
                                   <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Poskod<span class="style1">*</span></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="TextBox62" runat="server"  class="form-control validate[custom[phone]]" MaxLength="5"></asp:TextBox> 
                                    </div>
                                </div>
                            </div>
                                <div class="col-md-6 box-body">
                             ...
                             <div class="col-md-12">
                                ...
                                <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Sektor Pekerjaan<span class="style1">*</span></label>
                                    <div class="col-sm-8">
                             ...
                             <div class="col-md-12">
                                ...
                                <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Taraf Jawatan <span class="style1">*</span></label>
                                    <div class="col-sm-8">
                             ...
                             <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                      <asp:TextBox ID="TextBox31" onchange="chk_pro_amt()" Style=" text-align:right;" runat="server"  class="form-control validate[optional,custom[number]]" MaxLength="12"></asp:TextBox> 
                                    </div>
                                </div>
                            </div>
                                  <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                       <asp:TextBox ID="TextBox33" onchange="chk_pro_amt()" Style=" text-align:right;" runat="server"  class="form-control validate[optional,custom[number]]" MaxLength="12"></asp:TextBox> 
                            ...
                            <div role="tabpanel" class="tab-pane" runat="server" id="p6">
                             ...
                             <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Gaji Bersih (RM) </label>
                                    <div class="col-sm-8">
                                      <asp:TextBox ID="TextBox40" runat="server"  Style=" text-align:right;" onchange="chk_pro_amt()" class="form-control validate[optional,custom[number]]" MaxLength="12"></asp:TextBox> 
                                    </div>
                                </div>
                            </div>
                                  <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Gaji Kasar (RM)</label>
                                    <div class="col-sm-8">
                                       <asp:TextBox ID="TextBox41" runat="server"  Style=" text-align:right;" onchange="chk_pro_amt()" class="form-control validate[optional,custom[number]]" MaxLength="12"></asp:TextBox> 
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-12 box-body" style="text-align:center;">
                                  <asp:Button ID="Button3" runat="server" class="btn btn-danger" Text="Simpan" OnClientClick="return userValid();" OnClick="update"/>                                                            
                                                            ...
                                                            <asp:Button ID="Button5" runat="server" class="btn btn-default" UseSubmitBehavior="false" OnClick="Reset_btn_btm" Text="Set Semula" />                                                            
