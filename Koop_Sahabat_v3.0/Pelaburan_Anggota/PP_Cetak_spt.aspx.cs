...
public partial class PP_Cetak_spt : System.Web.UI.Page
{
    ...
    string level, userid, devinfo;
    string url = "~/PP_Cetak_spt.aspx";
        ...
        try
        {
            ...
            if (Applcn_no.Text != "" && no_rujukan.Text != "")
            {
                ...
                if (app_rujno.Rows.Count == 0)
                {
                    ...
                    DBCon.Execute_CommamdText("INSERT into cmn_ref_no (cmn_applcn_no,cmn_ref_no,cmn_txn_dt,cmn_txn_cd,cmn_crt_id,cmn_crt_dt) values ('" + Applcn_no.Text + "','" + no_rujukan.Text + "','" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "','032605','" + Session["New"].ToString() + "','" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "')");
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        try
        {
            if (Applcn_no.Text != "")
            {
                ...
                {
                    Rptviwer_cetak.LocalReport.ReportPath = "PELABURAN_ANGGOTA/PP_Tunggakan.rdlc";
                    ReportDataSource rds = new ReportDataSource("PP_CSPT", dt);
    ...
    "</DeviceInfo>";
                    ...
                    byte[] bytes = Rptviwer_cetak.LocalReport.Render("PDF", devinfo, out mimeType, out encoding, out extension, out streamids, out warnings);
                    Response.Buffer = true;
                    Response.Clear();
                    Response.ClearHeaders();
                    Response.ClearContent();
                    Response.ContentType = "application/pdf";
                    Response.AddHeader("content-disposition", "attachment; filename=Pelepasan_Tunggakan_" + Applcn_no.Text + "." + extension);
