<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../Pelaburan_Anggota/PP_KELULUSAN_PEMBIAYAAN.aspx.cs" Inherits="PP_KELULUSAN_PEMBIAYAAN" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" style="height: 895px;">
                    ...
                    <section class="content-header">
                        <h1> Kelulusan Hapus Kira Pembiayaan</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i> Pelaburan Anggota </a></li>
                            <li class="active">Kelulusan Hapus Kira Pembiayaan</li>
                        </ol>
                    </section>
                        ...
                        <div class="form-horizontal">
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-12 box-body" style="text-align:center;">
                              ...
                              <div class="box-header with-border">
                            <h3 class="box-title">Maklumat Permohonan Hapus Kira Pembiayaan </h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body">&nbsp;</div>
                             ...
                             <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8" style="pointer-events:none;">
                                           <asp:DropDownList runat="server" style="width:100%; font-size:13px;" class="form-control select2 validate[optional]" ID="k_status">
                              ...
                              <div class="box-header with-border">
                            <h3 class="box-title">Maklumat Kelulusan Hapus Kira Pembiayaan </h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body">&nbsp;</div>
                            <div class="row">
                             <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Status <span style="color: Red">*</span></label>
                                    <div class="col-sm-8">
                                         <asp:DropDownList runat="server" style="width:100%; font-size:13px;" class="form-control select2 validate[optional]" ID="DropDownList1">
                                                                <asp:ListItem Value="">--- PILIH ---</asp:ListItem>
