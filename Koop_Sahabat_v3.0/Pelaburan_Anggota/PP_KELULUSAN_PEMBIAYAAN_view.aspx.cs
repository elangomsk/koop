...
public partial class PP_KELULUSAN_PEMBIAYAAN_view : System.Web.UI.Page
{
    ...
    {
        con.Open();
        qry1 = "select *,case when wri_apply_sts_cd ='01' then 'PERMOHONAN' else 'BATAL PERMOHONAN' end as app_sts from jpa_write_off";
    ...
    //{
    //    Response.Redirect("../Pelaburan_Anggota/PP_KELULUSAN_PEMBIAYAAN.aspx");
    //}
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ddokdicno = DBCon.Ora_Execute_table("select * from jpa_write_off where wri_applcn_no='" + lblTitle.Text + "' ");
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../Pelaburan_Anggota/PP_KELULUSAN_PEMBIAYAAN.aspx?edit={0}", name));
            }
            else
            {
                Session["validate_success"] = "";
