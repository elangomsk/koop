...
public partial class PP_cl_shahabat_view : System.Web.UI.Page
{
    ...
    {
        con.Open();
        qry1 = "select s1.che_applcn_no,s2.app_name,s2.app_new_icno,s1.che_share_amt,s1.che_income_amt from jpa_application_checklist s1 left join jpa_application s2 on s2.app_applcn_no=s1.che_applcn_no inner join mem_member s3 on s3.mem_new_icno=s2.app_new_icno and s3.mem_staff_ind='N'";
    ...
    {
        Response.Redirect("../Pelaburan_Anggota/PP_cl_shahabat.aspx");
    }
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../Pelaburan_Anggota/PP_cl_shahabat.aspx?edit={0}", name));
            }
            else
            {
                Session["validate_success"] = "";
