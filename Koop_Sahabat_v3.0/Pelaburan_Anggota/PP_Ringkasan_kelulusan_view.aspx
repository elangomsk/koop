<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Pelaburan_Anggota/PP_Ringkasan_kelulusan_view.aspx.cs" Inherits="PP_Ringkasan_kelulusan_view" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" style="height: 895px;">
                    ...
                    <section class="content-header">
                        <h1>Senarai Ringkasan Kelulusan</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>Pelaburan Anggota</a></li>
                            <li class="active">Senarai Ringkasan Kelulusan</li>
                        </ol>
                    </section>
           ...
           <div class="col-md-12 box-body">
                                 <asp:GridView ID="GridView1" runat="server" class="table table-bordered table-striped uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="1000000" OnRowDataBound="GridView1_RowDataBound">
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="tujuan_desc" HeaderText="Tujuan" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="10%" />
                                                                <asp:BoundField DataField="app_apply_amt" HeaderText="Amaun Dipohon (RM)" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:n}" ItemStyle-Width="10%" />
                                                                <asp:BoundField DataField="app_apply_dur" HeaderText="Tempoh (Bulan)" ItemStyle-HorizontalAlign="center" ItemStyle-Width="10%" />
                                                                <asp:BoundField DataField="jkk_approve_amt" HeaderText="Amaun Diluluskan (RM)" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:n}" ItemStyle-Width="10%" />
                                                                <asp:BoundField DataField="jkk_result" HeaderText="Keputusan" ItemStyle-HorizontalAlign="center" ItemStyle-Width="10%" />
