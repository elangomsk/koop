<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../Pelaburan_Anggota/PP_SEMAKAN_PEMBIAYAAN.aspx.cs" Inherits="PP_SEMAKAN_PEMBIAYAAN" %>
        ...
        <ContentTemplate>
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                     ...
                                     <asp:TextBox ID="f_date" runat="server" class="form-control datepicker mydatepickerclass" placeholder="DD/MM/YYYY"></asp:TextBox>
                               ...
                               <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                           <div class="input-group">
                                     <asp:TextBox ID="t_date" runat="server" class="form-control datepicker mydatepickerclass" placeholder="DD/MM/YYYY"></asp:TextBox>
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                             </div>
                                    </div>
                                </div>
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-12 box-body" style="text-align:center;">
                             <asp:Button ID="Button4" runat="server" class="btn btn-primary" Text="Carian" UseSubmitBehavior="false" OnClick="btnsrch_Click"/>
                               ...
                               <div class="box-header with-border">
                            <h3 class="box-title">Senarai Maklumat Hapus Kira</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body">&nbsp;</div>
           ...
           <div class="col-md-12 box-body">
                                        ...
                                        <Columns>
                                            ...
                                            <ItemTemplate>  
                                                <asp:Label ID="Label5" runat="server" Text='<%# Eval("app_loan_amt","{0:n}") %>'></asp:Label>  
                                                 ...
                                                 <ItemStyle HorizontalAlign="Center" />  
                                            <ItemTemplate>  
                                                <asp:Label ID="Label6" runat="server" Text='<%# Eval("appl_loan_dur") %>'></asp:Label>  
                                            </ItemTemplate>  
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="JUMLAH KENA (RM)">   
                                                <ItemStyle HorizontalAlign="Right" /> 
                                            <ItemTemplate>  
                                                <asp:Label ID="Label6" runat="server" Text='<%# Eval("app_cumm_installment_amt","{0:n}") %>'></asp:Label>  
                                            </ItemTemplate>  
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="JUMLAH BAYAR (RM)">   
                                                <ItemStyle HorizontalAlign="Right" /> 
                                            <ItemTemplate>  
                                                <asp:Label ID="Label6" runat="server" Text='<%# Eval("app_cumm_pay_amt","{0:n}") %>'></asp:Label>  
                                            </ItemTemplate>  
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="JUMLAH UNTUNG (RM)">   
                                                <ItemStyle HorizontalAlign="Right" /> 
                                            <ItemTemplate>  
                                                <asp:Label ID="Label6" runat="server" Text='<%# Eval("app_cumm_profit_amt","{0:n}") %>'></asp:Label>  
                                            </ItemTemplate>  
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="JUMLAH TUNGGAKAN (RM)"> 
                                                <ItemStyle HorizontalAlign="Right" />   
                                            <ItemTemplate>  
                                                <asp:Label ID="Label6" runat="server" Text='<%# Eval("app_backdated_amt","{0:n}") %>'></asp:Label>  
                                            </ItemTemplate>  
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="BAKI PELABURAN (RM)">   
                                                <ItemStyle HorizontalAlign="Right" /> 
                                            <ItemTemplate>  
                                                <asp:Label ID="Label6" runat="server" Text='<%# Eval("app_bal_loan_amt","{0:n}") %>'></asp:Label>  
                                            </ItemTemplate>  
                                                </asp:TemplateField>
                                        </Columns>
                           ...
                           <div class="row">
                             <div class="col-md-12">
                            <div class="col-md-12 box-body" style="text-align:center;">
                              <asp:Button ID="Button2" runat="server" class="btn btn-warning" Text="Cetak" OnClick="click_print"/>                                                         
                                                         <asp:Button ID="Button3" runat="server" class="btn btn-defalut" Text="Batal" />
                            </div>
                           </div>
                               </div>            
                           <div class="row">
