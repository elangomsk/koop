...
public partial class PP_kk_daftar_view : System.Web.UI.Page
{
    ...
    {
        con.Open();
        qry1 = "select app_new_icno,app_name,count(*) as cnt from jpa_application as JA Left join mem_member as mm ON mm.mem_new_icno=JA.app_new_icno group by app_new_icno,app_name";
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ddokdicno = DBCon.Ora_Execute_table("select * from jpa_application where app_new_icno='" + lblTitle.Text + "' ");
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../Pelaburan_Anggota/PP_kk_daftar.aspx?edit={0}", name));
            }
            else
            {
                Session["validate_success"] = "";
