<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Pelaburan_Anggota/PP_Kutipan_manual_view.aspx.cs" Inherits="PP_Kutipan_manual_view" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" style="height: 895px;">
                    ...
                    <section class="content-header">
                        <h1>Senarai Kutipan Bayaran Manual</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>Pelaburan Anggota</a></li>
                            <li class="active">Senarai Kutipan Bayaran Manual</li>
                        </ol>
                    </section>
                                                                ...
                                                                <asp:TemplateField HeaderText="No Permohonan" ItemStyle-HorizontalAlign="center" ItemStyle-Width="10%">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton runat="server" ID="lnkView" OnClick="lnkView_Click" Font-Bold Font-Underline>
                                                                            ...
                                                                            <asp:Label ID="lbl_sts1" Visible="false" runat="server" Text='<%# Eval("Id") %>'></asp:Label>
                                                                        </asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
