<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../PELABURAN_ANGGOTA/PP_Cetak_spt.aspx.cs" Inherits="PP_Cetak_spt" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" style="height: 895px;">
                    ...
                    <section class="content-header">
                        <h1> Cetak Surat Pelepasan Tunggakan </h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>Pelaburan Anggota</a></li>
                            <li class="active"> Cetak Surat Pelepasan Tunggakan    </li>
                        </ol>
                    </section>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">   No Rujukan <span style="color: Red">*</span> </label>
                                    <div class="col-sm-8">
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-12 box-body" style="text-align:center;">
                                 <asp:Button ID="Button12" runat="server" class="btn btn-danger"  Text="Simpan" usesubmitbehavior="false" onclick="Click_rujukan" />
                                                                <asp:Button ID="Button1" runat="server" class="btn btn-warning" Text="Cetak"  OnClick="Button1_Click1" />
                            </div>
                           </div>
                               </div>
                          <div class="row">
                            <div class="col-md-12 col-sm-2" style="text-align: justify;">
                                                        <rsweb:ReportViewer ID="Rptviwer_cetak" runat="server">
                                                        </rsweb:ReportViewer>
                                                    </div>
                              </div>
                        </div>
