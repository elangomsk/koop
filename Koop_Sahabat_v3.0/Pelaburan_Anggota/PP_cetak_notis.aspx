<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../PELABURAN_ANGGOTA/PP_cetak_notis.aspx.cs" Inherits="PP_cetak_notis" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" style="height: 895px;">
                    ...
                    <section class="content-header">
                        <h1>  Cetak Notis Tuntutan       </h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>Pelaburan Anggota</a></li>
                            <li class="active">  Cetak Notis Tuntutan       </li>
                        </ol>
                    </section>
                         ...
                         <%--   <div class="col-md-6 box-body">
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-12 box-body" style="text-align:center;">
                                <asp:Button ID="Button1" runat="server" class="btn btn-warning" Text="TANPA PRASANGKA" usesubmitbehavior="false" OnClick="Cetakjbb_Click" />
                                                     <asp:Button ID="Button3" runat="server" class="btn btn-warning" 
                                                        Text="AMARAN TERAKHIR" usesubmitbehavior="false" onclick="Button3_Click" />                                                    
                            </div>
                           </div>
                               </div>
                          <div class="row">
