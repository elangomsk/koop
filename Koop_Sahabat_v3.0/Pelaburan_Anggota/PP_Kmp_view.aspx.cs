...
public partial class PP_Kmp_view : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("../Pelaburan_Anggota/PP_Kmp.aspx");
    }
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../Pelaburan_Anggota/PP_Kmp.aspx?edit={0}", name));
            }
            else
            {
                Session["validate_success"] = "";
