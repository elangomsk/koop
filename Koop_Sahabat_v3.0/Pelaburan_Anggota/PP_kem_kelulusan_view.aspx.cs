...
public partial class PP_kem_kelulusan_view : System.Web.UI.Page
{
    ...
    {
        con.Open();
        qry1 = "select app_applcn_no,JA.app_new_icno,JA.app_age,JA.app_name,rt.tujuan_desc,JA.app_apply_amt,JA.app_apply_dur,RW.Wilayah_Name,ISNULL(RB.branch_desc, '') AS branch_desc, JJA.jkk_approve_amt,JJA.jkk_approve_dur from jpa_application as JA Left join ref_tujuan as rt on rt.tujuan_cd=JA.app_loan_purpose_cd Inner join jpa_jkkpa_approval as JJA ON JJA.jkk_applcn_no = JA.app_applcn_no Left Join Ref_Wilayah as RW ON RW.Wilayah_Code=JA.app_region_cd Left join ref_branch AS RB ON RB.branch_cd=JA.app_branch_cd ";
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../Pelaburan_Anggota/PP_kem_kelulusan.aspx?edit={0}", name));
            }
            else
            {
                Session["validate_success"] = "";
