...
public partial class kw_presub1_skrin_view : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        //}
        qry1 = "SELECT m1.*,s1.KK_Spreskrin_name as sk_name, case when m1.Status = 'A' then 'AKTIF' else 'TIDAK AKTIF' end as sts FROM KK_PID_presub1_Skrin m1 left join KK_PID_presub_Skrin s1 on s1.KK_Spreskrin_id=m1.KK_Spreskrin_id order by s1.KK_Sskrin_id,m1.ID";
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../Pentadbiran/kw_presub1_skrin.aspx?edit={0}", name));
            }
            else
            {
