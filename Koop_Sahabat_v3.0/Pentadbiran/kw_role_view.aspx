<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Pentadbiran/kw_role_view.aspx.cs" Inherits="kw_role_view" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" style="height: 895px;">
                    ...
                    <section class="content-header">
                        <h1>Senarai Peranan</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>Pentadbiran</a></li>
                            <li class="active">Senarai Peranan</li>
                        </ol>
                    </section>
        ...
        <ContentTemplate>
          ...
          <%-- <div class="col-md-3 box-body">
                                ...
                                <div class="dataTables_wrapper form-inline dt-bootstrap"  style="overflow:auto;">
                                    <%--  <div class="row">--%>
           <div class="col-md-12 box-body">
                                    <asp:GridView  ID="gv_refdata" runat="server" class="table table-bordered table-striped uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="100000" OnRowDataBound="GridView1_RowDataBound">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="BIL" HeaderStyle-Width="1%">
                                                             ...
                                                             <asp:TemplateField HeaderText="NAMA KUMPULAN" HeaderStyle-HorizontalAlign="Left">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnkView" runat="server" OnClick="lnkView_Click" Font-Bold Font-Underline>
                                                                         <asp:Label ID="Label3" runat="server" Text='<%# Eval("KK_kumpulan_name") %>' CssClass="uppercase"></asp:Label>
                                                                         <asp:Label ID="og_genid" Visible="false" runat="server" Text='<%# Eval("Id") %>' CssClass="uppercase"></asp:Label>
                                                                        <asp:Label ID="Label1" Visible="false" runat="server" Text='<%# Eval("KK_kumpulan_id") %>' CssClass="uppercase"></asp:Label>
                                                                    </asp:LinkButton>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
