<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Pentadbiran/kw_presub_skrin.aspx.cs" Inherits="kw_presub_skrin" %>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:DropDownList id="dd_skrin" style="width:100%; font-size:13px;" runat="server" class="form-control select2 validate[optional] uppercase" OnSelectedIndexChanged="sel_mskrin" AutoPostBack="true"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                                 </div>
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:DropDownList id="dd_sskrin" style="width:100%; font-size:13px;" runat="server" class="form-control select2 validate[optional] uppercase" OnSelectedIndexChanged="sel_mskrin1" AutoPostBack="true"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                                 </div>
