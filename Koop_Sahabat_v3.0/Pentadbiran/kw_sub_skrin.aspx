<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Pentadbiran/kw_sub_skrin.aspx.cs" Inherits="kw_sub_skrin" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" style="height: 895px;">
                    ...
                    <section class="content-header">
                        <h1>Pengurusan Sub Skrin</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>Pentadbiran</a></li>
                            <li class="active">Pengurusan Sub Skrin</li>
                        </ol>
                    </section>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:DropDownList id="dd_skrin" style="width:100%" runat="server" class="form-control select2 validate[optional] uppercase" OnSelectedIndexChanged="sel_mskrin" AutoPostBack="true"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                                 </div>
