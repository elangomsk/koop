<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Pentadbiran/kw_main_skrin_view.aspx.cs" Inherits="kw_main_skrin_view" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" style="height: 895px;">
                    ...
                    <section class="content-header">
                        <h1>Senarai Pengurusan Skrin</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>Pentadbiran</a></li>
                            <li class="active">Senarai Pengurusan Skrin</li>
                        </ol>
                    </section>
                                    ...
                                    <asp:GridView  ID="gv_refdata" runat="server" class="table table-bordered table-striped uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="1000000">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="BIL" HeaderStyle-Width="2%">
                                                             ...
                                                             <asp:TemplateField HeaderText="Kod Skrin">
                                                                <ItemStyle HorizontalAlign="center" Width="3%" Font-Bold="true"></ItemStyle>
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnkView" runat="server" OnClick="lnkView_Click" Font-Bold Font-Underline>
                                                                        <asp:Label ID="kat_cd" runat="server" Text='<%# Eval("KK_Skrin_id") %>' CssClass="uppercase"></asp:Label>
                                                                        <asp:Label ID="og_genid" runat="server" Text='<%# Eval("Id") %>' Visible="false" CssClass="uppercase"></asp:Label>
                                                                    </asp:LinkButton>
                                                                </ItemTemplate>

                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Nama Skrin" HeaderStyle-HorizontalAlign="Left">
                                                                <ItemStyle HorizontalAlign="Left" Width="10%"></ItemStyle>
                                                                <ItemTemplate>
                                                                        <asp:Label ID="Label3" runat="server" Text='<%# Eval("KK_Skrin_name") %>' CssClass="uppercase"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
