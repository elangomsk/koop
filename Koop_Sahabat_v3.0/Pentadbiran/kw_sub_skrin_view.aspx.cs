...
public partial class kw_sub_skrin_view : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        //}
        qry1 = "SELECT *,s1.KK_Skrin_name as sk_name, case when m1.Status = 'A' then 'AKTIF' else 'TIDAK AKTIF' end as sts FROM KK_PID_Sub_Skrin m1 left join KK_PID_Skrin s1 on s1.KK_Skrin_id=m1.KK_Skrin_id order by s1.KK_Skrin_id,cast(m1.position as int)";
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../Pentadbiran/kw_sub_skrin.aspx?edit={0}", name));
            }
            else
            {
