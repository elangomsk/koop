<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../SUMBER_MANUSIA/HR_AKA_view.aspx.cs" Inherits="HR_AKA_view" %>
           ...
           <div class="col-md-12 box-body">
                                    <asp:GridView ID="GridView1" runat="server" class="table table-bordered table-striped uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="Small" Width="100%" AllowPaging="true" PageSize="1000000">
                                      ...
                                      <asp:TemplateField HeaderText="BIL">
                                       ...
                                       <asp:BoundField DataField="hr_pendi_desc" ItemStyle-HorizontalAlign="Left" HeaderText="TARAF PENDIDIKAN"  />
                                       <asp:BoundField DataField="hr_bidang_desc" ItemStyle-HorizontalAlign="Left" HeaderText="BIDANG / PROGRAM"  />   
                                       <asp:BoundField DataField="hr_univ_desc" ItemStyle-HorizontalAlign="Left" HeaderText="INSTITUSI"  />
                                       <asp:BoundField DataField="edu_year_gain" HeaderText="TAHUN DIPEROLEHI"  />   
                                        <asp:BoundField DataField="edu_result" HeaderText="KEPUTUSAN"  />   
                                      </Columns>
                                    </asp:GridView>
