...
public partial class HR_LM_latihan : System.Web.UI.Page
{
    ...
    void Bind_klati()
    {
        ...
        try
        {
            string com = "select kat_latihan_cd,UPPER(kat_latihan_desc) as kat_latihan_desc from Ref_hr_kat_latihan where Status='A' order by kat_latihan_cd asc";
            SqlDataAdapter adpt = new SqlDataAdapter(com, con);
            DataTable dt = new DataTable();
            adpt.Fill(dt);
            dd_kl.DataSource = dt;
            dd_kl.DataTextField = "kat_latihan_desc";
            dd_kl.DataValueField = "kat_latihan_cd";
            dd_kl.DataBind();
    ...
    //    try
    //    {
    //        string com = "select hr_jaba_Code,UPPER(op_perg_name) as op_perg_name from Ref_hr_jabatan WHERE Status = 'A' ORDER BY op_perg_name";
    //        SqlDataAdapter adpt = new SqlDataAdapter(com, con);
    //        DataTable dt = new DataTable();
    //        adpt.Fill(dt);
    //        dd_jabatan.DataSource = dt;
    //        dd_jabatan.DataTextField = "op_perg_name";
    ...
    void sql_info()
    {
        ...
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and sp.str_curr_org_cd='" + dd_org.SelectedValue.Trim() + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        ...
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and sp.str_curr_org_cd='" + dd_org.SelectedValue.Trim() + "' and sp.stf_cur_sub_org='" + dd_org_pen.SelectedValue + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() != "" && dd_org_pen.SelectedValue != "" && dd_jabatan.SelectedValue.Trim() != "" && dd_unit.SelectedValue.Trim() == "" && tm_date.Text == "" && ta_date.Text == "" && Kaki_no.Text == "" && dd_kl.SelectedValue == "" && dd_jl.SelectedValue == "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and sp.str_curr_org_cd='" + dd_org.SelectedValue.Trim() + "' and sp.stf_cur_sub_org='" + dd_org_pen.SelectedValue + "' and ph.pos_dept_cd='" + dd_jabatan.SelectedValue.Trim() + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() != "" && dd_org_pen.SelectedValue != "" && dd_jabatan.SelectedValue.Trim() != "" && dd_unit.SelectedValue.Trim() != "" && tm_date.Text == "" && ta_date.Text == "" && Kaki_no.Text == "" && dd_kl.SelectedValue == "" && dd_jl.SelectedValue == "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and sp.str_curr_org_cd='" + dd_org.SelectedValue.Trim() + "' and sp.stf_cur_sub_org='" + dd_org_pen.SelectedValue + "' and ph.pos_dept_cd='" + dd_jabatan.SelectedValue.Trim() + "' and ph.pos_unit_cd='" + dd_unit.SelectedValue.Trim() + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() == "" && dd_org_pen.SelectedValue == "" && dd_jabatan.SelectedValue.Trim() == "" && dd_unit.SelectedValue.Trim() == "" && tm_date.Text != "" && ta_date.Text != "" && Kaki_no.Text == "" && dd_kl.SelectedValue == "" && dd_jl.SelectedValue == "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and ht.trn_start_dt>=DATEADD(day, DATEDIFF(day, 0, '" + phdate1 + "'), 0) and ht.trn_start_dt<=DATEADD(day, DATEDIFF(day, 0, '" + phdate2 + "'), 0) group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() == "" && dd_org_pen.SelectedValue == "" && dd_jabatan.SelectedValue.Trim() == "" && dd_unit.SelectedValue.Trim() == "" && tm_date.Text == "" && ta_date.Text == "" && Kaki_no.Text != "" && dd_kl.SelectedValue == "" && dd_jl.SelectedValue == "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and ht.trn_staff_no='" + Applcn_no1.Text + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() == "" && dd_org_pen.SelectedValue == "" && dd_jabatan.SelectedValue.Trim() == "" && dd_unit.SelectedValue.Trim() == "" && tm_date.Text == "" && ta_date.Text == "" && Kaki_no.Text == "" && dd_kl.SelectedValue != "" && dd_jl.SelectedValue == "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and ht.trn_cat_cd='" + dd_kl.SelectedValue + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() == "" && dd_org_pen.SelectedValue == "" && dd_jabatan.SelectedValue.Trim() == "" && dd_unit.SelectedValue.Trim() == "" && tm_date.Text == "" && ta_date.Text == "" && Kaki_no.Text == "" && dd_kl.SelectedValue == "" && dd_jl.SelectedValue != "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and ht.trn_type_cd='" + dd_jl.SelectedValue + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }

        else if (dd_org.SelectedValue.Trim() != "" && dd_org_pen.SelectedValue == "" && dd_jabatan.SelectedValue.Trim() == "" && dd_unit.SelectedValue.Trim() == "" && tm_date.Text != "" && ta_date.Text != "" && Kaki_no.Text == "" && dd_kl.SelectedValue == "" && dd_jl.SelectedValue == "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ht.trn_start_dt>=DATEADD(day, DATEDIFF(day, 0, '" + phdate1 + "'), 0) and ht.trn_start_dt<=DATEADD(day, DATEDIFF(day, 0, '" + phdate2 + "'), 0) and  ph.pos_end_dt='9999-12-31' and sp.str_curr_org_cd='" + dd_org.SelectedValue + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() != "" && dd_org_pen.SelectedValue == "" && dd_jabatan.SelectedValue.Trim() == "" && dd_unit.SelectedValue.Trim() == "" && tm_date.Text == "" && ta_date.Text == "" && Kaki_no.Text != "" && dd_kl.SelectedValue == "" && dd_jl.SelectedValue == "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and ht.trn_staff_no='" + Applcn_no1.Text + "' and sp.str_curr_org_cd='" + dd_org.SelectedValue + "'  group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() != "" && dd_org_pen.SelectedValue == "" && dd_jabatan.SelectedValue.Trim() == "" && dd_unit.SelectedValue.Trim() == "" && tm_date.Text == "" && ta_date.Text == "" && Kaki_no.Text == "" && dd_kl.SelectedValue != "" && dd_jl.SelectedValue == "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and ht.trn_cat_cd='" + dd_kl.SelectedValue + "' and sp.str_curr_org_cd='" + dd_org.SelectedValue + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() != "" && dd_org_pen.SelectedValue == "" && dd_jabatan.SelectedValue.Trim() == "" && dd_unit.SelectedValue.Trim() == "" && tm_date.Text == "" && ta_date.Text == "" && Kaki_no.Text == "" && dd_kl.SelectedValue == "" && dd_jl.SelectedValue != "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and ht.trn_type_cd='" + dd_jl.SelectedValue + "' and sp.str_curr_org_cd='" + dd_org.SelectedValue + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }

        else if (dd_org.SelectedValue.Trim() != "" && dd_org_pen.SelectedValue != "" && dd_jabatan.SelectedValue.Trim() == "" && dd_unit.SelectedValue.Trim() == "" && tm_date.Text != "" && ta_date.Text != "" && Kaki_no.Text == "" && dd_kl.SelectedValue == "" && dd_jl.SelectedValue == "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ht.trn_start_dt>=DATEADD(day, DATEDIFF(day, 0, '" + phdate1 + "'), 0) and ht.trn_start_dt<=DATEADD(day, DATEDIFF(day, 0, '" + phdate2 + "'), 0) and  ph.pos_end_dt='9999-12-31' and sp.str_curr_org_cd='" + dd_org.SelectedValue.Trim() + "' and sp.stf_cur_sub_org='" + dd_org_pen.SelectedValue + "'  group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() != "" && dd_org_pen.SelectedValue != "" && dd_jabatan.SelectedValue.Trim() != "" && dd_unit.SelectedValue.Trim() != "" && tm_date.Text == "" && ta_date.Text == "" && Kaki_no.Text != "" && dd_kl.SelectedValue == "" && dd_jl.SelectedValue == "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and sp.str_curr_org_cd='" + dd_org.SelectedValue.Trim() + "' and sp.stf_cur_sub_org='" + dd_org_pen.SelectedValue + "' and ht.trn_staff_no='" + Applcn_no1.Text + "'  and ph.pos_dept_cd='" + dd_jabatan.SelectedValue + "' and ph.pos_unit_cd='" + dd_unit.SelectedValue + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() != "" && dd_org_pen.SelectedValue != "" && dd_jabatan.SelectedValue.Trim() != "" && dd_unit.SelectedValue.Trim() != "" && tm_date.Text == "" && ta_date.Text == "" && Kaki_no.Text == "" && dd_kl.SelectedValue != "" && dd_jl.SelectedValue == "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and sp.str_curr_org_cd='" + dd_org.SelectedValue.Trim() + "' and sp.stf_cur_sub_org='" + dd_org_pen.SelectedValue + "' and ht.trn_cat_cd='" + dd_kl.SelectedValue + "' and ph.pos_dept_cd='" + dd_jabatan.SelectedValue + "' and ph.pos_unit_cd='" + dd_unit.SelectedValue + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() != "" && dd_org_pen.SelectedValue != "" && dd_jabatan.SelectedValue.Trim() != "" && dd_unit.SelectedValue.Trim() != "" && tm_date.Text == "" && ta_date.Text == "" && Kaki_no.Text == "" && dd_kl.SelectedValue == "" && dd_jl.SelectedValue != "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and ht.trn_type_cd='" + dd_jl.SelectedValue + "' and sp.str_curr_org_cd='" + dd_org.SelectedValue.Trim() + "' and sp.stf_cur_sub_org='" + dd_org_pen.SelectedValue + "' and ph.pos_dept_cd='" + dd_jabatan.SelectedValue + "' and ph.pos_unit_cd='" + dd_unit.SelectedValue + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }

        else if (dd_org.SelectedValue.Trim() == "" && dd_org_pen.SelectedValue == "" && dd_jabatan.SelectedValue.Trim() == "" && dd_unit.SelectedValue.Trim() == "" && tm_date.Text != "" && ta_date.Text != "" && Kaki_no.Text != "" && dd_kl.SelectedValue == "" && dd_jl.SelectedValue == "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ht.trn_start_dt>=DATEADD(day, DATEDIFF(day, 0, '" + phdate1 + "'), 0) and ht.trn_start_dt<=DATEADD(day, DATEDIFF(day, 0, '" + phdate2 + "'), 0) and  ph.pos_end_dt='9999-12-31' and ht.trn_staff_no='" + Kaki_no.Text + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() == "" && dd_org_pen.SelectedValue == "" && dd_jabatan.SelectedValue.Trim() == "" && dd_unit.SelectedValue.Trim() == "" && tm_date.Text != "" && ta_date.Text != "" && Kaki_no.Text == "" && dd_kl.SelectedValue != "" && dd_jl.SelectedValue == "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ht.trn_start_dt>=DATEADD(day, DATEDIFF(day, 0, '" + phdate1 + "'), 0) and ht.trn_start_dt<=DATEADD(day, DATEDIFF(day, 0, '" + phdate2 + "'), 0) and  ph.pos_end_dt='9999-12-31' and ht.trn_cat_cd='" + dd_kl.SelectedValue + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() == "" && dd_org_pen.SelectedValue == "" && dd_jabatan.SelectedValue.Trim() == "" && dd_unit.SelectedValue.Trim() == "" && tm_date.Text != "" && ta_date.Text != "" && Kaki_no.Text == "" && dd_kl.SelectedValue == "" && dd_jl.SelectedValue != "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ht.trn_start_dt>=DATEADD(day, DATEDIFF(day, 0, '" + phdate1 + "'), 0) and ht.trn_start_dt<=DATEADD(day, DATEDIFF(day, 0, '" + phdate2 + "'), 0) and  ph.pos_end_dt='9999-12-31' and ht.trn_type_cd='" + dd_jl.SelectedValue + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() == "" && dd_org_pen.SelectedValue == "" && dd_jabatan.SelectedValue.Trim() == "" && dd_unit.SelectedValue.Trim() == "" && tm_date.Text == "" && ta_date.Text == "" && Kaki_no.Text != "" && dd_kl.SelectedValue != "" && dd_jl.SelectedValue == "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and ht.trn_staff_no='" + Applcn_no1.Text + "' and ht.trn_cat_cd='" + dd_kl.SelectedValue + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() == "" && dd_org_pen.SelectedValue == "" && dd_jabatan.SelectedValue.Trim() == "" && dd_unit.SelectedValue.Trim() == "" && tm_date.Text == "" && ta_date.Text == "" && Kaki_no.Text != "" && dd_kl.SelectedValue == "" && dd_jl.SelectedValue != "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and ht.trn_staff_no='" + Applcn_no1.Text + "' and ht.trn_type_cd='" + dd_jl.SelectedValue + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() == "" && dd_org_pen.SelectedValue == "" && dd_jabatan.SelectedValue.Trim() == "" && dd_unit.SelectedValue.Trim() == "" && tm_date.Text == "" && ta_date.Text == "" && Kaki_no.Text == "" && dd_kl.SelectedValue != "" && dd_jl.SelectedValue != "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and ht.trn_cat_cd='" + dd_kl.SelectedValue + "' and ht.trn_type_cd='" + dd_jl.SelectedValue + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else if (dd_org.SelectedValue.Trim() != "" && dd_org_pen.SelectedValue != "" && dd_jabatan.SelectedValue.Trim() != "" && dd_unit.SelectedValue.Trim() != "" && tm_date.Text != "" && ta_date.Text != "" && Kaki_no.Text != "" && dd_kl.SelectedValue != "" && dd_jl.SelectedValue != "")
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ht.trn_start_dt>=DATEADD(day, DATEDIFF(day, 0, '" + phdate1 + "'), 0) and ht.trn_start_dt<=DATEADD(day, DATEDIFF(day, 0, '" + phdate2 + "'), 0) and  ph.pos_end_dt='9999-12-31' and ht.trn_staff_no='" + Kaki_no.Text + "' and ht.trn_cat_cd='" + dd_kl.SelectedValue + "' and ht.trn_type_cd='" + dd_jl.SelectedValue + "' and p.str_curr_org_cd='" + dd_org.SelectedValue + "' and sp.stf_cur_sub_org='" + dd_org_pen.SelectedValue + "' and ph.pos_dept_cd='" + dd_jabatan.SelectedValue + "' and ph.pos_unit_cd='" + dd_unit.SelectedValue + "' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
        else
        {
            val1 = "select sp.stf_staff_no,upper(sp.stf_name) as stf_name,sum(ht.trn_dur) as tot_dur,hu.op_perg_name,org.org_name,ht.trn_catatan,FORMAT(trn_start_dt,'dd/MM/yyyy') dari from hr_training as ht left join hr_post_his as ph on ht.trn_staff_no=ph.pos_staff_no  left join hr_staff_profile as sp on sp.stf_staff_no=ht.trn_staff_no left join hr_organization_pern as hu on hu.op_perg_code=sp.stf_cur_sub_org left join hr_organization org on org.org_gen_id=sp.str_curr_org_cd where ph.pos_end_dt='9999-12-31' and ht.trn_staff_no='' group by sp.stf_staff_no,sp.stf_name,hu.op_perg_name,org.org_name,trn_catatan,trn_start_dt";
        }
    }
    ...
    protected void ExportToEXCEL(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count != 0)
        {
            ...
            builder.Append("ORGANISASI,WILAYAH,NO KAKITANGAN,NAMA KAKITANGAN, TAJUK, TEMPAT, TARIKH" + Environment.NewLine);
            for (int k = 0; k <= (dt.Rows.Count - 1); k++)
            {

                builder.Append(dt.Rows[k]["org_name"].ToString() + " , " + dt.Rows[k]["op_perg_name"].ToString() + ", " + dt.Rows[k]["stf_staff_no"].ToString() + "," + dt.Rows[k]["stf_name"].ToString().Replace("'", "''") + "," + dt.Rows[k]["trn_catatan"].ToString() + "," + dt.Rows[k]["tot_dur"].ToString() + "," + dt.Rows[k]["dari"].ToString() + Environment.NewLine);
