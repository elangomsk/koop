<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../SUMBER_MANUSIA/HR_SEL_PERKESO.aspx.cs" Inherits="HR_SEL_PERKESO" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1 id="h1_tag" runat="server">   Selenggara Maklumat Perkeso </h1>
                        <ol class="breadcrumb">
                            <li id="bb1_text" runat="server"><a href="#"><i class="fa fa-dashboard"></i>Sumber Manusia</a></li>
                            <li class="active" id="bb2_text" runat="server"> Selenggara Maklumat Perkeso </li>
                        </ol>
                    </section>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title" id="h3_tag" runat="server">Jadual Potongan Perkeso</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        ...
                        <div class="form-horizontal">
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-12 box-body" style="text-align:center;">
                              ...
                              <div class="box-header with-border">
                            <h3 class="box-title" id="h3_tag2" runat="server">Senarai Perkeso</h3>
                        </div>
                             <div class="box-body">&nbsp;</div>
                                  ...
                                  <asp:GridView ID="GridView1" runat="server" class="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="25" ShowFooter="false" GridLines="None" OnPageIndexChanging="SubmitAppraisalGrid_PageIndexChanging" OnRowCreated="grvMergeHeader_RowCreated">
                                       <PagerStyle CssClass="pager" />
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txt_min" style="text-align:right;" Width="100%" runat="server" ReadOnly="true" Text='<%#Eval("per_min_income_amt","{0:n}")%>' CssClass="form-control validate[optional,custom[number]] txt_min" />
                                                            </ItemTemplate>
                                                            <HeaderTemplate>
                                                                MINIMUM (RM)
                                                            </HeaderTemplate>
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txt_max" style="text-align:right;" Width="100%" runat="server" Text='<%#Eval("per_max_income_amt","{0:n}")%>' CssClass="form-control validate[optional,custom[number]] txt_max" />
                                                            </ItemTemplate>
                                                            <HeaderTemplate>
                                                                MAKSIMUM (RM)
                                                            </HeaderTemplate>
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txt_empamt1" style="text-align:right;" Width="100%" runat="server" Text='<%#Eval("per_employer_amt1","{0:n}")%>' CssClass="form-control validate[optional,custom[number]] txt_empamt1" />
                                                            </ItemTemplate>
                                                            <HeaderTemplate>
                                                                MAJIKAN (RM)
                                                            </HeaderTemplate>
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txt_empamt" style="text-align:right;" Width="100%" runat="server" Text='<%#Eval("per_employee_amt","{0:n}")%>' CssClass="form-control validate[optional,custom[number]] txt_empamt" />
                                                            </ItemTemplate>
                                                            <HeaderTemplate>
                                                                KAKITANGAN (RM)
                                                            </HeaderTemplate>
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txt_empamt2" style="text-align:right;" Width="100%" runat="server" Text='<%#Eval("per_employer_amt2","{0:n}")%>'
