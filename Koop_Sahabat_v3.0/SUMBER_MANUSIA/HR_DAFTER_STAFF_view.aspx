<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../SUMBER_MANUSIA/HR_DAFTER_STAFF_view.aspx.cs" Inherits="HR_DAFTER_STAFF_view" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1 id="h1_tag" runat="server"> Senarai Maklumat Kakitangan </h1>
                        <ol class="breadcrumb">
                            <li id="bb1_text" runat="server"><a href="#"><i class="fa fa-dashboard"></i>Sumber Manusia</a></li>
                            <li class="active" id="bb2_text" runat="server"> Senarai Maklumat Kakitangan</li>
                        </ol>
                    </section>
        ...
        <ContentTemplate>
           ...
           <div class="col-md-3 box-body" style="display:none;">
                                <div class="form-group">
                                    <div class="col-sm-12">
                                         <div class="input-group">
                                                <span class="input-group-addon" style="background-color:#008080; color:#fff;" ><i class="fa fa-search"></i></span>
                                             <asp:DropDownList ID="ddorganisasi" runat="server" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="lnkselect_Click"></asp:DropDownList>
                                             </div>
                                    </div>
                                ...
                                <div class="form-group">
                                     <div class="col-sm-12" style="text-align:right;">
                                         <asp:Button ID="Button1" runat="server" class="btn btn-warning" Text="Export" UseSubmitBehavior="false" OnClick="ctk_values" />
                                         <asp:Button ID="Button3" runat="server" class="btn btn-danger" Text="Hapus" UseSubmitBehavior="false" OnClick="btn_hups_Click" />
                                         <asp:Button ID="btn_tmbah" runat="server" Text="+ Tambah" OnClick="Add_profile"  class="align-center btn btn-primary"></asp:Button>
                                    </div>
                                </div>
                            </div>
      </div> 
                                                                                    ...
                                                                                    ItemStyle-Width="150" />
                                                                                        ...
                                                                                        <%--<asp:BoundField DataField="pos_start_dt" HeaderText="Tarikh Mula" />--%>
                                                                                         <asp:TemplateField HeaderText="No Kakitangan" ItemStyle-HorizontalAlign="Left">
                                                                                            <ItemTemplate>
                                                                                                  <%--<div style="display:inline-block;"><span class="dot_new"></span></div>--%>
                                                                                               <asp:LinkButton runat="server" ID="lnkView" OnClick="lnkView_Click" Font-Bold Font-Underline>
                                                                                                <asp:Label ID="lb_sno" runat="server" ToolTip='<%# Eval("stf_ss") %>'  Text='<%# Eval("stf_staff_no") %>'></asp:Label>
