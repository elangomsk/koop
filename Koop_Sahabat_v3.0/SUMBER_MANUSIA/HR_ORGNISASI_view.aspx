<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../SUMBER_MANUSIA/HR_ORGNISASI_view.aspx.cs" Inherits="HR_ORGNISASI_view" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1 id="h1_tag" runat="server"> Senarai Maklumat Organisasi </h1>
                        <ol class="breadcrumb">
                            <li id="bb1_text" runat="server"><a href="#"><i class="fa fa-dashboard"></i>Sumber Manusia</a></li>
                            <li class="active" id="bb2_text" runat="server"> Senarai Maklumat Organisasi </li>
                        </ol>
                    </section>
                                        ...
                                        <Columns>
                                         ...
                                         <asp:TemplateField HeaderText="BIL">  
                                            ...
                                            <ItemTemplate>  
                                                ...
                                                <asp:TemplateField HeaderText="No Daftar Organisasi">  
                                                <ItemStyle HorizontalAlign="center" Width="10%"></ItemStyle>
                                            <ItemTemplate>  
                                                 <asp:Label ID="Label2" runat="server"  Text='<%# Eval("org_id") %>'></asp:Label> 
                                            </ItemTemplate>  
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Nama Organisasi"> 
                                                <ItemStyle HorizontalAlign="Left" Width="25%" Font-Underline Font-Bold></ItemStyle>  
                                            <ItemTemplate>  
                                            <asp:LinkButton runat="server" ID="lnkView" OnClick="lnkView_Click">
                                                ...
                                                <asp:Label ID="Label1" Visible="false" runat="server"  Text='<%# Eval("org_state_cd") %>'></asp:Label>  
                                                <asp:Label ID="Label7" Visible="false" runat="server"  Text='<%# Eval("org_gen_id") %>'></asp:Label>  
                                                </asp:LinkButton> 
                                            </ItemTemplate>  
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Orang Hubungan 1">  
                                                <ItemStyle HorizontalAlign="Left" Width="25%"></ItemStyle> 
                                            <ItemTemplate>  
                                                <asp:Label ID="Label4" runat="server" Text='<%# Eval("org_contact_name1") %>'></asp:Label>  
                                            </ItemTemplate>  
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Orang Hubungan 2">   
                                                <ItemStyle HorizontalAlign="Left" Width="25%"></ItemStyle>
                                            <ItemTemplate>  
                                                <asp:Label ID="Label5" runat="server" Text='<%# Eval("org_contact_name2") %>'></asp:Label>  
                                            </ItemTemplate>  
                                                </asp:TemplateField>
