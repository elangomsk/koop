...
public partial class HR_Ref_table_mgmt : System.Web.UI.Page
{
...

    {
        ...
        {
            qry1 = "Select " + tc1 + " as c1," + tc2 + " as c2," + tc3 + " as c3," + tc4 + " as c4 from " + tn1 + " ORDER BY " + tc1 + " ASC";
        }
        else
        {
...

    {
        ...
        conn.Open();
            ...
            sel_val();
        service.audit_trail("P0097", "Hapus","KATEGORI", txtEditcode.Text);
...

        {
            ...
            if (txtAddName.Text != "" && txtAddcode.Text != "")
            {
                ...
                if (dtcenter.Rows.Count == 0)
                {
                    ...
                    service.audit_trail("P0097", "Simpan", "KATEGORI", txtAddcode.Text);
...

    {
        ...
        if (dtcenter.Rows.Count == 0)
        {
            ...
            sel_val();
            service.audit_trail("P0097", "Kemaskini", "KATEGORI", txtEditcode.Text);
