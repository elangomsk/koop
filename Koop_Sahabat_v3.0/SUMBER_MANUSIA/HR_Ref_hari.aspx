<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../SUMBER_MANUSIA/HR_Ref_hari.aspx.cs" Inherits="HR_Ref_hari" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1>  Selenggara Hari Bekerja </h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>SUMBER MANUSIA</a></li>
                            <li class="active"> Selenggara Hari Bekerja  </li>
                        </ol>
                    </section>
        ...
        <ContentTemplate>
           ...
           <div class="col-md-12 box-body">
                ...
                <Columns>           
                    ...
                    <asp:TemplateField HeaderText="Tahun" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Center">

                        <ItemTemplate>

                            <asp:Label ID="lblEmpID" class="uppercase" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "hk_year") %>'></asp:Label>
                        ...
                        <asp:TemplateField HeaderText="Bulan" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Center">

                        <ItemTemplate>

                            <asp:Label ID="lblName" class="uppercase" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "hr_month_desc") %>'></asp:Label>

                        </ItemTemplate>

                        <EditItemTemplate>           
                             <asp:DropDownList ID="txtEditcode" runat="server" style="width:100%;" class="form-control uppercase"></asp:DropDownList>
                        </EditItemTemplate>

                        <FooterTemplate>

                             <asp:DropDownList ID="txtAddcode" runat="server" style="width:100%;" class="form-control uppercase"></asp:DropDownList>

                        </FooterTemplate>

                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="Hari" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Center">

                        <ItemTemplate>

                            <asp:Label ID="lblcawangan" class="uppercase" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "hk_day") %>'></asp:Label>

                        </ItemTemplate>

                        <EditItemTemplate>           

                            <asp:TextBox ID="txtEditCawangan" class="form-control uppercase" runat="server" style="width:100%;" MaxLength="5" Text='<%#DataBinder.Eval(Container.DataItem, "hk_day") %>'></asp:TextBox>           

                        </EditItemTemplate>

                        <FooterTemplate>

                            <asp:TextBox ID="txtAddCawangan" placeholder="sila masukkan nilai" style="width:100%;" class="form-control uppercase" MaxLength="5" runat="server" ></asp:TextBox>
                    ...
                    <asp:TemplateField HeaderText="STATUS" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Center">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Label ID="status" class="uppercase" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "hk_Status").ToString() == "A" ? "Aktif" : "Tidak Aktif" %>'></asp:Label>
                        </ItemTemplate>
