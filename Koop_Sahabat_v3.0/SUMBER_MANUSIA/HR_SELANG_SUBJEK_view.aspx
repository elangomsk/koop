<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../SUMBER_MANUSIA/HR_SELANG_SUBJEK_view.aspx.cs" Inherits="HR_SELANG_SUBJEK_view" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1 id="h1_tag" runat="server">  Selenggara Subjek Penilaian </h1>
                        <ol class="breadcrumb">
                            <li id="bb1_text" runat="server"><a href="#"><i class="fa fa-dashboard"></i>Sumber Manusia</a></li>
                            <li class="active" id="bb2_text" runat="server"> Selenggara Subjek Penilaian </li>
                        </ol>
                    </section>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                          <asp:DropDownList ID="sel_rt" CssClass=" form-control uppercase" runat="server" AutoPostBack="true" OnSelectedIndexChanged="dd_SelectedIndexChanged">
                                              <asp:ListItem Value="23">Tuntutan Lain-Lain</asp:ListItem>
                                              <asp:ListItem Value="24">Tuntutan </asp:ListItem>
                                                            </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                                   ...
                                   <asp:GridView ID="gv_refdata" runat="server" class="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="1000000" ShowFooter="true" GridLines="None" OnRowCommand="gv_refdata_RowCommand"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="BIL" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="3%">
                                                                ...
                                                                <asp:TemplateField HeaderText="Bahagian" ItemStyle-Width="15%" >

                        <ItemTemplate>

                            <asp:Label ID="lblEmpID_1" class="uppercase" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "c6") %>'></asp:Label>
                        </ItemTemplate>

                        <EditItemTemplate>           

                            <asp:DropDownList ID="lbleditwilayah_1" runat="server" class="form-control uppercase"></asp:DropDownList>                            
                        </EditItemTemplate>

                        <FooterTemplate>

                            <asp:DropDownList ID="lbladdwilayah_1" runat="server" style="width:100%;" class="form-control uppercase"></asp:DropDownList>
                                                            ...
                                                            <asp:TemplateField HeaderText="SUBJEK KRITERIA" ItemStyle-Width="10%">
                                                                <ItemTemplate>
                                                             ...
                                                             <asp:TemplateField HeaderText="MARKAH" ItemStyle-Width="10%">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblName_amt" class="uppercase" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "c8") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <EditItemTemplate>
                                                                    <asp:TextBox ID="txtEditcode_amt" class="form-control uppercase" Width="100%" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "c8") %>'></asp:TextBox>
                                                                </EditItemTemplate>
                                                                <FooterTemplate>
