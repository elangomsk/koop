<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../SUMBER_MANUSIA/HR_PENG.aspx.cs" Inherits="HR_PENG" %>
                ...
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"> MAKLUMAT PENGALAMAN BEKERJA       </li>
                        </ol>
                    </section>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txt_nama" runat="server" class="form-control validate[required] uppercase"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
