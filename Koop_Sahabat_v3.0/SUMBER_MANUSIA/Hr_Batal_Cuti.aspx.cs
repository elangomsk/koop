...
public partial class SUMBER_MANUSIA_Hr_Batal_Cuti : System.Web.UI.Page
{
    ...
    void view_details()
    {
        ...
        if (ddokdicno1.Rows.Count != 0)
        {
            ...
            txt_peny.Text = ddokdicno1.Rows[0]["stf_name"].ToString();
            ...
            TextBox12.Text = ddokdicno1.Rows[0]["lap_cancel_reason"].ToString();
            TextBox1.Text = ddokdicno1.Rows[0]["lap_staff_no"].ToString();
            TextBox3.Text = ddokdicno1.Rows[0]["lap_staff_no"].ToString();
            Label4.Text = ddokdicno1.Rows[0]["lap_staff_no"].ToString();
            Label5.Text = ddokdicno1.Rows[0]["stf_name"].ToString();
    ...
    void grid1()
    {
        ...
        strQuery = "select * from (select a1.lev_staff_no,a1.hr_jenis_desc,case when a1.hr_jenis_desc = 'cuti tahunan' then '01' when a1.hr_jenis_desc = 'cuti sakit' then '02' when a1.hr_jenis_desc = 'cuti ganti' then '04'  "
                 ...
                 + " hr_leave_application where lap_staff_no ='" + TextBox3.Text + "' and lap_cancel_ind='N' and lap_leave_type_cd IN('04','05') and lap_approve_sts_cd NOT IN ('04','01') and ISNULL(lap_endorse_sts_cd,'') = '' "
                 ...
                 + "  hr_leave_application where lap_staff_no = '" + TextBox3.Text + "' and lap_cancel_ind = 'N' and lap_leave_type_cd IN('12') and lap_approve_sts_cd NOT IN('04', '01') and ISNULL(lap_endorse_sts_cd, '') = '' "
                 ...
                 + "   lap_staff_no = '" + TextBox3.Text + "' and lap_cancel_ind = 'N' and lap_leave_type_cd IN('12', '17') and lap_approve_sts_cd NOT IN('04', '01') and ISNULL(lap_endorse_sts_cd, '') = '01' and lap_cur_sts = 'Y' "
            ...
            if (ddicno.Rows.Count > 0)
            {
                if (TextBox12.Text != "" )
                {
                    ...
                    if (Status == "SUCCESS")
                    {
                        ...
                        //send_email();
                        service.audit_trail("P0220", "Batal", Label4.Text, TextBox7.Text);
                        Session["validate_success"] = "SUCCESS";
                        Session["alrt_msg"] = "Cuti Berjaya di Batalkan ";
                        Response.Redirect("../SUMBER_MANUSIA/Hr_Batal_cuti_view.aspx");
                    }
                }
                else
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "$.Zebra_Dialog('Sila Masukkan Sebab Batal.',{'type': 'warning','title': 'Warning','auto_close': 2000});", true);
                }
            }
        }
        else
    ...
    void send_email()
    {
        ...
        try
        {
            ...
            if (TextBox13.Text == "01" || TextBox13.Text == "04" || TextBox13.Text == "05" || TextBox13.Text == "17")
            {
            ...
            if (Mail_id3 != "")
            {
                ...
                //var toemail = new MailAddress("prasad.prasath2@gmail.com");
                var toemail = new MailAddress(Mail_id3);
                var fromemailpassword = "P@ssw0rd";
                string subject = "KTHB - Leave Approval";
