<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../SUMBER_MANUSIA/HR_LM_latihan.aspx.cs" Inherits="HR_LM_latihan" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1 id="h1_tag" runat="server">  Laporan Maklumat Latihan</h1>
                        <ol class="breadcrumb">
                            <li id="bb1_text" runat="server"><a href="#"><i class="fa fa-dashboard"></i>Sumber Manusia</a></li>
                            <li class="active" id="bb2_text" runat="server">  Laporan Maklumat Latihan  </li>
                        </ol>
                    </section>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label" id="lbl1_text" runat="server">  No Kakitangan /  Kakitangan</label>
                                    <div class="col-sm-8">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label" id="lbl2_text" runat="server">    Nama Syarikat /  Organisasi  </label>
                                    <div class="col-sm-8">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label" id="lbl8_text" runat="server">   Kategori Kursus  </label>
                                    <div class="col-sm-8">
                           ...
                           <div class="box-body">&nbsp;
                             ...
                             <div class="box-header with-border">
                            <h3 class="box-title" id="h3_tag2" runat="server"> Senarai Maklumat Latihan Kakitangan</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body">&nbsp;</div>
                                         ...
                                         <ItemStyle HorizontalAlign="center" Width="2%"></ItemStyle> 
                                            ...
                                            <ItemTemplate>  
                                               ...
                                               <asp:TemplateField HeaderText="Tajuk">  
                                                <ItemStyle HorizontalAlign="Center" Width="10%"></ItemStyle>
                                            <ItemTemplate>  
                                                 <asp:Label ID="trn_catatan" runat="server"  Text='<%# Eval("trn_catatan") %>'></asp:Label> 
                                            </ItemTemplate>  
                                                </asp:TemplateField>
                                                 <asp:TemplateField HeaderText="Tempat">   
                                                <ItemStyle HorizontalAlign="Center" Width="10%"></ItemStyle>
                                            <ItemTemplate>  
                                                <asp:Label ID="tot_dur" runat="server" Text='<%# Eval("tot_dur") %>'></asp:Label>  
                                            </ItemTemplate>  
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Tarikh">   
                                                <ItemStyle HorizontalAlign="Center" Width="10%"></ItemStyle>
                                            <ItemTemplate>  
                                                <asp:Label ID="s_gred" runat="server" Text='<%# Eval("dari") %>'></asp:Label>  
                                            </ItemTemplate>  
                                                </asp:TemplateField>
                                        </Columns>
