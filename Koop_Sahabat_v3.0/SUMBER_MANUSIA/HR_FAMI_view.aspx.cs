...
public partial class HR_FAMI_view : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("../SUMBER_MANUSIA/HR_FAMI.aspx");
    }
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../SUMBER_MANUSIA/HR_FAMI.aspx?edit={0}", name));
            }
            else
            {
                Session["validate_success"] = "";
