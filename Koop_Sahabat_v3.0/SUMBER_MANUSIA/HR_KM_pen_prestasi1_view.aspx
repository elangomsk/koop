<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../SUMBER_MANUSIA/HR_KM_pen_prestasi1_view.aspx.cs" Inherits="HR_KM_pen_prestasi1_view" %>
                                         ...
                                         <asp:TemplateField HeaderText="BIL">
                                            ...
                                            <ItemTemplate>  
                                               ...
                                               <asp:TemplateField HeaderText="KPI">   
                                                <ItemStyle HorizontalAlign="center" Width="3%"></ItemStyle>
                                            <ItemTemplate>  
                                                <asp:LinkButton runat="server" ID="lnkView" OnClick="lnkView_Click"><i class='fa fa-edit'></i></asp:LinkButton>
                                            </ItemTemplate>  
                                                </asp:TemplateField>
