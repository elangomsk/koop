<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../SUMBER_MANUSIA/HR_Ref_Institute.aspx.cs" Inherits="HR_Ref_Institute" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1 id="h1_tag" runat="server"> Selenggara Maklumat Institusi </h1>
                        <ol class="breadcrumb">
                            <li id="bb1_text" runat="server"><a href="#"><i class="fa fa-dashboard"></i>Sumber Manusia</a></li>
                            <li class="active" id="bb2_text" runat="server">Selenggara Maklumat Institusi</li>
                        </ol>
                    </section>
                ...
                <Columns>           
                    ...
                    <asp:TemplateField HeaderText="TARAF PENDIDIKAN">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblEmpID" class="uppercase" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "hr_pendi_desc") %>'></asp:Label>
                            <asp:TextBox ID="Id" Visible="false" class="uppercase" style="width:100%;" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Id") %>'></asp:TextBox>
                            <asp:TextBox ID="TextBox1" Visible="false" class="uppercase" style="width:100%;" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "hr_ins_desc") %>'></asp:TextBox>
                        </ItemTemplate>

                        <EditItemTemplate>           

                            <asp:DropDownList ID="lbleditwilayah" runat="server" class="form-control uppercase"></asp:DropDownList>
                            <asp:TextBox ID="Id" Visible="false" class="uppercase" style="width:100%;" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Id") %>'></asp:TextBox>
                        </EditItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="KOD INSTITUSI">

                        <ItemTemplate>

                            <asp:Label ID="lblName" class="uppercase" runat="server"  Text='<%#DataBinder.Eval(Container.DataItem, "hr_ins_Code") %>'></asp:Label>

                        </ItemTemplate>

                        <EditItemTemplate>           

                            <asp:TextBox ID="txtEditcode" class="form-control validate[optional,custom[onlyLetterNumberSp],minSize[4]] uppercase" style="width:100%;" MaxLength="4" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "hr_ins_Code") %>'></asp:TextBox>           

                        </EditItemTemplate>

                        <FooterTemplate>

                            <asp:TextBox ID="txtAddcode" placeholder="sila masukkan nilai" style="width:100%;" class="form-control validate[optional,custom[onlyLetterNumberSp],minSize[4]] uppercase" MaxLength="4" runat="server" ></asp:TextBox>

                        </FooterTemplate>

                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="NAMA INSTITUSI">

                        <ItemTemplate>

                            <asp:Label ID="lblcawangan" class="uppercase" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "hr_ins_desc") %>'></asp:Label>

                        </ItemTemplate>

                        <EditItemTemplate>           

                            <asp:TextBox ID="txtEditCawangan" class="form-control uppercase" style="width:100%;" runat="server" MaxLength="100" Text='<%#DataBinder.Eval(Container.DataItem, "hr_ins_desc") %>'></asp:TextBox>           
