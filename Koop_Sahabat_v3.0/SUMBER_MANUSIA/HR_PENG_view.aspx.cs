...
public partial class HR_PENG_view : System.Web.UI.Page
{
    ...
    protected void BindData_Grid()
    {
        ...
        SqlCommand cmd = new SqlCommand("select wrk_start_dt,wrk_end_dt,wrk_org_name,wrk_last_post From hr_experience where wrk_staff_no=''", con);
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../SUMBER_MANUSIA/HR_PENG.aspx?edit={0}", name));
            }
            else
            {
                Session["validate_success"] = "";
