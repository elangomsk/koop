<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../SUMBER_MANUSIA/HR_PROFESIONAL.aspx.cs" Inherits="HR_PROFESIONAL" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1 id="h1_tag" runat="server">  Maklumat Profesional </h1>
                        <ol class="breadcrumb">
                            <li id="bb1_text" runat="server"><a href="#"><i class="fa fa-dashboard"></i>Sumber Manusia</a></li>
                            <li class="active" id="bb2_text" runat="server"> Maklumat Profesional </li>
                        </ol>
                    </section>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txt_stfno" runat="server" class="form-control validate[optional] uppercase"
                            ...
                            <div class="box-header with-border">
                            <h3 class="box-title" id="h3_tag2" runat="server">Maklumat Kelayakan Profesional </h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body">&nbsp;</div>
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label" id="lbl8_text" runat="server">  Sijil Profesional  </label>
                                    <div class="col-sm-8">
                                       <asp:TextBox ID="txt_sipr" runat="server" class="form-control validate[optional] uppercase"
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label" id="lbl9_text" runat="server">  No Rujukan </label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txt_noru" runat="server" class="form-control validate[optional,custom[nodaft1]] uppercase"
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label" id="lbl10_text" runat="server">  Tarikh Dikeluarkan </label>
                                    <div class="col-sm-8">
                                       <div class="input-group">
                                                                    <asp:TextBox ID="txt_tadi" runat="server" class="form-control validate[optional,custom[dtfmt]] datepicker mydatepickerclass"
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label" id="lbl11_text" runat="server">  Tarikh Tamat </label>
                                    <div class="col-sm-8">
                                         <div class="input-group">
                                                                    <asp:TextBox ID="txt_tata" runat="server" class="form-control validate[optional,custom[dtfmt]] datepicker mydatepickerclass"
                                                                        placeholder="DD/MM/YYYY"></asp:TextBox>
                                              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                                </div>
                                       ...
                                       <PagerStyle CssClass="pager" />
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField Visible="false">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("cer_seq_no") %>' Visible="false"></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Tarikh Dikeluarkan" ItemStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="Label6" runat="server" Text='<%# Bind("d1","{0:dd/MM/yyyy}") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Tarikh Tamat" ItemStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="Label7" runat="server" Text='<%# Bind("d2","{0:dd/MM/yyyy}") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
