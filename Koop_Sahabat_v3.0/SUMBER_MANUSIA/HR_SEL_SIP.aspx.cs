...
public partial class HR_SEL_SIP : System.Web.UI.Page
{
    ...
    void app_language()
    {
        ...
        //h3_tag.InnerText = txtinfo.ToTitleCase(gt_lng.Rows[4][0].ToString().ToLower());  
        //h3_tag2.InnerText = txtinfo.ToTitleCase(gt_lng.Rows[11][0].ToString().ToLower()); 
    ...
    void grid()
    {
        ...
        SqlCommand cmd = new SqlCommand("SELECT id,SIP_min_income_amt,SIP_max_income_amt,SIP_employer_amt1,SIP_employee_amt,SIP_employer_amt2 FROM hr_comm_SIP ", con);
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("UPDATE hr_comm_SIP set SIP_min_income_amt='" + txt_min.Text + "',SIP_max_income_amt='" + txt_max.Text + "',SIP_employer_amt1='" + txt_empamt1.Text + "',SIP_employee_amt='" + txt_empamt.Text + "',SIP_employer_amt2='" + txt_empamt2.Text + "' where id='" + ID + "'", con);
        cmd.ExecuteNonQuery();
        con.Close();
    ...
    protected void insert_Click3(object sender, EventArgs e)
    {
        if (jpp_min.Text != "")
        {
            ...
            ddicno_per = DBCon.Ora_Execute_table("select * from hr_comm_SIP where SIP_min_income_amt='" + jpp_min.Text + "'");

            if (ddicno_per.Rows.Count == 0)
            {
                DBCon.Ora_Execute_CommamdText("INSERT INTO hr_comm_SIP (SIP_min_income_amt,SIP_max_income_amt,SIP_employer_amt1,SIP_employee_amt,SIP_employer_amt2,SIP_crt_id,SIP_crt_dt) values ('" + jpp_min.Text + "','" + jpp_mak.Text + "','" + jpp_maj1.Text + "','" + jpp_kak1.Text + "','" + jpp_maj2.Text + "','" + Session["New"].ToString() + "','" + DateTime.Now + "')");
                service.audit_trail("P0198", "Simpan","","");
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        foreach (GridViewRow row in GridView1.Rows)
        {
            ...
            comm.CommandText = "UPDATE hr_comm_SIP set SIP_max_income_amt='" + txt_max.Text + "',SIP_employer_amt1='" + txt_empamt1.Text + "',SIP_employee_amt='" + txt_empamt.Text + "',SIP_employer_amt2='" + txt_empamt2.Text + "',SIP_upd_id='" + Session["New"].ToString() + "',SIP_upd_dt='" + DateTime.Now + "' where SIP_min_income_amt='" + txt_min.Text + "' and id='" + lblTitle.Text + "'";
            comm.Connection = con;
            comm.Parameters.AddWithValue("@id", lblTitle.Text.Trim());
            comm.Parameters.AddWithValue("@SIP_min_income_amt", txt_min.Text.Trim());
            comm.Parameters.AddWithValue("@SIP_max_income_amt", txt_max.Text.Trim());
            comm.Parameters.AddWithValue("@SIP_employer_amt1", txt_empamt1.Text.Trim());
            comm.Parameters.AddWithValue("@SIP_employee_amt", txt_empamt.Text.Trim());
            comm.Parameters.AddWithValue("@SIP_employer_amt2", txt_empamt2.Text.Trim());
            con.Open();
            comm.ExecuteNonQuery();
            con.Close();
        }
        service.audit_trail("P0198", "Kemaskini","","");
