<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../SUMBER_MANUSIA/HR_REF_INTEGRASI.aspx.cs" Inherits="HR_REF_INTEGRASI" %>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                          <asp:DropDownList ID="sel_rt" CssClass=" form-control uppercase" runat="server" AutoPostBack="true" OnSelectedIndexChanged="dd_SelectedIndexChanged">
                                                               ...
                                                               <asp:ListItem Value="01">Gaji</asp:ListItem>
                                                                <asp:ListItem Value="02">Jenis Elaun</asp:ListItem>
                                                                <asp:ListItem Value="03">Potongan</asp:ListItem>
                                                            </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
           ...
           <div class="col-md-12 box-body">
                                  <asp:GridView ID="gv_refdata" runat="server" class="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="25" ShowFooter="true" GridLines="None" OnRowCommand="gv_refdata_RowCommand"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <EditItemTemplate>           
                                                                <asp:DropDownList ID="lbleditkodID" runat="server" class="form-control uppercase"  ></asp:DropDownList>
                                                            </EditItemTemplate>
                                                          ...
                                                          <asp:TemplateField HeaderText="KOD AKAUN KREDIT">
                                                            ...
                                                            <EditItemTemplate>           
                                                                <asp:DropDownList ID="lbleditkodID1" runat="server" class="form-control uppercase"></asp:DropDownList>
                                                            </EditItemTemplate>
                                                           
                                                        </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="STATUS">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="status" class="uppercase" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "C4").ToString() == "A" ? "Aktif" : "Tidak Aktif" %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <EditItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="TINDAKAN" ItemStyle-Width="7%" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:ImageButton ID="imgbtnDelete" OnClientClick="if (!confirm('Adakah Anda pasti?')) return false;" runat="server" CommandName="Delete"
                                                                        ImageUrl="../Login_assets/img/Delete.jpg" Height="22px" Width="22px" />
                                                                </ItemTemplate>
                                                                <EditItemTemplate>
