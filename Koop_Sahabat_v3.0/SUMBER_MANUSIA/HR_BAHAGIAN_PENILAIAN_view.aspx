<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../SUMBER_MANUSIA/HR_BAHAGIAN_PENILAIAN_view.aspx.cs" Inherits="HR_BAHAGIAN_PENILAIAN_view" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1 id="h1_tag" runat="server"> Senarai Maklumat Bahagian </h1>
                        <ol class="breadcrumb">
                            <li id="bb1_text" runat="server"><a href="#"><i class="fa fa-dashboard"></i>Sumber Manusia</a></li>
                            <li id="bb2_text" runat="server" class="active"> Senarai Maklumat Bahagian </li>
                        </ol>
                    </section>
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="CATATAN">
                                                                  ...
                                                                  <asp:TemplateField HeaderText="MARKAH WAJARAN">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("cse_marks") %>' CssClass="uppercase"></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
