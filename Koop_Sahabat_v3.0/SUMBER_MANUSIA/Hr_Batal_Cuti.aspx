<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="Hr_Batal_Cuti.aspx.cs" Inherits="SUMBER_MANUSIA_Hr_Batal_Cuti" %>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title" id="h3_tag" runat="server"> Maklumat Pembatalan  Cuti </h3>
                        </div> 
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                              ...
                              <div class="box-header with-border">
                            <h3 class="box-title" id="h3_tag2" runat="server">Maklumat Pembatalan  Cuti</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body">&nbsp;</div>
                        ...
                        <div class="box-body">&nbsp;</div>
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label" id="lbl7_text" runat="server"> Status Kelulusan</label>
                                    <div class="col-sm-8  text-right">
                                   ...
                                   <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label" id="lbl8_text" runat="server"> Catatan</label>
                                    <div class="col-sm-8  text-right">
                            ...
                            <div class="col-md-6 box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8 text-right">
                                     ...
                                     <%-- <div class="box-header with-border">
                            <h3 class="box-title" id="h3_tag4" runat="server">Kelulusan Bahagian Sumber Manusia</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body">&nbsp;</div>--%>
                             ...
                             <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8 text-right">
                                        <asp:label ID="txt_catat" runat="server" class="uppercase" MaxLength="500"></asp:label>
                                  ...
                                  <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label" id="Label7" runat="server">  Sebab Batal <span class="style1">*</span></label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="TextBox12" runat="server" class="form-control validate[optional] uppercase" MaxLength="500"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                                 </div>
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-12 box-body" style="text-align:center;">
                                ...
                                <asp:Button ID="Btn_submit" runat="server" class="btn btn-danger" Text="Batal" UseSubmitBehavior="false" onclick="Btn_submit_Click" />
