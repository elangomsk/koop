...
public partial class SUMBER_MANUSIA_HR_SEL_KWSP : System.Web.UI.Page
{
    ...
    void grid()
    {
        ...
        SqlCommand cmd = new SqlCommand("SELECT h1,h2 FROM kwsp_cal order by h1", con);
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("UPDATE kwsp_cal set h2='" + txt_max.Text + "' where h1='" + txt_min.Text + "'", con);
        cmd.ExecuteNonQuery();
        con.Close();
    ...
    protected void insert_Click3(object sender, EventArgs e)
    {
        if (jpp_min.Text != "")
        {
            ...
            ddicno_per = DBCon.Ora_Execute_table("select * from kwsp_cal where h1='" + jpp_min.Text + "'");

            if (ddicno_per.Rows.Count == 0)
            {
                DBCon.Ora_Execute_CommamdText("INSERT INTO kwsp_cal (h1,h2) values ('" + jpp_min.Text + "','" + jpp_mak.Text + "')");
                service.audit_trail("P0215", "Simpan","","");
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        service.audit_trail("P0215", "Kemaskini", "", "");
