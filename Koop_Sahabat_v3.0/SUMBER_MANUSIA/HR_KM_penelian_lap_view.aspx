<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../SUMBER_MANUSIA/HR_KM_penelian_lap_view.aspx.cs" Inherits="HR_KM_penelian_lap_view" %>
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:Dropdownlist ID="txt_tahun" runat="server" ReadOnly="true" class="form-control select2 validate[optional] uppercase" OnSelectedIndexChanged="chg_tahun" AutoPostBack="true"></asp:Dropdownlist>
                                    </div>
                                </div>
                            </div>
