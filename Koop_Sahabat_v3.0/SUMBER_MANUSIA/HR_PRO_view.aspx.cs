...
public partial class HR_PRO_view : System.Web.UI.Page
{
    ...
    protected void BindData_Grid()
    {
        ...
        SqlCommand cmd = new SqlCommand("select cer_name,cer_ref_no,ISNULL(CASE WHEN cer_issue_date = '1900-01-01 00:00:00.000' THEN '' ELSE FORMAT(cer_issue_date,'dd/MM/yyyy', 'en-us') END, '') AS cer_issue_date, ISNULL(CASE WHEN cer_expiry_date = '1900-01-01 00:00:00.000' THEN '' ELSE FORMAT(cer_expiry_date,'dd/MM/yyyy', 'en-us') END, '') AS cer_expiry_date From hr_pro_cert where cer_staff_no=''", con);
    ...
    {
        Response.Redirect("../SUMBER_MANUSIA/HR_PRO.aspx");
    }
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../SUMBER_MANUSIA/HR_PRO.aspx?edit={0}", name));
            }
            else
            {
                Session["validate_success"] = "";
