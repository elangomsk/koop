...
public partial class HR_KEMESKINI_KRITE_view : System.Web.UI.Page
{
    ...
    protected void BindData_Grid()
    {
        ...
        SqlCommand cmd = new SqlCommand("select FORMAT(a.cap_start_dt, 'yyyy-MM-dd') as dt1, FORMAT(a.cap_end_dt, 'yyyy-MM-dd') as dt2, a.cap_post_cat_cd, a.cap_unit_cd, a.cap_section_cd, a.cap_subject_cd, a.cap_seq_no, cas.cse_section_desc, cs.csb_subject_desc, a.cap_weightage, c1.hr_jaw_desc, c2.hr_unit_desc from(select * from hr_cmn_appraisal as ca where ca.cap_start_dt >= DATEADD(day, DATEDIFF(day, 0, '2018-01-01'), 0) and ca.cap_start_dt <= DATEADD(day, DATEDIFF(day, 0, '2018-01-31'), +0)) a left join hr_cmn_appr_section as cas on cas.cse_section_cd = a.cap_section_cd left join hr_cmn_subject as cs on cs.csb_subject_cd = a.cap_subject_cd left join Ref_hr_Jawatan c1 on c1.hr_jaw_Code = a.cap_post_cat_cd left join Ref_hr_unit c2 on c2.hr_unit_Code = a.cap_unit_cd", con);
    ...
    {
        Response.Redirect("../SUMBER_MANUSIA/HR_KEMESKINI_KRITE.aspx");
    }
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ddokdicno = DBCon.Ora_Execute_table("select * From hr_cmn_appraisal where Id='" + lblTitle.Text + "' ");
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../SUMBER_MANUSIA/HR_KEMESKINI_KRITE.aspx?edit={0}", name));
            }
            else
            {
                Session["validate_success"] = "";
