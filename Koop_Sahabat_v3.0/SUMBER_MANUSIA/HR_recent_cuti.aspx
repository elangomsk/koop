<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../SUMBER_MANUSIA/HR_recent_cuti.aspx.cs" Inherits="HR_recent_cuti" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1 > Senarai Cuti </h1>
                        <ol class="breadcrumb">
                              <li><a href="../HR_Dashboard.aspx"><i class="fa fa-dashboard"></i>Dashboard</a></li>
                            <li class="active" > Senarai Cuti   </li>
                        </ol>
                    </section>
