<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../SUMBER_MANUSIA/Hr_Kem_Mak_Dis_view.aspx.cs" Inherits="Hr_Kem_Mak_Dis_view" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1 id="h1_tag" runat="server">Senarai Disiplin Kakitangan</h1>
                        <ol class="breadcrumb">
                            <li id="bb1_text" runat="server"><a href="#"><i class="fa fa-dashboard"></i>Sumber Manusia</a></li>
                            <li class="active" id="bb2_text" runat="server">Senarai Disiplin Kakitangan</li>
                        </ol>
                    </section>
        ...
        <ContentTemplate>
           ...
           <div class="col-md-12 box-body">
                                <asp:GridView ID="GridView1" runat="server" class="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="10000000" ShowFooter="false" GridLines="None">
                                                                                    <Columns>
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblRowNumber" Text='<%# Container.DataItemIndex + 1 %>' runat="server"
                                                                                    ItemStyle-Width="150" />
                                                                                         ...
                                                                                         <asp:TemplateField HeaderText="No Kakitangan" ItemStyle-HorizontalAlign="Left">
                                                                                            <ItemTemplate>
                                                                                               <asp:LinkButton runat="server" ID="lnkView" OnClick="lnkView_Click" Font-Bold Font-Underline>
                                                                                                <asp:Label ID="lb_sno" runat="server" Text='<%# Eval("stf_staff_no") %>'></asp:Label>
                                                                                        ...
                                                                                        <asp:BoundField DataField="pos_end_dt" ItemStyle-HorizontalAlign="center" HeaderText="Tarikh Tamat" />
                                                                                        ...
                                                                                        <asp:BoundField DataField="job_sts" ItemStyle-HorizontalAlign="center" HeaderText="Status Penjawatan" />
