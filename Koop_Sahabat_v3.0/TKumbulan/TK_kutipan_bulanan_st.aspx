<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../TKumbulan/TK_kutipan_bulanan_st.aspx.cs" Inherits="TK_kutipan_bulanan_st" %>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-4 control-label"> Jenis Sahabat <span style="color: Red">*</span> </label>
                                    <div class="col-sm-8">
