<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="TK_Muatnaik_pst.aspx.cs" Inherits="TKumbulan_TK_Muatnaik_pst" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                ...
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1>Muatnaik Data Pengeluaran Simpanan Tetap</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>Tabung Kumpulan</a></li>
                            <li class="active">Muatnaik Fail PST</li>
                        </ol>
                    </section>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Maklumat Muatnaik Fail PST</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                         <asp:DropDownList ID="ddljp" runat="server" class="form-control validate[optional] select2 uppercase">
                                                                </asp:DropDownList>
                                        <br /><br />
                                ...
                                <div class="form-group">
                                    <div class="col-sm-8">
                                        <asp:Button ID="btnsmit" runat="server" class="btn btn-success" Text="Muatnaik"  UseSubmitBehavior="false" onclick="btnsmit_Click"/>  &nbsp;
