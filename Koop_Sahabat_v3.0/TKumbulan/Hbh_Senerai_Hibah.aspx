<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../TKumbulan/Hbh_Senerai_Hibah.aspx.cs" Inherits="Hbh_Senerai_Hibah" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                ...
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1>Senerai Kiraan Hibah</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>Tabung Kumpulan</a></li>
                            <li class="active">Senerai Kiraan Hibah</li>
                        </ol>
                    </section>
        ...
        <ContentTemplate>    
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                  ...
                                  <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Nama Wilayah </label>
                                    <div class="col-sm-8">
                                  <asp:DropDownList ID="ddwil" class="form-control validate[optional] select2 uppercase" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DD_wilayah_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                                 </div>
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Nama Cawangan</label>
                                    <div class="col-sm-8">
                                    <asp:DropDownList ID="DD_cawangan" class="form-control select2 uppercase" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
         ...
         <Columns>
            <asp:TemplateField HeaderText="No KP" ItemStyle-HorizontalAlign="Left" >
              ...
              <asp:BoundField DataField="mem_hbh_BAKI_ST" HeaderText="Baki ST" DataFormatString="{0:N}" ItemStyle-HorizontalAlign="Right" />
              <asp:BoundField DataField="bank_no" HeaderText="No Akaun Bank" />
...
<ItemTemplate>
    ...
    <asp:CheckBox ID="deleteRec" onclick="return check_uncheck (this );"
                             ...
                             <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                     <%--  <asp:Button ID="Button3" runat="server" class="btn btn-danger" Visible="false" Text="Submit" OnClick="Button3_Click"  />
                                                            <asp:Button ID="Button4" runat="server" class="btn btn-danger" Visible="false" Text="Batal"/>--%>
                                    </div>
                                </div>
                            </div>
                                 </div>
