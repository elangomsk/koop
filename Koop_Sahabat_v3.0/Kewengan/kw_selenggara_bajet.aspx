<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_selenggara_bajet.aspx.cs" Inherits="kw_selenggara_bajet" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1><asp:Label ID="ps_lbl1" Visible="false" runat="server"></asp:Label> Selenggara Bajet</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i><asp:Label ID="ps_lbl2" Visible="false" runat="server"></asp:Label>Kewangan</a></li>
                            <li class="active"><asp:Label ID="ps_lbl3" Visible="false" runat="server"></asp:Label>Selenggara Bajet</li>
                        </ol>
                    </section>
                        ...
                        <div class="form-horizontal">
                         ...
                         <%--   <div class="col-md-6 box-body">
                             ...
                             <div class="col-md-12">
                                   ...
                                   <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Kategori Bajet <span class="style1">*</span></label>
                                    <div class="col-sm-8">
