...
public partial class kw_mohon_bayar : System.Web.UI.Page
{
    ...
    void bind_bank()
    {
        ...
        try
        {
            string com = "select Bank_Code,upper(Bank_Name) as Bank_Name from Ref_Nama_Bank where Status='A'";
...

    {
        if (Session["New"] != null)
        {
            ...
            ps_lbl31.Text = gt_lng.Rows[31][0].ToString();
    ...
    protected void Mohon_disChangedBil(object sender, EventArgs eventArgs)
    {
        ...
        if (tgst_1 != "")
        {
            if (chk.Checked == true)
            {
                ...
                decimal tot1 = ((Convert.ToDecimal(unit.Text) * Convert.ToDecimal(qty.Text)) - Convert.ToDecimal(dis1));
                ...
                numTotal3 = Convert.ToDecimal(tot1);
        ...
        else
        {
            if (qty.Text != "" && unit.Text != "")
            {
                ...
                if (dis.Text != "")
                {
                    numTotal1 = ((Convert.ToDecimal(unit.Text) * Convert.ToDecimal(qty.Text)) - Convert.ToDecimal(dis.Text));
                }
                else
                {
                    numTotal1 = (Convert.ToDecimal(unit.Text) * Convert.ToDecimal(qty.Text));
                }
                if (chk.Checked == true)
                {
                    if (gmt1 != "")
                ...
                else
                {
                    ...
                    //txt.Text = numTotal4.ToString("C").Replace("RM", "").Replace("$", "");
                    //gamt.Text = numTotal4.ToString("C").Replace("RM", "").Replace("$", "");
                    numTotal2 = Convert.ToDecimal(numTotal1) + numTotal4;
                    numTotal3 = Convert.ToDecimal(txt1.Text);
                    tOt.Text = numTotal2.ToString("C").Replace("RM", "").Replace("$", "");
                    txt1.Text = numTotal2.ToString("C").Replace("RM", "").Replace("$", "");
                }
        ...
        else
        {
            if (qty.Text != "" && unit.Text != "")
            {
                ...
                else
                {
                    ...
                    //gamt.Text = numTotal4.ToString("C").Replace("RM", "").Replace("$", "");
                    numTotal2 = Convert.ToDecimal(numTotal1) + numTotal4;
                    numTotal3 = Convert.ToDecimal(numTotal1);
                    tOt.Text = numTotal2.ToString("C").Replace("RM", "").Replace("$", "");
                    txt1.Text = numTotal3.ToString("C").Replace("RM", "").Replace("$", "");
                }
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        //{
            ...
            {
            float gt_tot = 0;
            if (txttarkihmo.Text != "" && ddbkepada.SelectedValue != "" && DropDownList2.SelectedValue != "" && DropDownList1.SelectedValue != "" && TextBox16.Text != "")
                {
    ...
    protected void btnkem_Click(object sender, EventArgs e)
    {
        if (txtnoper.Text != "")
        {
            if (txttarkihmo.Text != "" && ddbkepada.SelectedValue != "" && DropDownList2.SelectedValue != "" && DropDownList1.SelectedValue != "")
            {
                ...
                userid = Session["New"].ToString();
                DataTable dt = new DataTable();
                string Inssql_main = "update KW_Pembayaran_mohon  set perkara='"+ TextBox16.Text +"',tarkih_permohonan='" + tDate.ToString("yyyy-MM-dd") + "',Terma='" + dd_terma.SelectedValue + "',Jenis_permohonan='" + ddbkepada.SelectedValue + "',no_ruj='" + txtname.Text + "',cara_bayaran='" + DropDownList2.SelectedValue + "',kat_penerima='" + DropDownList1.SelectedValue + "',tarkih_invois='" + doc_dt + "',PO_no='" + TextBox9.Text + "',DO_no='" + TextBox14.Text + "',upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy / MM / dd hh: mm:ss") + "' where no_permohonan='" + txtnoper.Text + "'";
                Status = DBCon.Ora_Execute_CommamdText(Inssql_main);
                if (Status == "SUCCESS")
                {
                    BindMohon();
    ...
    protected void lblSubbind_Click(object sender, EventArgs e)
    {
        ...
        Session["permohon_no"] = CommandArgument1;
        bind_mohon_info();
    }

    void bind_mohon_info()
    {
        ...
        DataTable dt = new DataTable();
        dt = Dbcon.Ora_Execute_table("select no_permohonan,perkara,Catatan,id_profile_syarikat,semak_sts,ID_pemohon,PO_no,DO_no,jumlah,Format(tarkih_invois,'dd/MM/yyyy') as tk_invois,Format(tarkih_permohonan,'dd/MM/yyyy') as tk_mohon,Jenis_permohonan,no_ruj,cara_bayaran,kat_penerima,Terma,s1.Kk_username nama_pemohon from KW_Pembayaran_mohon m1 left join KK_User_Login s1 on s1.KK_userid=ID_pemohon and s1.Status='A' where no_permohonan='" + Session["permohon_no"].ToString() + "' and m1.Status='A'");
        //tab1();
        if (dt.Rows.Count != 0)
        {
            ...
            txtid.Text = dt.Rows[0]["nama_pemohon"].ToString();
            txtid.Attributes.Add("disabled", "disabled");
            ...
            //get_sum_item = Dbcon.Ora_Execute_table("select sum(mhn_amount_bsr) amt from KW_Pembayaran_mohon_item where mhn_no_permohonan='" + CommandArgument1 + "' and Status='A'");

            //TextBox17.Text = double.Parse(get_sum_item.Rows[0]["amt"].ToString()).ToString("C").Replace("$","").Replace("RM", "");
            query1 = "select mhn_byr_kepada as kepada,UPPER(mhn_keterangan) as Keteragan,s2.Ref_Projek_name as projek,s3.Bank_Name as bank,s1.mhn_noacc_bank as acc_no,mhn_amount as jumlah, mhn_disc as Disk "
                           + " ,UPPER(ISNULL(s4.Ref_nama_cukai,'')) as jen_cukai, s1.mhn_tax as cukai_amt, s1.mhn_amount_bsr as amount ,m1.kat_penerima as kat "
                           ...
                           + " left join KW_Ref_Tetapan_cukai s4 on s4.Ref_kod_cukai=s1.mhn_jns_tax  where mhn_no_permohonan='" + Session["permohon_no"].ToString() + "' and s1.Status='A'";
    ...
    {
        if (Session["permohon_no"].ToString() != "")
        {
            CommandArgument3 = "";
            bind_mohon_info();
            Session["permohon_no"] = txtnoper.Text;
    ...
    {
        Response.Redirect("../kewengan/kw_mohon_bayar.aspx");
    }
    protected void BindMohon()
    {
        ...
        {
            condtion = "and tarkih_permohonan = '"+ tmdate + "' and no_permohonan = '"+ txtnoinvois.Text + "' and a.no_ruj = '" + TextBox13.Text + "'";
        }
        else if (txtnoinvois.Text == "" && txttarikhinvois.Text != "" && TextBox13.Text == "")
        {
            condtion = "and tarkih_permohonan = '" + tmdate + "'";
        }
        else if (txtnoinvois.Text == "" && txttarikhinvois.Text == "" && TextBox13.Text != "")
        {
            condtion = "and a.no_ruj = '" + TextBox13.Text + "'";
        }
        else if (txtnoinvois.Text != "" && txttarikhinvois.Text != "" && TextBox13.Text == "")
        {
            condtion = "and tarkih_permohonan = '" + tmdate + "' and no_permohonan = '" + txtnoinvois.Text + "'";
        }
        else if (txtnoinvois.Text == "" && txttarikhinvois.Text != "" && TextBox13.Text != "")
        {
            condtion = "and no_permohonan = '" + txtnoinvois.Text + "' and a.no_ruj = '" + TextBox13.Text + "'";
        }
        else if (txtnoinvois.Text != "" && txttarikhinvois.Text == "" && TextBox13.Text != "")
        {
            condtion = "and tarkih_permohonan = '" + tmdate + "' and a.no_ruj = '" + TextBox13.Text + "'";
        }
        else if (txtnoinvois.Text != "" && txttarikhinvois.Text == "" && TextBox13.Text == "")
        {
            condtion = "and no_permohonan = '" + txtnoinvois.Text + "'";
        }

        qry1 = "select kat_penerima,Format(tarkih_permohonan,'dd/MM/yyyy')tarkih_permohonan,no_permohonan,b.mhn_byr_kepada as  Bayar_kepada,a.jumlah as  jumlah,CASE ISNULL(chk_sts,'')  WHEN '' THEN 'WAITING'  WHEN 'P' THEN 'PROSES' WHEN 'L' THEN 'LULUS' END  as status,ISNULL(lulus_sts,'') lul_sts_cd,CASE ISNULL(lulus_sts,'')  WHEN '' THEN 'WAITING'  WHEN 'P' THEN 'PROSES' WHEN 'L' THEN 'LULUS' END  as lul_status,a.no_ruj,perkara mhn_keterangan  from KW_Pembayaran_mohon a OUTER APPLY (select top(1)* from KW_Pembayaran_mohon_item s2 where s2.Status='A' and s2.mhn_no_permohonan=a.no_permohonan order by cr_dt asc) as b  where a.Status='A' " + condtion + "";
    ...
    protected void bind_bank_details(object sender, EventArgs eventArgs)
    {
        GridViewRow row = ((GridViewRow)((DropDownList)sender).NamingContainer);
        DropDownList kodakaun = (DropDownList)row.FindControl("TextBox11");
        DropDownList bank_cd = (DropDownList)row.FindControl("dd_bank");
        TextBox no_acc_bank = (TextBox)row.FindControl("TextBox12");
        ...
        if (DropDownList1.SelectedValue == "01")
        {
            ste_set = DBCon.Ora_Execute_table("SELECT ISNULL(stf_bank_cd,'') as val1,ISNULL(stf_bank_acc_no,'') as val2 FROM hr_staff_profile s1 left join hr_post_his s2 on s2.pos_staff_no=s1.stf_staff_no and pos_end_dt >='" + DateTime.Now.ToString("yyyy-MM-dd") + "' where stf_staff_no='"+ kodakaun.SelectedValue + "'");            
        }
        else if (DropDownList1.SelectedValue == "02")
        {
            ste_set = DBCon.Ora_Execute_table("select ISNULL(pem_bank_cd,'') as val1,ISNULL(pem_bank_accno,'') as val2 from KW_Ref_Pembekal where Status='A' and Ref_no_syarikat='" + kodakaun.SelectedValue + "'");
        }
        else if (DropDownList1.SelectedValue == "03")
        {
            ste_set = DBCon.Ora_Execute_table("select ISNULL(pel_bank_cd,'') as val1,ISNULL(pel_bank_accno,'') as val2 from KW_Ref_Pelanggan where Status='A' and Ref_no_syarikat='" + kodakaun.SelectedValue + "'");            
        }
        if(ste_set.Rows.Count != 0)
        {
            if (ste_set.Rows[0]["val1"].ToString().Trim() != "")
            {
                bank_cd.SelectedValue = ste_set.Rows[0]["val1"].ToString().Trim();
            }
            no_acc_bank.Text = ste_set.Rows[0]["val2"].ToString().Trim();
        }
    }
    ...
    void shw_grd_info()
    {
        if (DropDownList1.SelectedValue != "")
        {
            ...
            foreach (GridViewRow row in grdmohon.Rows)
            {
                ...
                if (DropDownList1.SelectedValue == "01")
                {
                    innerDropdown.DataSource = GetData("SELECT stf_name as val1,stf_staff_no as val2 FROM hr_staff_profile s1 left join hr_post_his s2 on s2.pos_staff_no=s1.stf_staff_no and pos_end_dt >='" + DateTime.Now.ToString("yyyy-MM-dd") + "' where ISNULL(stf_kod_akaun,'') != ''");
                }
                else if (DropDownList1.SelectedValue == "02")
                {
                ...
                {
                    innerDropdown.DataSource = GetData("select Ref_nama_syarikat as val1,Ref_no_syarikat as val2 from KW_Ref_Pelanggan where Status='A' and ISNULL(Ref_kod_akaun,'') != ''");
                }
    ...
    protected void GridView1_RowDataBound1(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                ddokdicno = DBCon.Ora_Execute_table("select Ref_nama_syarikat as val1,Ref_no_syarikat as val2 from KW_Ref_Pelanggan where Status='A' and Ref_no_syarikat=''");
            }
            if (ddokdicno.Rows.Count != 0)
            {
