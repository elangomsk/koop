<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_lep_gst_summary.aspx.cs" Inherits="kw_lep_gst_summary" %>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <label><asp:CheckBox ID="zero_bal" runat="server" /> &nbsp;<asp:Label ID="ps_lbl7" runat="server"></asp:Label> </label>
                                    </div>
                                </div>
                            </div>
                                 </div>
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-12 box-body" style="text-align:center;">
                                ...
                                <asp:Button ID="Button2" runat="server" class="btn btn-warning sub_btn" Text="Text File" OnClick="Btn_Cetak_Click" UseSubmitBehavior="false" />
