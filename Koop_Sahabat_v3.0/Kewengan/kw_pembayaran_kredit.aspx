<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_pembayaran_kredit.aspx.cs" Inherits="kw_pembayaran_kredit" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1><asp:Label ID="ps_lbl1" runat="server"></asp:Label>Kreditor Nota Kredit</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i><asp:Label ID="ps_lbl2" runat="server"></asp:Label></a>Kewangan</li>
                            <li class="active"><asp:Label ID="ps_lbl3" runat="server"></asp:Label>Kreditor Nota Kredit</li>
                        </ol>
                    </section>
          ...
          <asp:TemplateField HeaderText="BIL">  
           ...
           <div class="col-md-12 box-body">
            ...
            <asp:TemplateField HeaderText="BIL">  
             ...
             <asp:TemplateField HeaderText="No Nota Kredit" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
                                                                    ...
                                                                    <div class="row">
                                                                         <div class="col-md-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                     <div class="input-group">
                                                                                  <asp:TextBox ID="TextBox4" ReadOnly="true" runat="server" class="form-control uppercase validate[optional]"></asp:TextBox> 
                                                                                           <span class="input-group-addon"><i class="fa fa-edit"></i></span>
                                             </div>
...
<asp:BoundField DataField="tot" HeaderText="Amaun (RM)" HeaderStyle-HorizontalAlign="Right" DataFormatString="{0:n}" ItemStyle-HorizontalAlign="Right" />
  ...
  <asp:gridview ID="Gridview10" runat="server"  class="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="20" ShowFooter="true" GridLines="None" OnRowDeleting="grvStudentDetails_RowDeleting" onrowdatabound="Gridview9_RowDataBound" >
             ...
             <asp:TemplateField HeaderText="Kod Akaun (CR)" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Keterangan" ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate>
                     <asp:TextBox ID="Txtdis" runat="server"  class="form-control uppercase" Width="100%" Text='<%# Eval("column3","{0:n}") %>'  placeholder="0.00"   OnTextChanged="QtyChanged1" AutoPostBack="true"   style="text-align:right;"    ></asp:TextBox>
                </ItemTemplate>
                 <FooterStyle HorizontalAlign="Right" />
                <FooterTemplate>
            ...
            <asp:TemplateField HeaderText="Jenis Cukai" ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate>
                    <asp:Label ID="Label5" class="form-control uppercase" Width="100%" Text='<%# Eval("column10","{0:n}") %>' style="text-align:right;" runat="server" ></asp:Label>
                </ItemTemplate>
                 <FooterStyle HorizontalAlign="Right" />
                <FooterTemplate>
                  <asp:Label ID="Label6" class="form-control uppercase" Width="100%"  runat="server" Text="0.00"  ></asp:Label>
