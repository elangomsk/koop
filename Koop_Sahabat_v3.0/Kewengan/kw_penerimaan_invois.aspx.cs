...
public partial class kw_penerimaan_invois : System.Web.UI.Page
{
    ...
    void bank_info()
    {
        ...
        try
        {
            ...
            string com1 = "select Ref_No_akaun,Ref_nama_bank from KW_Ref_Akaun_bank where Status='A'";
    ...
    protected void Mohon_disChangedBil(object sender, EventArgs eventArgs)
    {
        ...
        if (tgst_1 != "")
        {
            ...
            {
                decimal tot1 = ((Convert.ToDecimal(unit.Text) * num_qty) - Convert.ToDecimal(dis.Text)) + Convert.ToDecimal(gmt1);
                ...
                numTotal2 = Convert.ToDecimal(tOt.Text) + numTotal1 + Convert.ToDecimal(gmt1);
                   if (dis.Text != "")
                    {
                        numTotal2 = (tot1) + numTotal1 + Convert.ToDecimal(gmt.Text);
                    }
                    else
                    {
                        numTotal2 = (tot1) + numTotal1 + Convert.ToDecimal(gmt.Text);
        ...
        else
        {
            if (dis.Text != "")
            {
                numTotal1 = ((Convert.ToDecimal(unit.Text) * num_qty) - Convert.ToDecimal(dis1));
            }
            else
            {
    ...
    protected void Mohon_ddcukaiinvBil_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (tgst_1 != "")
        {
            ...
            else
            {
                ...
                if (dis.Text != "")
                {
                    numTotal2 = ((Convert.ToDecimal(unit.Text) * num_qty) - Convert.ToDecimal(dis1)) + numTotal1 + Convert.ToDecimal(gmt1);
                }
                else
                {
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        //{
            ...
            if (txtnoper.Text != "")
            {
                if (txttarkihmo.Text != "" && DropDownList2.SelectedValue != "" && TextBox7.Text != "" && TextBox16.Text != "")
                {
                ...
                userid = Session["New"].ToString();
                                        ...
                                        gen_invkd = Dbcon.Ora_Execute_table("select no_invois from KW_Penerimaan_invois where no_invois='" + txtnoper.Text + "'");
                                        if (gen_invkd.Rows.Count > 0)
                                        {
                                            DataTable dtmb_db1 = Dbcon.Ora_Execute_table("select doc_type_cd,format as fmt,SUBSTRING(cur_format, 1, 12) as lfrmt1,SUBSTRING(cur_format, 13, 4) as lfrmt2,cur_format as cfmt from KW_Format_Nombor_rujukan where doc_type_cd='01' and Status='A'");
                                            ...
                                            else
                                            {
                                                ...
                                                get_doc = Dbcon.Ora_Execute_table("select Ref_doc_descript as s1 from KW_Ref_Doc_kod where Ref_doc_code='01'");

                                                DataTable dtmb_db2 = Dbcon.Ora_Execute_table("select   ISNULL(max(SUBSTRING(no_invois,13,3000)),'0') from KW_Penerimaan_invois");
                ...
                //}
                    string Inssql_main = "insert into KW_Penerimaan_invois (nama_pelanggan_code,no_invois,tarikh_invois,project_kod,Overall,id_profile_syarikat,PO_no,DO_no,inv_bank,inv_noacc_bank,Terma,perkera,crt_id,cr_dt,Status) values('" + dd_kepada.SelectedValue + "','" + txtnoper_1.Text + "','" + tDate.ToString("yyyy-MM-dd") + "','" + ddbkepada.SelectedValue + "','" + TextBox17.Text + "','" + DropDownList3.SelectedValue + "','" + TextBox9.Text + "','" + TextBox14.Text + "','" + DropDownList2.SelectedValue + "','" + TextBox15.Text + "','" + dd_terma.SelectedValue + "','"+ TextBox16.Text + "','" + userid + "','" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "','A')";
                ...
                if (Status == "SUCCESS")
                {
                    ...
                    foreach (GridViewRow g1 in grdmohon.Rows)
                    {
                        ...
                        string Inssql = "insert into KW_Penerimaan_invois_item (no_invois,keterangan,unit,quantiti,jumlah,discount,tax,gstjumlah,Overall,crt_id,cr_dt,Status) values('" + txtnoper_1.Text + "','" + ket + "','" + unit + "','" + c_qty + "','" + ttotal + "','" + disk + "','" + jen_cukai + "','" + cukai_amt + "','" + overall + "','" + userid + "','" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "','A')";
                        Status = Dbcon.Ora_Execute_CommamdText(Inssql);
                    }
                    ...
                    if (Status == "SUCCESS")
                    {
                        ...
                        dt_upd_format = Dbcon.Ora_Execute_table("update KW_Format_Nombor_rujukan set cur_format='" + txtnoper_1.Text + "',upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "' where doc_type_cd='01' and Status = 'A'");
                        BindMohon();
                        Div2.Visible = false;
                        Div3.Visible = true;
                        reset();
                        tab1();
                        ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "$.Zebra_Dialog('Debtor Invois Berjaya Dibuat.',{'type': 'confirmation','title': 'Success','auto_close': 2000});", true);
                    }
                }
    ...
    protected void btnkem_Click(object sender, EventArgs e)
    {
        if (txtnoper.Text != "")
        {
            if (DropDownList2.SelectedValue != "" && TextBox7.Text != "" && TextBox15.Text != "")
            {
                string doc_dt = string.Empty;
                //DateTime tDate = DateTime.ParseExact(txttarkihmo.Text, "dd/MM/yyyy", null);
                if (TextBox7.Text != "")
                ...
                userid = Session["New"].ToString();
                DataTable dt = new DataTable();
                string Inssql_main = "update KW_Penerimaan_invois  set id_profile_syarikat='" + DropDownList3.SelectedValue + "',tarikh_invois='" + doc_dt + "',Terma='" + dd_terma.SelectedValue + "',inv_bank='" + DropDownList2.SelectedValue + "',inv_noacc_bank='" + TextBox15.Text + "',perkera='" + TextBox16.Text + "',PO_no='" + TextBox9.Text + "',DO_no='" + TextBox14.Text + "',project_kod='"+ ddbkepada.SelectedValue + "',upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy / MM / dd hh: mm:ss") + "' where no_invois='" + txtnoper.Text + "'";
                Status = DBCon.Ora_Execute_CommamdText(Inssql_main);
                if (Status == "SUCCESS")
                {
                    BindMohon();
                    ...
                    reset();
                    tab1();
                    ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "$.Zebra_Dialog('Debtor Invois Berjaya Dikemaskini.',{'type': 'confirmation','title': 'Success','auto_close': 2000});", true);
                }
    ...
    void crt_invois()
    {
        ...
        DataTable dt = new DataTable();
        dt = Dbcon.Ora_Execute_table("select no_invois,inv_noacc_bank,semak_sts,inv_bank,id_profile_syarikat,project_kod,nama_pelanggan_code as bayar_kepada,Status,PO_no,DO_no,Overall as jumlah,Format(tarikh_invois,'dd/MM/yyyy') as tk_invois,'' as tk_mohon,'' cara_bayaran,'' kat_penerima,Terma,perkera from KW_Penerimaan_invois where no_invois='" + ssv2 + "' and Status='A'");
        //tab1();
        if (dt.Rows.Count != 0)
        {
            ...
            Session["dbtno"] = dt.Rows[0]["no_invois"].ToString();
            ...
            TextBox16.Text = dt.Rows[0]["perkera"].ToString();
            ddbkepada.SelectedValue = dt.Rows[0]["project_kod"].ToString();
            //txtname.Text = dt.Rows[0]["no_ruj"].ToString();
            txtnoper.Text = dt.Rows[0]["no_invois"].ToString();
            DropDownList2.SelectedValue = dt.Rows[0]["inv_bank"].ToString();
            DropDownList1.SelectedValue = "03";
            DropDownList3.SelectedValue = dt.Rows[0]["id_profile_syarikat"].ToString();
            shw_grd_info();
            ...
            //get_sum_item = Dbcon.Ora_Execute_table("select sum(Overall) amt from KW_Penerimaan_invois_item where no_invois='" + ssv2 + "' and Status='A'");

            //TextBox17.Text = double.Parse(get_sum_item.Rows[0]["amt"].ToString()).ToString("C").Replace("$", "").Replace("RM", "");            
            ...
            query1 = "select UPPER(keterangan) as Keteragan,'' as bank,'' as acc_no,unit as jumlah, discount as Disk,s1.quantiti as qty, "
                           ...
                           + " left join KW_Ref_Tetapan_cukai s4 on s4.Ref_kod_cukai=s1.tax where no_invois='" + ssv2 + "' and s1.Status='A'";
    ...
    protected void BindMohon()
    {
        ...
        {
            condtion = "and a.no_notadebit ='" + txtnoinvois.Text + "' and a.po_no='" + TextBox13.Text + "' and a.tarikh_invois='" + fmdate + "'";
        }
        else if (txtnoinvois.Text == "" && txttarikhinvois.Text != "" && TextBox13.Text != "")
        {
            condtion = "and a.po_no='" + TextBox13.Text + "' and a.tarikh_invois='" + fmdate + "'";
        }
        else if (txtnoinvois.Text != "" && txttarikhinvois.Text == "" && TextBox13.Text != "")
        {
            condtion = "and a.no_notadebit ='" + txtnoinvois.Text + "' and a.po_no='" + TextBox13.Text + "'";
        }
        else if (txtnoinvois.Text != "" && txttarikhinvois.Text != "" && TextBox13.Text == "")
        {
            condtion = "and a.no_notadebit ='" + txtnoinvois.Text + "' and a.tarikh_invois='" + fmdate + "'";
        }
        else if (txtnoinvois.Text != "" && txttarikhinvois.Text == "" && TextBox13.Text == "")
        {
            condtion = "and a.no_notadebit ='" + txtnoinvois.Text + "'";
        }
        else if (txtnoinvois.Text == "" && txttarikhinvois.Text != "" && TextBox13.Text == "")
        {
        ...
        {
            condtion = "and a.po_no='" + TextBox13.Text + "'";
        }


        qry1 = "select '' kat_penerima,Format(tarikh_invois,'dd/MM/yyyy') tarkih_permohonan,a.no_invois,s1.Ref_nama_syarikat as  Bayar_kepada,a.Overall as  jumlah,CASE ISNULL(a.semak_sts,'')  WHEN '' THEN 'WAITING'  WHEN 'P' THEN 'PROSES' WHEN 'L' THEN 'LULUS' END  as status,ISNULL(lulus_sts,'') lul_sts_cd,CASE ISNULL(lulus_sts,'')  WHEN '' THEN 'WAITING'  WHEN 'P' THEN 'PROSES' WHEN 'L' THEN 'LULUS' END  as lul_status,a.po_no,a.perkera as keterangan  from KW_Penerimaan_invois a OUTER APPLY (select top(1)* from KW_Penerimaan_invois_item s2 where s2.Status='A' and s2.no_invois=a.no_invois order by cr_dt asc) as b left join KW_Ref_Pelanggan s1 on s1.Ref_no_syarikat=a.nama_pelanggan_code  where a.Status='A' " + condtion + "";
    ...
    {
        DataTable dt1 = Dbcon.Ora_Execute_table("select doc_type_cd,format as fmt,SUBSTRING(cur_format, 1, 12) as lfrmt1,SUBSTRING(cur_format, 13, 4) as lfrmt2,cur_format as cfmt from KW_Format_Nombor_rujukan where doc_type_cd='09' and Status='A'");
        if (dt1.Rows.Count != 0)
        {
            if (dt1.Rows[0]["cfmt"].ToString() == "")
            {
        ...
        {
            DataTable get_doc = new DataTable();
            get_doc = Dbcon.Ora_Execute_table("select Ref_doc_descript as s1,s1.ws_format as s2 from KW_Ref_Doc_kod left join site_settings s1 on  s1.ID='1' where Ref_doc_code='09'");
            DataTable dt = Dbcon.Ora_Execute_table("select   ISNULL(max(SUBSTRING(no_invois,13,3000)),'0') from KW_Penerimaan_invois");
            if (dt.Rows.Count > 0)
            {
                int seqno = Convert.ToInt32(dt.Rows[0][0].ToString());
                int newNumber = seqno + 1;
