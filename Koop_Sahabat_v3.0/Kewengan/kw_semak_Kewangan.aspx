<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_semak_Kewangan.aspx.cs" Inherits="kw_semak_Kewangan" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1><asp:Label ID="ps_lbl1" Visible="false" runat="server"></asp:Label>Semakan Kewangan</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i><asp:Label ID="ps_lbl2" Visible="false" runat="server"></asp:Label></a> Kewangan</li>
                            <li class="active"><asp:Label ID="ps_lbl3" Visible="false" runat="server"></asp:Label>Semakan Kewangan</li>
                        </ol>
                    </section>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><asp:Label ID="ps_lbl4" Visible="false" runat="server"></asp:Label> <asp:Label Visible="false" ID="hd_txt" runat="server"></asp:Label>Semakan Kewangan</h3>
                        </div>
                                                                     ...
                                                                     <legend style="width:4%"><asp:Label ID="ps_lbl11" runat="server"></asp:Label></legend>
                                                                       ...
                                                                       <div class="col-md-3 box-body">
                                                                            ...
                                                                            <div class="form-group">
                                                                             ...
                                                                             <div class="col-md-3 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-5 control-label"><asp:Label ID="Label21" Visible="false" runat="server"></asp:Label>Status Semakan</label>
                                                                                <div class="col-sm-7">
...
<asp:Label ID="lbl_mohon_no" runat="server" Text='<%# Eval("rujukan") %>' Visible="false"></asp:Label>
                  ...
                  <asp:TemplateField HeaderText="Action">
                                                                <ItemStyle HorizontalAlign="center" Width="5%"></ItemStyle>
                                                                    <ItemTemplate>
                                                                       <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("rujukan")+","+ Eval("jen_txi")%>' CommandName="Add" ToolTip='<%# Eval("rujukan")%>'  onclick="lblSubbind_Click"><i class='fa fa-edit'></i></asp:LinkButton>                                                                    
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <asp:TextBox ID="end_dt1" runat="server" Visible="false"></asp:TextBox>
                                                                 ...
                                                                 <fieldset class="col-md-12" style="pointer-events:none;">
                                                                       ...
                                                                       <div class="row">
                                                                         <div class="col-md-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"><asp:Label ID="ps_lbl19" Visible="false" runat="server"></asp:Label> No Permohonan</label>
                                                                                <div class="col-sm-8">
                                                                      ...
                                                                      <div class="row">
                                                                        ...
                                                                        <div class="col-md-6 box-body">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                <asp:TextBox ID="TextBox19" runat="server" class="form-control validate[optional] uppercase" ReadOnly="true"></asp:TextBox> 
                                                                                </div>
                                                                                </div>
                                                                            </div>
                                                                 ...
                                                                 <div class="row" style="display:none;">
                                                                        ...
                                                                        <div class="col-md-6 box-body">
                                                                            ...
                                                                            <div id="mak_dok_shw" runat="server">
                                                                         <fieldset class="col-md-12">
...
<br>
            ...
            <Columns>
                  ...
                  <asp:TemplateField HeaderText="Kod Bajet" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
                   <asp:DropDownList ID="dd_bajet" CssClass="form-control select2 uppercase" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="load_bajet" runat="server"></asp:DropDownList>
                </ItemTemplate>
            </asp:TemplateField>
...
<asp:BoundField DataField="cukai_amt" HeaderText="Cukai (RM)" HeaderStyle-HorizontalAlign="Right" DataFormatString="{0:n}" ItemStyle-HorizontalAlign="Right" />
                <asp:TemplateField HeaderText="Amaun (RM)" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right">
                <ItemTemplate>
                    <asp:Label ID="jumlah" runat="server" Width="100%" CssClass="form-control" Text='<%# Eval("jumlah","{0:n}") %>' class="uppercase" ></asp:Label>
                </ItemTemplate>
                     <FooterTemplate>

                 <asp:Label ID="jumlah_ftr" CssClass="form-control" runat="server" class="uppercase" ></asp:Label>
                                                        ...
                                                        <AlternatingRowStyle BackColor="White" />      
                                                                ...
                                                                <div class="box-body">&nbsp;</div>
                                                                        <div id="sts" runat="server" visible="false">
                                                                              <fieldset class="col-md-12">
                                                                     <legend style="width:11%">Semakan Kewangan</legend> 
                                                                                   <div class="row">
                                                                         <div class="col-md-12">
                                                                        <div class="col-md-6 box-body">
                                                                            <div class="form-group" style="display:none;">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label">Kod Bajet </label>
                                                                                <div class="col-sm-8">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label">Kategory Kelulusan <span class="style1">*</span></label>
                                                                                <div class="col-sm-8">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label">Status Semakan <span class="style1">*</span></label>
                                                                                <div class="col-sm-8">
                                                                             ...
                                                                             <div class="col-md-6 box-body">
                                                                           <%-- <div class="form-group">--%>
                                                                                <asp:gridview ID="Gridview1" runat="server" class="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="3" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="30" ShowFooter="false" GridLines="None" OnRowDeleting="grvStudentDetails_RowDeleting" >
            <Columns>
                <asp:BoundField DataField="nama_bajet" HeaderText="KETERANGAN BAJET" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />       
                <asp:BoundField DataField="Ref_jumlah_bajet" HeaderText="AMAUN (RM)" HeaderStyle-HorizontalAlign="Right" DataFormatString="{0:n}"  ItemStyle-HorizontalAlign="Right" />
                <asp:BoundField DataField="Ref_used_bajet" HeaderText="PENGGUNAAN (RM)" HeaderStyle-HorizontalAlign="Right" DataFormatString="{0:n}"  ItemStyle-HorizontalAlign="Right" />
                <asp:BoundField DataField="baki" HeaderText="Baki (RM)" HeaderStyle-HorizontalAlign="Right" DataFormatString="{0:n}"  ItemStyle-HorizontalAlign="Right" />
                                                                   ...
                                                                   <div class="row">
                                                                                 <div class="col-md-12" style="text-align:center;">
                                                                                  ...
                                                                                  <asp:Button ID="btnprintmoh" runat="server" class="btn btn-warning" Text="Print" Type="submit" onclick="btnprintmoh_Click" />
