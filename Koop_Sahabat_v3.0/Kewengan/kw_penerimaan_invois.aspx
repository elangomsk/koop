<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_penerimaan_invois.aspx.cs" Inherits="kw_penerimaan_invois" %>
        ...
        <ContentTemplate>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><asp:Label ID="ps_lbl4" Visible="false" runat="server"></asp:Label> <asp:Label Visible="false" ID="hd_txt" runat="server"></asp:Label>Debtor Invois</h3>
                            <div class="type-1 ">
                              <div class="type-in">
                                                                     ...
                                                                     <legend style="width:4%"><asp:Label ID="ps_lbl11" runat="server"></asp:Label></legend>
                                                                        ...
                                                                        <div class="col-md-3 box-body">
                                                                            ...
                                                                            <div class="form-group">
                                                                              ...
                                                                              <div class="col-md-3 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-5 control-label"><asp:Label ID="ps_lbl14" Visible="false"  runat="server"></asp:Label> No Po</label>
                                                                                <div class="col-sm-7">
           ...
           <div class="col-md-12 box-body">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="tarkih_permohonan" HeaderText="Tarkih Invois" ItemStyle-HorizontalAlign="Center" />            
                ...
                <asp:BoundField DataField="po_no" HeaderText="No Po" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                                                 ...
                                                                 <fieldset class="col-md-12">
                                                                  ...
                                                                  <div class="row">
                                                                     ...
                                                                     <div class="row">
                                                                        ...
                                                                        <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"><asp:Label ID="ps_lbl20" Visible="false" runat="server"></asp:Label> Tarikh Invois <span class="style1">*</span></label>     
                                                                                <div class="col-sm-8">
                                                                                 <div class="input-group">
                                                                    ...
                                                                    UseSubmitBehavior="false" onclick="btncarian_Click"  />
                                                                      ...
                                                                      <div class="row">
                                                                         <div class="col-md-12">
                                                                                <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"> Bank <span class="style1">*</span></label>
                                                                                <div class="col-sm-8">
