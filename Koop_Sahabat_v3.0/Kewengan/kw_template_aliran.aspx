<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../Kewengan/kw_template_aliran.aspx.cs" Inherits="kw_template_aliran" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1 id="h1_tag" runat="server">  Aliran Tunai Templat  </h1>
                        <ol class="breadcrumb">
                            <li id="bb1_text" runat="server"><a href="#"><i class="fa fa-dashboard"></i>Kewangan</a></li>
                            <li class="active" id="bb2_text" runat="server"> Aliran Tunai Templat  </li>
                        </ol>
                    </section>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                          <asp:DropDownList ID="sel_rt" CssClass=" form-control uppercase" runat="server" AutoPostBack="true" OnSelectedIndexChanged="dd_SelectedIndexChanged">
                                              ...
                                              <asp:ListItem Value="00">ALIRAN TUNAI KATEGORI</asp:ListItem>                 
                                              <asp:ListItem Value="01">ALIRAN TUNAI HEADER</asp:ListItem>
