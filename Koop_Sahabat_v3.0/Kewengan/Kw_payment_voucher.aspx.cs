...
public partial class Kw_payment_voucher : System.Web.UI.Page

{
...

    {
...

        {
...

            {
                ...
                DropDownList1.SelectedValue = "03";
...

    {
...

        {
            ...
            DropDownList5.DataTextField = "Jenis_bayaran";

            DropDownList5.DataValueField = "Jenis_bayaran_cd";
...

    {
...

        {
            ...
            string com = "SELECT Ref_kod_akaun, Ref_Nama_akaun FROM KW_Ref_Akaun_bank where status='A' and ISNULL(Ref_kod_akaun,'') != ''";
            ...
            DropDownList4.DataTextField = "Ref_Nama_akaun";

            DropDownList4.DataValueField = "Ref_kod_akaun";
...

    {
...

        {
            ...
            string com = "SELECT no_invois FROM KW_Penerimaan_invois WHERE nama_pelanggan_code=''";
            ...
            dd_terma.DataSource = dt;

            dd_terma.DataBind();

            dd_terma.DataTextField = "no_invois";

            dd_terma.DataValueField = "no_invois";

            dd_terma.DataBind();

            dd_terma.Items.Insert(0, new ListItem("--- PILIH ---", ""));
...

    {
...

        {
            ...
            string com = "SELECT s2.Ref_Projek_code,Ref_Projek_name FROM KW_Penerimaan_invois s1 left join KW_Ref_Projek s2 on s2.Ref_Projek_code=s1.project_kod WHERE nama_pelanggan_code='' and ISNULL(s2.Ref_Projek_code,'') != '' group by s2.Ref_Projek_code,Ref_Projek_name";
            ...
            ddbkepada.DataTextField = "Ref_Projek_name";

            ddbkepada.DataValueField = "Ref_Projek_code";
...

    {
...

        {
            ...
            pel_DropDownList1.DataSource = dt;

            pel_DropDownList1.DataBind();

            pel_DropDownList1.DataTextField = "Bank_Name";

            pel_DropDownList1.DataValueField = "Bank_Code";

            pel_DropDownList1.DataBind();

            pel_DropDownList1.Items.Insert(0, new ListItem("--- PILIH ---", ""));
    ...
    protected void shw_resit(object sender, EventArgs e)
...

    {
...

        {
...

            {
                ...
                decimal tot1 = (Convert.ToDecimal(unit.Text) * num_qty);
...

                {
                    ...
                    numTotal2 = ((Convert.ToDecimal(unit.Text) * num_qty) - Convert.ToDecimal(dis.Text)) + numTotal4;
...

                {
                    ...
                    numTotal2 = (Convert.ToDecimal(unit.Text) * num_qty) + numTotal4;

                }



                numTotal3 = (Convert.ToDecimal(unit.Text) * num_qty);
...

            {
                ...
                decimal tot1 = (Convert.ToDecimal(unit.Text) * num_qty) + Convert.ToDecimal(gmt1);
...

            {
...

                {
...

                    {
                        ...
                        ddokdicno = Dbcon.Ora_Execute_table("SELECT stf_name as val1,stf_staff_no as val2,stf_bank_cd as bank,stf_bank_acc_no as acc_no FROM hr_staff_profile s1 left join hr_post_his s2 on s2.pos_staff_no=s1.stf_staff_no and pos_end_dt >='" + DateTime.Now.ToString("yyyy-MM-dd") + "' where stf_staff_no=''");
...

                    {
                        ...
                        ddokdicno = Dbcon.Ora_Execute_table("select Ref_nama_syarikat as val1,Ref_no_syarikat as val2,pem_bank_cd as bank,pem_bank_accno as acc_no from KW_Ref_Pembekal where Status='A' and Ref_no_syarikat=''");
...

                    {
                        ...
                        ddokdicno = Dbcon.Ora_Execute_table("select Ref_nama_syarikat as val1,Ref_no_syarikat as val2,pel_bank_cd as bank,pel_bank_accno as acc_no from KW_Ref_Pelanggan where Status='A' and Ref_no_syarikat=''");
...

                    {
...

                        {
                            ...
                            box1_1.SelectedValue = ddokdicno.Rows[0]["bank"].ToString();

                            box2.Text = ddokdicno.Rows[0]["acc_no"].ToString();
...

    {
...

        {
...

            {
                ...
                decimal tot1 = ((decimal)Convert.ToDecimal(unit.Text) * (decimal)Convert.ToDecimal(qty_v1));
...

                {
                    ...
                    numTotal2 = ((Convert.ToDecimal(unit.Text) * (decimal)Convert.ToDecimal(qty_v1)) - Convert.ToDecimal(dis.Text)) + numTotal4;
...

                {
                    ...
                    numTotal2 = (Convert.ToDecimal(unit.Text) * (decimal)Convert.ToDecimal(qty_v1)) + numTotal4;
...

            {
                ...
                decimal tot1 = ((decimal)Convert.ToDecimal(unit.Text) * (decimal)Convert.ToDecimal(qty_v1)) + Convert.ToDecimal(gmt1);
...

                {
                    ...
                    numTotal2 = ((Convert.ToDecimal(unit.Text) * (decimal)Convert.ToDecimal(qty_v1)) - Convert.ToDecimal(dis.Text)) + numTotal1 + Convert.ToDecimal(gmt.Text);
...

                {
                    ...
                    numTotal2 = (Convert.ToDecimal(unit.Text) * (decimal)Convert.ToDecimal(qty_v1)) + numTotal1 + Convert.ToDecimal(gmt.Text);
...

        {
...

            {
                ...
                numTotal1 = ((Convert.ToDecimal(unit.Text) * (decimal)Convert.ToDecimal(qty_v1)) - Convert.ToDecimal(dis.Text));
...

            {
                ...
                numTotal1 = (Convert.ToDecimal(unit.Text) * (decimal)Convert.ToDecimal(qty_v1));
...

            {
                ...
                numTotal3 = (Convert.ToDecimal(unit.Text) * (decimal)Convert.ToDecimal(qty_v1));
...

        {
...

            {
...

                {
                    ...
                    numTotal2 = ((Convert.ToDecimal(unit.Text) * num_qty) - Convert.ToDecimal(dis.Text)) + numTotal1 + Convert.ToDecimal(gmt1);
...

                {
                    ...
                    numTotal2 = (Convert.ToDecimal(unit.Text) * num_qty) + numTotal1 + Convert.ToDecimal(gmt1);
...

        {
...

            {
...

                {
                    ...
                    numTotal2 = numTotal1 + Convert.ToDecimal(gmt1);
...

                {
...

                    {
...

                        {
                            ...
                            dtCurrentTable2.Rows[i - 1]["Column5"] = ddokdicno.Rows[0]["acc_no"].ToString();
...

    {
...

        {
            ...
            string cek_dt = string.Empty;

            if (DropDownList5.SelectedValue != "" && DropDownList4.SelectedValue != "" && TextBox7.Text != "")

            {
...

                {
                    ...
                    DateTime tDate = DateTime.ParseExact(TextBox22.Text, "dd/MM/yyyy", null);

                    cek_dt = tDate.ToString("yyyy-MM-dd");
                ...
                gen_invkd = Dbcon.Ora_Execute_table("select no_resit from KW_Penerimaan_resit where no_resit='" + txtnoper.Text + "'");

                if (gen_invkd.Rows.Count > 0)

                {

                    DataTable dtmb_db1 = Dbcon.Ora_Execute_table("select doc_type_cd,format as fmt,SUBSTRING(cur_format, 1, 12) as lfrmt1,SUBSTRING(cur_format, 13, 4) as lfrmt2,cur_format as cfmt from KW_Format_Nombor_rujukan where doc_type_cd='02' and Status='A'");
...

                    {
                        ...
                        get_doc = Dbcon.Ora_Execute_table("select Ref_doc_descript as s1 from KW_Ref_Doc_kod where Ref_doc_code='02'");



                        DataTable dtmb_db2 = Dbcon.Ora_Execute_table("select   ISNULL(max(SUBSTRING(no_resit,13,3000)),'0') from KW_Penerimaan_resit");
                ...
                string Inssql_main = "insert into KW_Penerimaan_resit (tarikh_resit,no_resit,project_kod,no_invois,bentuk_bayaran,nama_pelanggan_code,perkara,gl_cd_bank,no_cek,bank_cod,tarikh_cek,Overall,lulus_sts,crt_id,cr_dt,Status) values('" + doc_dt + "','" + txtnoper_1.Text + "','" + ddbkepada.SelectedValue + "','" + dd_terma.SelectedValue + "','" + DropDownList5.SelectedValue + "','','" + TextBox16.Value + "','" + DropDownList4.SelectedValue + "','','','" + cek_dt + "','" + TextBox17.Text + "','L','" + userid + "','" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "','A')";
...

                {
...

                    {
                        ...
                        string overall = (g1.FindControl("Label1") as Label).Text;
                        ...
                        string Inssql = "insert into KW_Penerimaan_resit_item (no_resit,res_keterangan,res_unit,res_quantiti,res_jumlah,res_disk,tax,gstjumlah,Overall,crt_id,cr_dt,Status) values('" + txtnoper_1.Text + "','" + ket + "','" + unit + "','" + c_qty + "','" + ttotal + "','" + disk + "','" + jen_cukai + "','" + cukai_amt + "','" + overall + "','" + userid + "','" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "','A')";
...

                    {
                        ...
                        dt_upd_format = Dbcon.Ora_Execute_table("update KW_Format_Nombor_rujukan set cur_format='" + txtnoper_1.Text + "',upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "' where doc_type_cd='02' and Status = 'A'");
                        ...
                        ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "$.Zebra_Dialog('Terimaan Berjaya Dibuat.',{'type': 'confirmation','title': 'Success','auto_close': 2000});", true);
...

    {
...

        {
...

            {
                ...
                string doc_dt = string.Empty, cek_dt = string.Empty;

                if (TextBox30.Text != "")

                {

                    DateTime tDate = DateTime.ParseExact(TextBox30.Text, "dd/MM/yyyy", null);
                ...
                DataTable gen_invkd = new DataTable();
                gen_invkd = Dbcon.Ora_Execute_table("select Pv_no from KW_Pembayaran_Pay_voucer where Pv_no='" + txtnoper.Text + "'");
                if (gen_invkd.Rows.Count > 0)
                {
                    DataTable dtmb_db1 = Dbcon.Ora_Execute_table("select doc_type_cd,format as fmt,SUBSTRING(cur_format, 1, 12) as lfrmt1,SUBSTRING(cur_format, 13, 4) as lfrmt2,cur_format as cfmt from KW_Format_Nombor_rujukan where doc_type_cd='04' and Status='A'");
                    if (dtmb_db1.Rows.Count != 0)
                    {
                        if (dtmb_db1.Rows[0]["cfmt"].ToString() == "")
                        {
                    ...
                    {
                        DataTable get_doc = new DataTable();
                        get_doc = Dbcon.Ora_Execute_table("select Ref_doc_descript as s1,s1.ws_format as s2 from KW_Ref_Doc_kod left join site_settings s1 on  s1.ID='1' where Ref_doc_code='04'");
                        DataTable dtmb_db2 = Dbcon.Ora_Execute_table("select   ISNULL(max(SUBSTRING(Pv_no,13,3000)),'0') from KW_Pembayaran_Pay_voucer");
                        if (dtmb_db2.Rows.Count > 0)
                        {
                            int seqno = Convert.ToInt32(dtmb_db2.Rows[0][0].ToString());
                            int newNumber = seqno + 1;
                ...
                string Inssql_main = "Insert into KW_Pembayaran_Pay_voucer (kod_bajet,Ref_doc_code,tarkih_pv,Pv_no,Cara_Bayaran,Bayar_kepada,no_invois,Cre_Bank_nm,project_kod,Cre_Bank_no,perkara,Terma,gl_cd_bank,No_cek,tarikh_cek,Overall,lulus_sts,no_doc) values "

                    + " ('" + TextBox38.Text + "','" + TextBox33.Text + "','" + doc_dt + "','" + txtnoper_1.Text + "','" + DropDownList5.SelectedValue + "','" + TextBox24.Text + "','" + TextBox27.Text + "','" + TextBox19.Text + "','"+TextBox34.Text+"','" + TextBox22.Text + "','" + TextBox16.Value + "','" + TextBox31.Text + "','" + DropDownList4.SelectedValue + "','" + TextBox28.Text + "','" + cek_dt + "','" + TextBox17.Text + "','L','"+ TextBox35.Text +"')";
...

                {
                    ...
                    DataTable dt_upd_format = new DataTable();
                    dt_upd_format = Dbcon.Ora_Execute_table("update KW_Format_Nombor_rujukan set cur_format='" + txtnoper_1.Text + "',upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "' where doc_type_cd='04' and Status = 'A'");
                    ...
                    ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "$.Zebra_Dialog('Baucer Bayaran Berjaya Dikemaskini.',{'type': 'confirmation','title': 'Success','auto_close': 2000});", true);
...

        {
            ...
            ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "$.Zebra_Dialog('Sila Masukkan No Baucer Bayaran.',{'type': 'warning','title': 'warning','auto_close': 2000});", true);
...

    {
        ...
        CommandArgument3 = CommadArgument[2];

        Session["cmd_arg1"] = CommandArgument2;
        Session["cmd_arg2"] = CommandArgument3;
        Session["cmd_arg3"] = CommandArgument1;
        crt_invois();
    }
...

    {
...

        {
            ...
            ssv2 = Session["cmd_arg3"].ToString();
...

        {
            ...
            dt = Dbcon.Ora_Execute_table("select s4.Ref_nama_syarikat,s5.Bank_Name,s4.pem_bank_accno,s3.Ref_doc_name as desc1,s2.Ref_Projek_name as pro_name,m1.cara_bayaran,m1.no_invois no_inv,m1.no_invois as no_permohonan,m1.no_invois no_ruj,'' Catatan,m1.id_profile_syarikat,semak_sts,ISNULL(s1.lulus_sts,'') lulus_sts,semak_id,Format(semak_dt,'dd/MM/yyyy') semakdt,'' ID_pemohon,PO_no,DO_no, m1.Overall jumlah,Format(tarikh_invois,'dd/MM/yyyy') as tk_invois, Format(tarkih_mohon,'dd/MM/yyyy') as tk_mohon,'01' Jenis_permohonan "
                + " ,PO_no as no_ruj,m1.cara_bayaran,kat_penerima,m1.Terma,ISNULL(s1.Pv_no,'') pv_no,m1.perkara,m1.project_kod pcod,b.kod_bajet from KW_Pembayaran_invois m1 OUTER APPLY (select top(1)* from KW_Pembayaran_invoisBil_item s2 where s2.Status='A' and s2.no_invois=m1.no_invois order by cr_dt asc) as b left join KW_Pembayaran_Pay_voucer s1 on s1.no_invois=m1.no_invois left join KW_Ref_Projek s2 on s2.Ref_Projek_code=m1.project_kod left join KW_Ref_Doc_kod s3 on s3.ref_doc_code='01' left join KW_Ref_Pembekal s4 on s4.Ref_no_syarikat=m1.Bayar_kepada left join Ref_Nama_Bank s5 on s5.Bank_Code=s4.pem_bank_cd where m1.no_invois='" + Session["cmd_arg3"].ToString() + "' and m1.Status='A'");
...

        {
            ...
            dt = Dbcon.Ora_Execute_table("select case when (ISNULL(s4.Ref_nama_syarikat,'')='' and ISNULL(s4_1.Ref_nama_syarikat,'')='') then s4_2.stf_name when(ISNULL(s4.Ref_nama_syarikat, '') = '' and ISNULL(s4_2.stf_name, '') = '') then s4_1.Ref_nama_syarikat when(ISNULL(s4_1.Ref_nama_syarikat, '') = '' and ISNULL(s4_2.stf_name, '') = '') then s4.Ref_nama_syarikat else '' end as Ref_nama_syarikat, s5.Bank_Name,b.mhn_noacc_bank as pem_bank_accno,s3.Ref_doc_name as desc1,s6.Ref_Projek_name as pro_name,m1.cara_bayaran,no_permohonan,Catatan,no_ruj as no_inv,no_permohonan no_ruj,m1.id_profile_syarikat,semak_sts,ISNULL(s1.lulus_sts,'')lulus_sts,semak_id,Format(semak_dt,'dd/MM/yyyy') semakdt,ID_pemohon,PO_no,DO_no,m1.jumlah,Format(tarkih_invois,'dd/MM/yyyy') as tk_invois,Format(tarkih_permohonan,'dd/MM/yyyy') as tk_mohon,'03' Jenis_permohonan,no_ruj,m1.cara_bayaran,kat_penerima,m1.Terma Terma,ISNULL(s1.Pv_no,'') pv_no,m1.perkara,'' pcod,b.kod_bajet from KW_Pembayaran_mohon m1 OUTER APPLY (select top(1)* from KW_Pembayaran_mohon_item s2 where s2.Status='A' and s2.mhn_no_permohonan=m1.no_permohonan order by cr_dt asc) as b left join KW_Pembayaran_Pay_voucer s1 on s1.no_invois= m1.no_ruj and s1.no_doc=m1.no_permohonan left join KW_Ref_Doc_kod s3 on s3.ref_doc_code='03'  left join KW_Ref_Pembekal s4 on s4.Ref_no_syarikat=b.mhn_byr_kepada left join KW_Ref_Pelanggan s4_1 on s4_1.Ref_no_syarikat=b.mhn_byr_kepada left join hr_staff_profile s4_2 on s4_2.stf_staff_no = b.mhn_byr_kepada  left join Ref_Nama_Bank s5 on s5.Bank_Code=b.mhn_bank left join KW_Ref_Projek s6 on s6.Ref_Projek_code=b.mhn_projek_cd where no_permohonan='" + Session["cmd_arg3"].ToString() + "' and m1.Status='A'");
...

        {
            ...
            dt = Dbcon.Ora_Execute_table("select s4.Ref_nama_syarikat,s5.Bank_Name,s4.pem_bank_accno,s3.Ref_doc_name as desc1,s2.Ref_Projek_name as pro_name,''cara_bayaran "
                + " ,m1.no_invois no_inv,m1.no_invois no_ruj,'05' Jenis_permohonan,'' cara_bayaran,'' ID_pemohon,no_Rujukan no_permohonan,'' Catatan,m1.id_profile_syarikat,semak_sts,ISNULL(s1.lulus_sts,'')lulus_sts,semak_id,Format(semak_dt,'dd/MM/yyyy') semakdt,m1.overall as jumlah,'' as tk_invois,Format(tarkih_mohon,'dd/MM/yyyy') as tk_mohon,'02' kat_penerima,m1.Terma,ISNULL(s1.Pv_no,'') pv_no,m1.perkera as perkara,m1.project_kod pcod,b.kod_bajet from KW_Pembayaran_Credit m1 OUTER APPLY (select top(1)* from KW_Pembayaran_Credit_item s2 where s2.Status='A' and s2.no_Rujukan=m1.no_Rujukan order by cr_dt asc) as b left join KW_Pembayaran_Pay_voucer s1 on s1.no_invois= no_invois and s1.no_doc=no_permohonan left join KW_Ref_Projek s2 on s2.Ref_Projek_code=m1.project_kod left join KW_Ref_Doc_kod s3 on s3.ref_doc_code='05' left join KW_Ref_Pembekal s4 on s4.Ref_no_syarikat=m1.nama_pembekal_code left join Ref_Nama_Bank s5 on s5.Bank_Code=s4.pem_bank_cd where no_Rujukan='" + Session["cmd_arg3"].ToString() + "' and m1.Status='A'");
...

        {
            ...
            dt = Dbcon.Ora_Execute_table("select s4.Ref_nama_syarikat,s5.Bank_Name,s4.pem_bank_accno,s3.Ref_doc_name as desc1,s2.Ref_Projek_name as pro_name,''cara_bayaran "
                + " ,m1.no_invois no_inv,m1.no_invois no_ruj,'06' Jenis_permohonan,'' ID_pemohon,no_Rujukan no_permohonan,'' Catatan,m1.id_profile_syarikat,semak_sts,ISNULL(s1.lulus_sts,'')lulus_sts,semak_id,Format(semak_dt,'dd/MM/yyyy') semakdt,m1.overall as jumlah,'' as tk_invois,Format(tarkih_mohon,'dd/MM/yyyy') as tk_mohon,'02' kat_penerima,m1.Terma,ISNULL(s1.Pv_no,'') pv_no,m1.perkera as perkara,m1.project_kod pcod,b.kod_bajet from KW_Pembayaran_Dedit m1 OUTER APPLY (select top(1)* from KW_Pembayaran_Dedit_item s2 where s2.Status='A' and s2.no_Rujukan=m1.no_Rujukan order by cr_dt asc) as b left join KW_Pembayaran_Pay_voucer s1 on s1.no_invois=m1.no_invois left join KW_Ref_Projek s2 on s2.Ref_Projek_code=m1.project_kod left join KW_Ref_Doc_kod s3 on s3.ref_doc_code='06' left join KW_Ref_Pembekal s4 on s4.Ref_no_syarikat=m1.nama_pembekal_code left join Ref_Nama_Bank s5 on s5.Bank_Code=s4.pem_bank_cd where no_Rujukan='" + Session["cmd_arg3"].ToString() + "' and m1.Status='A'");
...

        {
            ...
            dt = Dbcon.Ora_Execute_table("select * from (select '' Ref_nama_syarikat,'' Bank_Name,'' pem_bank_accno,a.jp_desc as desc1,'' as pro_name,''cara_bayaran "
                + " ,a.no_inv as no_inv,a.no_inv as no_ruj,'' Jenis_permohonan,'' ID_pemohon,a.no_permohonan ,(a.desc1 +' '+replace(b.gl_invois_no,'HR','')) Catatan,'' id_profile_syarikat,a.semak_sts,lulus_sts,a.semak_id,semakdt,a.Overall as jumlah,'' tk_invois,tk_mohon,''kat_penerima,Terma,pv_no,perkara,pcod,'' kod_bajet from  "
                + " (  select pv_item, sb1.no_permohonan, sb1.desc1, sum(sb1.Overall) Overall, sb1.jp_desc, sb1.tarkih_permohonan, sb1.nama_pelanggan_code, sb1.status, sb1.jp_cd, sb1.no_inv, sb1.semak_sts, sb1.semakdt, sb1.tk_invois, sb1.tk_mohon, sb1.kat_penerima, sb1.Terma, sb1.pv_no, sb1.perkara, sb1.pcod, sb1.semak_id, sb1.lulus_sts from( "
                + " select  pv_item, m1.no_permohonan as no_permohonan,case when pv_item = '1' then 'Gaji Kakitangan' when pv_item = '2' then 'STATUTORI MAJIKAN (KWSP)' when pv_item = '3' then 'STATUTORI MAJIKAN (PERKESO)' "
                + " when pv_item = '4' then 'STATUTORI MAJIKAN (LHDN)' when pv_item = '5' then 'STATUTORI MAJIKAN (SIP)' else m1.keterangan end as desc1, sum(m1.Overall) as Overall, s2.kk_skrin_name as jp_desc, "
                + " Format(tarikh_lulus, 'dd/MM/yyyy') as tarkih_permohonan, nama_pelanggan_code,case when ISNULL(kew_appr_gl_cd, '') = 'L' then 'LULUS' else 'WAITING' end as status, Jenis_permohonan as jp_cd, "
                + " no_Rujukan no_inv, semak_sts, Format(semak_dt, 'dd/MM/yyyy') semakdt, '' as tk_invois, Format(tarikh_lulus, 'dd/MM/yyyy') as tk_mohon, '03' kat_penerima, m2.Terma, ISNULL(p1.Pv_no, '') pv_no, "
                + " m2.perkara, '' pcod, semak_id, ISNULL(p1.lulus_sts, '') lulus_sts from KW_jurnal_inter_items m1   inner join KW_jurnal_inter m2 on m2.no_permohonan = m1.no_permohonan "
                + " left join KW_Pembayaran_Pay_voucer p1 on p1.no_invois = m1.no_permohonan left join kk_pid_skrin s2 on s2.KK_skrin_id = nama_pelanggan_code "
                + " and s2.status = 'A'  where m1.pv_item != '0' and  m1.overall != '0.00' and m2.kew_appr_gl_cd = 'L' "
                + " and ISNULL(m2.kew_appr_pv_cd, '') = ''  group by  m1.no_permohonan, pv_item, kk_skrin_name, tarikh_lulus, nama_pelanggan_code, ISNULL(kew_appr_gl_cd, ''), Jenis_permohonan, no_Rujukan, "
                + "  semak_sts, semak_dt, m2.Terma, Pv_no, m2.perkara, semak_id, p1.lulus_sts, keterangan "
                ...
                + "   ) as a outer apply(select gl_invois_no from KW_General_Ledger where gl_jenis_no=a.no_permohonan group by gl_invois_no) as b) as a where  no_permohonan ='" + Session["cmd_arg3"].ToString() + "' and Catatan='" + Session["cmd_arg2"].ToString() + "'");
...

        {
            ...
            if (dt.Rows[0]["lulus_sts"].ToString() == "L")
            ...
            TextBox23.Text = dt.Rows[0]["desc1"].ToString();

            Session["dbtno"] = dt.Rows[0]["no_permohonan"].ToString();
            ...
            TextBox16.Value = dt.Rows[0]["perkara"].ToString();
             
            TextBox33.Text = dt.Rows[0]["Jenis_permohonan"].ToString();
            TextBox34.Text = dt.Rows[0]["pcod"].ToString();
            TextBox38.Text = dt.Rows[0]["kod_bajet"].ToString();
            //txtname.Text = dt.Rows[0]["no_ruj"].ToString();

            if (dt.Rows[0]["pv_no"].ToString() != "")

            {

                txtnoper.Text = dt.Rows[0]["pv_no"].ToString();
            ...
            txtnoper.Attributes.Add("Readonly", "Readonly");

            //DropDownList2.SelectedValue = dt.Rows[0]["bank_cod"].ToString();
            ...
            DropDownList5.SelectedValue = dt.Rows[0]["cara_bayaran"].ToString();

            if(DropDownList5.SelectedValue == "001")
            {
                cek_det1.Visible = true;
                cek_det2.Visible = true;
                cek_det3.Visible = false;
            }
            else
            {
                cek_det1.Visible = false;
                cek_det2.Visible = false;
                cek_det3.Visible = true;
            }


            //DropDownList4.SelectedValue = dt.Rows[0]["gl_cd_bank"].ToString();

            TextBox26.Text = dt.Rows[0]["pro_name"].ToString();

            TextBox27.Text = dt.Rows[0]["no_inv"].ToString();

            TextBox35.Text = dt.Rows[0]["no_ruj"].ToString();

            TextBox24.Text = dt.Rows[0]["Ref_nama_syarikat"].ToString().ToUpper();
            if (dt.Rows[0]["tk_invois"].ToString() != "01/01/1900")
            {
                TextBox32.Text = dt.Rows[0]["tk_invois"].ToString();
            }

            TextBox19.Text = dt.Rows[0]["Bank_Name"].ToString().ToUpper();

            TextBox22.Text = dt.Rows[0]["pem_bank_accno"].ToString();

            TextBox31.Text = dt.Rows[0]["Terma"].ToString();

            DataTable chk_payvcher = new DataTable();
            chk_payvcher = DBCon.Ora_Execute_table("select * from (select no_invois,No_cek,case when Format(tarikh_cek,'dd/MM/yyyy') !='01/01/1900' then Format(tarikh_cek,'dd/MM/yyyy') else '' end tk_cek,gl_cd_bank from KW_Pembayaran_Pay_voucer where no_invois='" + TextBox35.Text +"' and lulus_sts='L' and Pv_no='"+ txtnoper.Text + "' ) as a outer apply ( select count(gl_jenis_no) cnt from KW_General_Ledger where gl_jenis_no='" + txtnoper.Text + "' and gl_sts='L') as b");

            if(chk_payvcher.Rows.Count!= 0)
            {

                if (chk_payvcher.Rows[0]["cnt"].ToString() != "0")
                {
                ...
                DropDownList4.SelectedValue = chk_payvcher.Rows[0]["gl_cd_bank"].ToString();
                TextBox28.Text = chk_payvcher.Rows[0]["No_cek"].ToString();
                TextBox30.Text = chk_payvcher.Rows[0]["tk_cek"].ToString();
            }       
...

            {
                query1 = "select s1.kod_bajet,s1.Id,m1.Bayar_kepada as kepada,UPPER(s1.keterangan) as Keteragan,s2.Ref_Projek_name as projek,s3.Bank_Name as bank,s1.nv_noacc_bank as acc_no, s1.Overall as jumlah, discount as Disk  , "
                           ...
                           + " left join KW_Ref_Tetapan_cukai s4 on s4.Ref_kod_cukai=s1.tax where s1.no_invois='" + Session["cmd_arg3"].ToString() + "' and s1.Status='A'";
...

            {
                ...
                query1 = "select s1.kod_bajet,s1.Id,mhn_byr_kepada as kepada,UPPER(mhn_keterangan) as Keteragan,s2.Ref_Projek_name as projek,s3.Bank_Name as bank,s1.mhn_noacc_bank as acc_no,mhn_amount_bsr as jumlah, mhn_disc as Disk "
                          ...
                          + " left join KW_Ref_Tetapan_cukai s4 on s4.Ref_kod_cukai=s1.mhn_jns_tax  where mhn_no_permohonan='" + Session["cmd_arg3"].ToString() + "' and s1.Status='A'";
...

            {
                ...
                query1 = "select s1.kod_bajet,s1.Id,m1.nama_pembekal_code as kepada,UPPER(perkera) as Keteragan,s2.Ref_Projek_name as projek,'' as bank,'' as acc_no,s1.overall as jumlah, discount as Disk "
                          ...
                          + " left join KW_Ref_Tetapan_cukai s4 on s4.Ref_kod_cukai=s1.tax  where m1.no_Rujukan='" + Session["cmd_arg3"].ToString() + "' and s1.Status='A'";
...

            {
                ...
                query1 = "select * from (select no_permohonan,'' kod_bajet,'' Id,'' kepada,(a.desc1 +' '+replace(b.gl_invois_no,'HR','')) as Keteragan,'' as projek,''bank,'' acc_no,a.Overall as jumlah,'0.00' Disk,'' jen_cukai,'0.00' cukai_amt,a.Overall amount,a.Overall unit,'' kat,'1' qty  from  "
                          + " ( select pv_item,sb1.no_permohonan,sb1.desc1,sum(sb1.Overall) Overall,sb1.jp_desc,sb1.tarkih_permohonan,sb1.nama_pelanggan_code,sb1.status,sb1.jp_cd,sb1.no_inv,sb1.semak_sts,sb1.semakdt,sb1.tk_invois,sb1.tk_mohon,sb1.kat_penerima,sb1.Terma,sb1.pv_no,sb1.perkara,sb1.pcod,sb1.semak_id,sb1.lulus_sts from ( select pv_item,m1.no_permohonan as no_permohonan,case when pv_item = '1' then 'Gaji Kakitangan' when pv_item = '2' then 'STATUTORI MAJIKAN (KWSP)' when pv_item = '3' then 'STATUTORI MAJIKAN (PERKESO)' "
                            ...
                            + "  ) as sb1 group by pv_item,sb1.no_permohonan,sb1.desc1,sb1.jp_desc,sb1.tarkih_permohonan,sb1.nama_pelanggan_code,sb1.status,sb1.jp_cd,sb1.no_inv,sb1.semak_sts,sb1.semakdt,sb1.tk_invois,sb1.tk_mohon,sb1.kat_penerima,sb1.Terma,sb1.pv_no,sb1.perkara,sb1.pcod,sb1.semak_id,sb1.lulus_sts "
                            + " ) as a outer apply(select gl_invois_no from KW_General_Ledger where gl_jenis_no=a.no_permohonan group by gl_invois_no) as b) as a where  no_permohonan ='" + Session["cmd_arg3"].ToString() + "' and Keteragan='" + Session["cmd_arg2"].ToString() + "' ";
            ...
            dt2 = Dbcon.Ora_Execute_table("select 'K' txn_type,k1.Ref_doc_name,kod_akauan,s1.nama_akaun ,s3.Ref_kod_cukai as gsttype,s3.Ref_nama_cukai as gstname,keterangan,CAST(CASE c.tax WHEN 'Y' THEN 1 ELSE 0 END AS BIT) AS tax,othgst,case when c.gstjumlah = '0.00' then '0.00' else Format(c.gstjumlah,'#,##,###.00') end as gstjumlah , '0.00' as othgstjumlah , case when c.jumlah = '0.00' then '0.00' else Format(c.jumlah,'#,##,###.00') end as jumlah , case when c.overall = '0.00' then '0.00' else Format(c.overall,'#,##,###.00') end as overall,m1.Overall inv_amt   from KW_Pembayaran_Credit_item c inner join KW_Pembayaran_Credit c1 on c1.no_Rujukan=c.no_Rujukan left join KW_Pembayaran_invois m1 on m1.no_invois=c1.no_invois left join KW_Ref_Carta_Akaun s1 on s1.kod_akaun=c.kod_akauan left join KW_Ref_Tetapan_cukai s3 on s3.Ref_kod_cukai=c.tax left join KW_Ref_Doc_kod k1 on k1.Ref_doc_code='05' where c1.no_invois='" + TextBox27.Text + "' union all select 'D' txn_type,k1.Ref_doc_name,kod_akauan,s1.nama_akaun ,s3.Ref_kod_cukai as gsttype,s3.Ref_nama_cukai as gstname,keterangan,CAST(CASE c.tax WHEN 'Y' THEN 1 ELSE 0 END AS BIT) AS tax,othgst,case when c.gstjumlah = '0.00' then '0.00' else Format(c.gstjumlah,'#,##,###.00') end as gstjumlah , '0.00' as othgstjumlah , case when c.jumlah = '0.00' then '0.00' else Format(c.jumlah,'#,##,###.00') end as jumlah , case when c.overall = '0.00' then '0.00' else Format(c.overall,'#,##,###.00') end as overall,m1.Overall inv_amt   from KW_Pembayaran_dedit_item c inner join KW_Pembayaran_dedit c1 on c1.no_Rujukan=c.no_Rujukan left join KW_Pembayaran_invois m1 on m1.no_invois=c1.no_invois left join KW_Ref_Carta_Akaun s1 on s1.kod_akaun=c.kod_akauan left join KW_Ref_Tetapan_cukai s3 on s3.Ref_kod_cukai=c.tax left join KW_Ref_Doc_kod k1 on k1.Ref_doc_code='06' where c1.no_invois='" + TextBox27.Text +"'");
            ...
            {
                string unit1 = (g1.FindControl("lblover") as Label).Text;
                string kat = (g1.FindControl("Label26") as Label).Text;
                string jum_amt = (g1.FindControl("Label27") as Label).Text;
                if (kat == "D")
                {
                    pv_amt = jum_unit + float.Parse(unit1);
                    jum_unit = pv_amt;
                }
                else if (kat == "K")
                {
            ...
            if (dt2.Rows.Count != 0)
            {
                ...
                TextBox17.Text = double.Parse(Convert.ToString(pv_amt)).ToString("C").Replace("$", "").Replace("RM", "");
            }
            else
            {
...

    {
...

        {
            ...
            Session["dbtno"] = txtnoper.Text;

            Session["rpt_lang"] = "mal";

            Session["rpt_type"] = "payment_voucher";
...

    {
...

        {
            ...
            DateTime fd = DateTime.ParseExact(txttarikhinvois.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture);
...

        {
            ...
            condtion = "and a.no_resit ='" + txtnoinvois.Text + "' and a.no_invois='" + TextBox13.Text + "' and a.tarikh_resit='" + fmdate + "'";
...

        {
            ...
            condtion = "and a.no_invois='" + TextBox13.Text + "' and a.tarikh_resit='" + fmdate + "'";
...

        {
            ...
            condtion = "and a.no_resit ='" + txtnoinvois.Text + "' and a.no_invois='" + TextBox13.Text + "'";
...

        {
            ...
            condtion = "and a.no_resit ='" + txtnoinvois.Text + "' and a.tarikh_resit='" + fmdate + "'";
...

        {
            ...
            condtion = "and a.no_resit ='" + txtnoinvois.Text + "'";
...

        {
            ...
            condtion = "and a.tarikh_resit='" + fmdate + "'";
...

        {
            ...
            condtion = "and a.no_invois='" + TextBox13.Text + "'";

        }



        qry1 = "select a.pvno,a.pv_no,a.jp_cd,a.jp_desc,a.tarkih_permohonan, case when(ISNULL(s4.Ref_nama_syarikat, '') = '' and ISNULL(s4_1.Ref_nama_syarikat, '') = '') then s4_2.stf_name when(ISNULL(s4.Ref_nama_syarikat, '') = '' and ISNULL(s4_2.stf_name, '') = '') then s4_1.Ref_nama_syarikat when(ISNULL(s4_1.Ref_nama_syarikat, '') = '' and ISNULL(s4_2.stf_name, '') = '') then s4.Ref_nama_syarikat else '' end as bk,a.no_inv,a.perkara,a.jumlah,a.status from(SELECT a.pvno,a.pv_no,a.jp_cd,a.jp_desc,a.tarkih_permohonan,b.mhn_byr_kepada bk,a.no_inv,a.perkara,a.jumlah,a.status from (SELECT s1.Pv_no as pvno,no_permohonan as pv_no, '03' as jp_cd, 'MOHON BAYAR' as jp_desc,Format(tarkih_permohonan,'dd/MM/yyyy') tarkih_permohonan,'' as bk,no_ruj no_inv,m1.perkara,m1.jumlah ,case when ISNULL(s1.kew_appr_pv_cd,'') ='L' then 'LULUS' when ISNULL(s1.kew_appr_pv_cd, '') = 'T' then 'TIDAK LULUS' else 'WAITING' end as status  FROM KW_Pembayaran_mohon m1 left join KW_Pembayaran_Pay_voucer s1 on s1.no_invois= no_invois and s1.no_doc=no_permohonan WHERE m1.Status='A' and kew_appr_gl_cd='L' and  ISNULL(m1.kew_appr_pv_cd,'') ='' ) as a"
           + " outer apply (select top(1) mhn_byr_kepada from KW_Pembayaran_mohon_item where mhn_no_permohonan=a.pv_no) as b"
           + " Union all SELECT s1.Pv_no as pvno,m1.no_invois as pv_no, '01' as jp_cd, 'KREDITOR INVOIS' as jp_desc,Format(tarikh_invois, 'dd/MM/yyyy') tarkih_permohonan,m1.Bayar_kepada as bk,m1.no_invois no_inv,m1.perkara,m1.Overall as jumlah,case when ISNULL(s1.kew_appr_pv_cd,'') = 'L' then 'LULUS' when ISNULL(s1.kew_appr_pv_cd, '') = 'T' then 'TIDAK LULUS' else 'WAITING' end as status FROM KW_Pembayaran_invois m1 left join KW_Pembayaran_Pay_voucer s1 on s1.no_invois= m1.no_invois WHERE m1.Status='A' and kew_appr_gl_cd='L' and ISNULL(m1.kew_appr_pv_cd,'') ='' "
           + " Union all select * from ( select a.pvno as pvno,a.pv_no,a.jp_cd,a.jp_desc,a.tarkih_permohonan, "
            + " nama_pelanggan_code as bk,a.no_inv,(a.desc1 + ' ' + replace(b.gl_invois_no, 'HR', '')) perkara,a.Overall as jumlah,a.status from ( select pv_item, pvno, pv_no, desc1, sum(Overall)Overall, jp_desc, tarkih_permohonan, nama_pelanggan_code, status, jp_cd, no_inv from( select  pv_item, p1.Pv_no pvno, m1.no_permohonan as pv_no, "
           + " case when pv_item = '1' then 'Gaji Kakitangan' when pv_item = '2' then 'STATUTORI MAJIKAN (KWSP)' when pv_item = '3' then 'STATUTORI MAJIKAN (PERKESO)' "
           + " when pv_item = '4' then 'STATUTORI MAJIKAN (LHDN)' when pv_item = '5' then 'STATUTORI MAJIKAN (SIP)' else m1.keterangan end as desc1, "
           + " sum(m1.Overall) as Overall, s2.kk_skrin_name as jp_desc, Format(tarikh_lulus, 'dd/MM/yyyy') as tarkih_permohonan, "
           + " nama_pelanggan_code,case when ISNULL(p1.kew_appr_pv_cd, '') = 'L' then 'LULUS' when ISNULL(p1.kew_appr_pv_cd, '') = 'T' then 'TIDAK LULUS' else 'WAITING' end as status, Jenis_permohonan as jp_cd, no_Rujukan no_inv from KW_jurnal_inter_items m1 "
           + " inner join KW_jurnal_inter m2 on m2.no_permohonan = m1.no_permohonan left join KW_Pembayaran_Pay_voucer p1 on p1.no_invois = "
           + " m1.no_permohonan left join kk_pid_skrin s2 on s2.KK_skrin_id = nama_pelanggan_code and s2.status = 'A'   where m1.pv_item != '0' and  m1.overall != '0.00' "
           + "  and m2.kew_appr_gl_cd = 'L'  and ISNULL(m2.kew_appr_pv_cd, '') = ''  group by  pv_item, p1.Pv_no, m1.no_permohonan, tarikh_lulus, "
           + " nama_pelanggan_code, ISNULL(kew_appr_gl_cd, ''), Jenis_permohonan, no_Rujukan, s2.kk_skrin_name, keterangan,p1.kew_appr_pv_cd) as sb1 group by pv_item, pvno, pv_no, desc1, jp_desc, tarkih_permohonan, nama_pelanggan_code, status, jp_cd, no_inv "
           + " ) as a outer apply(select gl_invois_no from KW_General_Ledger where gl_jenis_no=a.pv_no group by gl_invois_no) as b) as a where a.jp_cd In ('14','15','16','18','19','20','21') "
           + " ) as a left join KW_Ref_Pembekal s4 on s4.Ref_no_syarikat = a.bk left join KW_Ref_Pelanggan s4_1 on s4_1.Ref_no_syarikat = a.bk  left join hr_staff_profile s4_2 on s4_2.stf_staff_no = a.bk ";
            //end
...

    {
        ...
        //    qry1 = "select Data,tarkih_mohon,a.no_permohonan,'' tarkih_invois,jumlah,Payamt, Cast(jumlah as money )- Cast(Payamt as money ) Baki from (select Data,tarkih_mohon,a.no_permohonan,a.tarkih_invois,jumlah,isnull(Payamt,'0.00') Payamt from (select I.Data,Format(tarkih_mohon,'dd/MM/yyyy')tarkih_mohon,I.No_permohonan,Format(tarkih_invois,'dd/MM/yyyy')tarkih_invois,Format(sum(I.Overall),'#,##,###.00') jumlah from KW_Pembayaran_invoisBil_item I where I.no_permohonan='" + TextBox6.Text + "' "+ smb_clk1 + " group by I.Data,tarkih_mohon,I.No_permohonan,tarkih_invois) a left join (select no_permohonan,case when p.Status='L' Then Format(sum(P.payamt),'#,##,###.00')  else  '0.00'  End Payamt from KW_Pembayaran_Pay_voucer P where Status='L' group by no_permohonan,p.Status) b on  a.no_permohonan=b.no_Permohonan) a order by a.tarkih_invois";
...

                {
...

                    {
...

                        {
                            ...
                            gen_invkd = Dbcon.Ora_Execute_table("select no_invois from KW_Penerimaan_invois where no_invois='" + txtnoruj2.Text + "' and Status='A'");
...

    {
        ...
        TextBox dis1 = (TextBox)row.FindControl("Txtdis");
...

        {
...

            {
                ...
                numTotal = ((qty1 * unit1) - Convert.ToDecimal(dis1.Text));
            ...
            numTotal_1 = ((qty1 * unit1));

            jum.Text = numTotal.ToString("C").Replace("RM", "").Replace("$", "");

            jumI.Text = numTotal_1.ToString("C").Replace("RM", "").Replace("$", "");
...

            {
...

                {
...

                    {
                        ...
                        decimal tot1 = ((decimal)Convert.ToDecimal(unit.Text) * (decimal)Convert.ToDecimal(qty1));
...

                    {
                        ...
                        decimal tot1 = ((decimal)Convert.ToDecimal(unit.Text) * (decimal)Convert.ToDecimal(qty1)) + Convert.ToDecimal(gmt1);
...

                {
...

                    {
                        ...
                        numTotal1 = ((Convert.ToDecimal(unit.Text) * qty1) - Convert.ToDecimal(dis.Text));
...

                    {
                        ...
                        numTotal1 = (Convert.ToDecimal(unit.Text) * qty1);
...

                    {
                        ...
                        decimal tot1 = ((Convert.ToDecimal(unit.Text) * qty1) - Convert.ToDecimal(dis.Text));
...

    {
        ...
        DataTable dt1 = Dbcon.Ora_Execute_table("select doc_type_cd,format as fmt,SUBSTRING(cur_format, 1, 12) as lfrmt1,SUBSTRING(cur_format, 13, 4) as lfrmt2,cur_format as cfmt from KW_Format_Nombor_rujukan where doc_type_cd='04' and Status='A'");
...

        {
            ...
            DataTable dt = Dbcon.Ora_Execute_table("select   ISNULL(max(SUBSTRING(pv_no,13,3000)),'0') from KW_Pembayaran_Pay_voucer");
    ...
    protected void ddbkepada_SelectedIndexChanged1(object sender, EventArgs e)
...

    {
        ...
        //    DropDownList innerDropdown = (DropDownList)row.FindControl("dd_bank");

        //    TextBox acc_no = (TextBox)row.FindControl("TextBox12");

        //    if (DropDownList1.SelectedValue == "01")

        //    {

        //        ddokdicno = Dbcon.Ora_Execute_table("SELECT stf_name as val1,stf_staff_no as val2,stf_bank_cd as bank,stf_bank_acc_no as acc_no FROM hr_staff_profile s1 left join hr_post_his s2 on s2.pos_staff_no=s1.stf_staff_no and pos_end_dt >='" + DateTime.Now.ToString("yyyy-MM-dd") + "' where stf_staff_no='"+ dd_kepada.SelectedValue + "'");
        ...
        //        ddokdicno = Dbcon.Ora_Execute_table("select Ref_nama_syarikat as val1,Ref_no_syarikat as val2,pem_bank_cd as bank,pem_bank_accno as acc_no from KW_Ref_Pembekal where Status='A' and Ref_no_syarikat='" + dd_kepada.SelectedValue + "'");
        ...
        //        ddokdicno = Dbcon.Ora_Execute_table("select Ref_nama_syarikat as val1,Ref_no_syarikat as val2,pel_bank_cd as bank,pel_bank_accno as acc_no from KW_Ref_Pelanggan where Status='A' and Ref_no_syarikat='" + dd_kepada.SelectedValue + "'");

        //    }

        //    innerDropdown.DataSource = GetData("select Bank_Code,Bank_Name from Ref_Nama_Bank where Status='A'");

        //    innerDropdown.DataTextField = "Bank_Name";

        //    innerDropdown.DataValueField = "Bank_Code";
        ...
        //        innerDropdown.SelectedValue = ddokdicno.Rows[0]["bank"].ToString().Trim();

        //        acc_no.Text = ddokdicno.Rows[0]["acc_no"].ToString();
...

    {
...

        {
            ...
            else if (lblctrl.Text == "TIDAK LULUS")

            {

                lblctrl.Attributes.Add("Class", "label label-warning Uppercase");
...

            {
                ...
                //lblctrl.ForeColor = Color.FromName("Green");
...

    {
...

        {
            ...
            ddokdicno = DBCon.Ora_Execute_table("select * From KW_Penerimaan_invois where no_invois='" + lblTitle.Text + "' and Status='A' ");

            if (ddokdicno.Rows.Count != 0)

            {

                string Inssql_main = "Update KW_Penerimaan_invois set Status='T' where no_invois='" + lblTitle.Text + "' and Status='A'";
...

                {
                    ...
                    string Inssql_item = "Update KW_Penerimaan_invois_item set Status='T' where no_invois='" + lblTitle.Text + "' and Status='A'";

                    Status = DBCon.Ora_Execute_CommamdText(Inssql_item);

                    BindMohon();

                    ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "$.Zebra_Dialog('Debtor Invois Dihapuskan Berjaya.',{'type': 'confirmation','title': 'Success','auto_close': 2000});", true);
