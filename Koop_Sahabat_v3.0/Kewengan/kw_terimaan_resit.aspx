...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1><asp:Label ID="ps_lbl1" Visible="false" runat="server"></asp:Label>Terimaan</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i><asp:Label ID="ps_lbl2" Visible="false" runat="server"></asp:Label></a> Kewangan</li>
                            <li class="active"><asp:Label ID="ps_lbl3" Visible="false" runat="server"></asp:Label>Terimaan</li>
                        </ol>
                    </section>
        ...
        <ContentTemplate>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><asp:Label ID="ps_lbl4" Visible="false" runat="server"></asp:Label> <asp:Label Visible="false" ID="hd_txt" runat="server"></asp:Label>Terimaan</h3>
                         <%--   <div class="type-1 ">
                              <div class="type-in">
                                                                 ...
                                                                 />
                                                                    ...
                                                                    <fieldset class="col-md-12">
                                                                     <legend style="width:4%"><asp:Label ID="ps_lbl11" runat="server"></asp:Label></legend>
                                                                        ...
                                                                        <div class="col-md-3 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-5 control-label"><asp:Label Visible="false" ID="ps_lbl12" runat="server"></asp:Label>No Rujukan</label>
                                                                                <div class="col-sm-7">
                                                                               ...
                                                                               <div class="col-md-3 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-5 control-label"><asp:Label ID="ps_lbl13" Visible="false" runat="server"></asp:Label> Tarikh Terimaan</label>
                                                                                <div class="col-sm-7">
           ...
           <div class="col-md-12 box-body">
            ...
            <Columns>
                ...
                <ItemTemplate>
                    <asp:Label ID="no_invois" runat="server" Text='<%# Eval("no_invois") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
                <asp:BoundField DataField="tarkih_permohonan" HeaderText="Tarkih Terimaan" ItemStyle-HorizontalAlign="Center" />            
                <asp:TemplateField HeaderText="Pelenggan" ItemStyle-HorizontalAlign="Left">  
                    <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>  
                                                <asp:Label ID="Bayar_kepada" runat="server" Text='<%# Eval("Bayar_kepada") %>'></asp:Label>
                                            </ItemTemplate>  
                                                </asp:TemplateField>
                <asp:BoundField DataField="po_no" HeaderText="No Invois" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                <asp:BoundField DataField="keterangan" HeaderText="Perkara" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
 ...
 <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center">  
                    <ItemStyle HorizontalAlign="Center" />
                                            <ItemTemplate>  
<asp:Label ID="lbl_mohon_no" runat="server" Text='<%# Eval("no_invois") %>' Visible="false"></asp:Label>
    <asp:Label ID="Label17" runat="server" Text='<%# Eval("kat_penerima") %>' Visible="false"></asp:Label>
                                                ...
                                                <asp:LinkButton ID="LinkButton1" runat="server"  CommandArgument='<%# Eval("no_invois")%>' CommandName="Add"  onclick="lblSubbind_Click" ToolTip='<%# Eval("no_invois").ToString().ToUpper() %>' ><i class='fa fa-search'></i></asp:LinkButton>                                                                    
                                                &nbsp;&nbsp;
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <asp:TextBox ID="end_dt1" runat="server" Visible="false"></asp:TextBox>
                                                                 ...
                                                                 <fieldset class="col-md-12">
                                                                     <legend style="width:11%">Maklumat Terimaan</legend>     
                                                                  ...
                                                                  <div class="row">
                                                                         <div class="col-md-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                             ...
                                                                             <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"><asp:Label ID="Label20" Visible="false" runat="server"></asp:Label>Nama Pelenggan <span class="style1">*</span></label>                     
                                                                                <div class="col-sm-8">
                                                                                     <div class="col-sm-9">
                                                                                    <div class="input-group">
                                                                                   <asp:DropDownList ID="dd_kepada" style="width:100%; font-size:13px;" runat="server" class="form-control select2 validate[optional]" OnSelectedIndexChanged="ddbkepada_SelectedIndexChanged1" AutoPostBack="true" ></asp:DropDownList>
                                                                                         <span class="input-group-addon"><i class="fa fa-search"></i></span>
                                             </div>
                                                                                </div>
                                                                                 <div class="col-sm-2">
                                                                                     <asp:Button ID="Button19" runat="server" Text="New Entry" class="btn btn-danger" UseSubmitBehavior="false"
                                                                                   onclick="new_entry"  />
                                                                                          </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"><asp:Label Visible="false" ID="ps_lbl27" runat="server"></asp:Label> No Invois <span class="style1">*</span></label>
                                                                                <div class="col-sm-8">
                                                                                  <asp:DropDownList ID="dd_terma" runat="server" style="width:100%; font-size:13px;" class="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="get_invois_info">
                                                                                </asp:DropDownList>
                                                                                </div>
                                                                                </div>
                                                                            </div>
                                                                     ...
                                                                     <div class="row">
                                                                         <div class="col-md-12">
                                                                               <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"><asp:Label ID="ps_lbl20" Visible="false" runat="server"></asp:Label> Tarikh Terimaan <span class="style1">*</span></label>     
                                                                                <div class="col-sm-8">
                                                                                 <div class="input-group">
                                                                        ...
                                                                        <div class="col-md-6 box-body" id="mb_tab1" runat="server">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"><asp:Label ID="ps_lbl19" Visible="false" runat="server"></asp:Label> No Rujukan <span class="style1">*</span></label>
                                                                                <div class="col-sm-8">
                                                                                     <div class="input-group">
                                                                ...
                                                                <div class="box-body">&nbsp;</div>
                                                                    ...
                                                                    <div class="row">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                  ...
                                                                                  <asp:TextBox ID="TextBox16" runat="server" class="form-control uppercase validate[optional]"></asp:TextBox> 
                                                                                         <asp:TextBox ID="TextBox23" runat="server" style="display:none;" class="form-control uppercase validate[optional]"></asp:TextBox> 
                                                                                           <span class="input-group-addon"><i class="fa fa-edit"></i></span>
                                             </div>
                                                                             ...
                                                                             <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"> Diterima Ke Akaun Bank (DR) <span class="style1">*</span></label>
                                                                                <div class="col-sm-8">
                                                                         ...
                                                                         <div class="box-body">&nbsp;</div>
                                                                        <div id="mak_resit" runat="server" visible="false">
                                                                        <fieldset class="col-md-12">     
                                                                             <legend style="width:11%">Maklumat Resit / CEK</legend>                                                      
                                                                    <div class="row">
                                                                         <div class="col-md-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                     <div class="input-group">
                                                                                  <asp:TextBox ID="TextBox19" runat="server" class="form-control uppercase validate[optional]"></asp:TextBox> 
                                                                                           <span class="input-group-addon"><i class="fa fa-edit"></i></span>
                                             </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-4 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"><asp:Label ID="Label21" Visible="false" runat="server"></asp:Label> Tarikh Resit / CEK </label>
                                                                                <div class="col-sm-8">
                                                                                 <div class="input-group">
                                                                                      <asp:TextBox ID="TextBox22" runat="server" class="form-control validate[optional,custom[dtfmt]] datepicker2 mydatepickerclass" placeholder="DD/MM/YYYY"></asp:TextBox> 
                                                                                           <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                             </div>
                                                                                </div>
                                                                                </div>
...
<asp:gridview ID="Gridview1" runat="server"  class="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="20" ShowFooter="true" GridLines="None" OnRowDeleting="grvStudentDetails_RowDeleting" onrowdatabound="Gridview3_RowDataBound" >
            <Columns>
             ...
             <asp:TemplateField HeaderText="Jenis Permohonan" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
                 <asp:Label ID="lbljp" runat="server" Text='<%# Eval("jp") %>'  />
                    <asp:Label ID="Label22" runat="server" Visible="false" Text='<%# Eval("Ref_doc_code") %>'  />
                </ItemTemplate>
            </asp:TemplateField>
              ...
              <asp:TemplateField HeaderText="Jumlah Kecil (RM)" ItemStyle-HorizontalAlign="Right">
                <ItemTemplate>
                 <asp:Label ID="lbljum" runat="server" Text='<%# Eval("jumlah","{0:n}") %>' DataFormatString="{0:n}"  />
                   ...
                   <asp:TemplateField HeaderText="Disk (RM)" ItemStyle-HorizontalAlign="Right">
                <ItemTemplate>
                 <asp:Label ID="lbldisc" runat="server" Text='<%# Eval("discount","{0:n}") %>' DataFormatString="{0:n}"  />
                </ItemTemplate>
            </asp:TemplateField>  
           ...
           <asp:TemplateField HeaderText="Caj Perkhidmatan (%)" Visible="false" ItemStyle-HorizontalAlign="Center">
             ...
             <asp:TemplateField HeaderText="Jenis Cukai" ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate>
                 ...
                 <asp:Label ID="jumlah_ftr" CssClass="form-control" style="width:100%; text-align:right;" runat="server" class="uppercase" ></asp:Label>
...
<asp:BoundField DataField="acc_no" HeaderText="No Akaun Bank" Visible="false" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
             <asp:BoundField DataField="jumlah" HeaderText="Harga / Unit (RM)" HeaderStyle-HorizontalAlign="Right" DataFormatString="{0:n}" ItemStyle-HorizontalAlign="Right" />
              ...
              <asp:BoundField DataField="Disk" HeaderText="Disk (RM)" HeaderStyle-HorizontalAlign="Right" DataFormatString="{0:n}" ItemStyle-HorizontalAlign="Right" />
                <asp:BoundField DataField="tot" HeaderText="Jumlah Kecil (RM)" HeaderStyle-HorizontalAlign="Right" DataFormatString="{0:n}" ItemStyle-HorizontalAlign="Right" />
                                                                                 ...
                                                                                 <div class="col-md-12" style="text-align:center;">
                                                                                  ...
                                                                                  <asp:Button ID="btnprintmoh" runat="server" class="btn btn-warning" Text="Print" Type="submit"
                                                                                   onclick="btnprintmoh_Click" 
                                                                                    />
                                                                                    <asp:Button ID="Button23" runat="server" class="btn btn-warning" onclick="Button22_Click" Text="Cetak (M)" Type="submit" />
