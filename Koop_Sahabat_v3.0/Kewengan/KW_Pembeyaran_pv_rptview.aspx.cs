...
public partial class KW_Pembeyaran_pv_rptview : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                if (nameshbt != "")
                {
                    ...
                    dt = Dbcon.Ora_Execute_table("select m1.no_invois as ss1,m1.untuk_akaun ss2,s1.nama_syarikat ss3,s1.alamat_syarikat ss4,s2.Ref_nama_syarikat ss5,FORMAT(m1.tarkih_pv,'dd/MM/yyyy', 'en-us')  ss6,FORMAT(m1.tarikh_invois,'dd/MM/yyyy', 'en-us') ss7,m1.jumlah as ss8,m1.gstjumlah as ss9,m1.othgstjumlah as ss10,m1.Overall as ss11,m1.payamt as ss12,s4.Ref_No_akaun ss13,m1.No_cek ss14,s4.Ref_nama_bank ss15,m1.Pv_no ss16,'' ss17,'' ss18 from KW_Pembayaran_Pay_voucer m1 left join KW_Profile_syarikat s1 on s1.kod_syarikat=m1.untuk_akaun and cur_sts='1' left join KW_Ref_Pembekal s2 on s2.Ref_kod_akaun=m1.Deb_kod_akaun left join KW_Ref_Akaun_bank s4 on s4.Ref_kod_akaun=m1.Cre_kod_akaun where m1.Pv_no='" + nameshbt + "'");
