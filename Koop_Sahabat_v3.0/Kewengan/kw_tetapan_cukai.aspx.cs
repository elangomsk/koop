...
public partial class kw_tetapan_cukai : System.Web.UI.Page
{
    ...
    void view_details()
    {
        ...
        try
        {
            ...
            ddokdicno = DBCon.Ora_Execute_table("select * From KW_Ref_Tetapan_cukai where Id='" + lblid + "' ");
            if (ddokdicno.Rows.Count != 0)
            {
                Button4.Text = "Kemaskini";
                ver_id.Text = "1";
                get_id.Text = lblid;
                TextBox1.Text = ddokdicno.Rows[0]["Ref_nama_cukai"].ToString();
                ...
                TextBox2.Text = ddokdicno.Rows[0]["Ref_kod_cukai"].ToString();
    ...
    protected void katcd_TextChanged(object sender, EventArgs e)
    {
        ...
        sel_kat = DBCon.Ora_Execute_table("select * from KW_Ref_Tetapan_cukai where Ref_kod_cukai = '" + TextBox2.Text + "'");
        if (sel_kat.Rows.Count != 0)
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Kod Cukai Yang Sedia Ada.');", true);
            TextBox2.Text = "";
            TextBox2.Focus();
        }
        else
    ...
    {
        Response.Redirect("../kewengan/kw_tetapan_cukai.aspx");
    }
