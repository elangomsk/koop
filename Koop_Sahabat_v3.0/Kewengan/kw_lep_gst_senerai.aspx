<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_lep_gst_senerai.aspx.cs" Inherits="kw_lep_gst_senerai" %>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                         <asp:listbox runat="server" class="form-control uppercase" id="DropDownList2" selectionmode="Multiple"></asp:listbox>
                                    </div>
                                </div>
                            </div>
                                 </div>
