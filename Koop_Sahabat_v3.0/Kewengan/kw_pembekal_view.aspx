<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_pembekal_view.aspx.cs" Inherits="kw_pembekal_view" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><asp:Label ID="hd_txt" Visible="false" runat="server"></asp:Label>Kreditor Pembekal</h3>
                             <div class="type-1 ">
                              <div class="type-in">
