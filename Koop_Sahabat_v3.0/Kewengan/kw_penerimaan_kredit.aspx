<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_penerimaan_kredit.aspx.cs" Inherits="kw_penerimaan_kredit" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1><asp:Label ID="ps_lbl1" runat="server"></asp:Label>Debtor Nota Kredit</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i><asp:Label ID="ps_lbl2" runat="server"></asp:Label></a>Kewangan</li>
                            <li class="active"><asp:Label ID="ps_lbl3" runat="server"></asp:Label>Debtor Nota Kredit</li>
                        </ol>
                    </section>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><asp:Label ID="ps_lbl4" Visible="false" runat="server"></asp:Label> <asp:Label ID="hd_txt" Visible="false" runat="server"></asp:Label>Nota Kredit</h3>
                             <div class="type-1 ">
                              <div class="type-in">
          ...
          <asp:TemplateField HeaderText="BIL">  
                                    ...
                                    <div class="col-sm-12">
                                       <asp:Button ID="tab3tam" runat="server" class="btn btn-danger" Text="+Tambah" Type="submit"
                                                                     ...
                                                                     <legend style="width:4%"><asp:Label ID="ps_lbl78" runat="server"></asp:Label></legend>
                                                                        ...
                                                                        <div class="col-md-3 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-5 control-label"><asp:Label Visible="false" ID="ps_lbl79" runat="server"></asp:Label> No Nota Kredit</label>
                                                                                <div class="col-sm-7">
                                                                            ...
                                                                            <div class="form-group">
                                                                              ...
                                                                              <div class="col-md-3 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-5 control-label"><asp:Label Visible="false" ID="ps_lbl81" runat="server"></asp:Label> Pelanggan</label>                      
                                                                                <div class="col-sm-7">
           ...
           <div class="col-md-12 box-body">
            ...
            <asp:TemplateField HeaderText="BIL">  
             ...
             <asp:TemplateField HeaderText="No Nota Kredit" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
             ...
             <asp:BoundField DataField="tarkih_permohonan" HeaderText="Tarikh Mohon" ItemStyle-HorizontalAlign="Center" />
              <asp:BoundField DataField="Bayar_kepada" HeaderText="Pelanggan" ItemStyle-HorizontalAlign="Left" />
                <asp:BoundField DataField="no_invois" HeaderText="No Invois" ItemStyle-HorizontalAlign="Center" />
                                                       ...
                                                       <%-- <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />--%>
                                                        ...
                                                        <AlternatingRowStyle BackColor="White" />
                                                                   ...
                                                                   <div id="th2" runat="server">
                                                                           ...
                                                                           <fieldset class="col-md-12">
                                                                       <legend style="width:11%">Maklumat Nota Kredit</legend>
                                                                       ...
                                                                       <div class="row">
                                                                        ...
                                                                        <div class="col-md-4 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-5 control-label"><asp:Label ID="ps_lbl84" Visible="false" runat="server"></asp:Label>Nama Pelanggan <span class="style1">*</span></label>
                                                                                <div class="col-sm-7">
                                        ...
                                        <asp:TextBox ID="end_dt1" runat="server" Visible="false"></asp:TextBox>
                                                                         ...
                                                                         <div class="col-md-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                              ...
                                                                              <div class="col-md-4 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-5 control-label">No Akaun Bank </label>
                                                                                <div class="col-sm-7">
                                                                                     <div class="input-group">
                                                                      ...
                                                                      <div class="row" id="kredit_tab4" runat="server">
                                                                         <div class="col-md-12">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label">Tarikh Nota Kredit Kreditor <span class="style1">*</span></label>
                                                                                <div class="col-sm-8">
                                                                                  <div class="input-group">
                                                                               <asp:TextBox ID="txttcinvois" runat="server" class="form-control validate[optional,custom[dtfmt]] datepicker mydatepickerclass"
                                                                                ...
                                                                                <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label">No. Nota Kredit Kreditor <span class="style1">*</span></label>
                                                                                <div class="col-sm-8">
                                                                                     <div class="input-group">
                                                                    ...
                                                                    <div class="row">
                                                                         <div class="col-md-12">
                                                                                <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"><asp:Label Visible="false" ID="ps_lbl90" runat="server"></asp:Label>No Nota Kredit <span class="style1">*</span></label>
                                                                                <div class="col-sm-8">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                     <div class="input-group">
                                                                                  <asp:TextBox ID="TextBox4" runat="server" class="form-control uppercase validate[optional]"></asp:TextBox> 
                                                                                           <span class="input-group-addon"><i class="fa fa-edit"></i></span>
                                             </div>
                                                                         ...
                                                                         <div class="box-body">&nbsp;</div>
                                                                     <div class="box-header with-border">
                            <h3 class="box-title">Butiran Nota Kredit</h3>
                        </div>
                                                                    <div class="panel" style="width: 100%;">
...
<asp:BoundField DataField="amount" HeaderText="Amaun (RM)" HeaderStyle-HorizontalAlign="Right" DataFormatString="{0:n}" ItemStyle-HorizontalAlign="Right" />
  ...
  <asp:gridview ID="Gridview10" runat="server"  class="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="20" ShowFooter="true" GridLines="None" OnRowDeleting="grvStudentDetails_RowDeleting" onrowdatabound="Gridview9_RowDataBound" >
             ...
             <asp:TemplateField HeaderText="Kod Akaun (DR)" Visible="false" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Keterangan" ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate>
                     ...
                     <asp:TextBox ID="Txtunit" runat="server"  class="form-control uppercase" Width="100%" Text='<%# Eval("column3","{0:n}") %>'  placeholder="0.00"   OnTextChanged="QtyChanged1" AutoPostBack="true"   style="text-align:right;"    ></asp:TextBox>
                ...
                <ItemTemplate>
                     ...
                     <asp:TextBox ID="Txtqty_new" runat="server"  class="form-control uppercase" Width="100%" OnTextChanged="QtyChanged1" AutoPostBack="true"   style="text-align:right;"    ></asp:TextBox>
                ...
                <ItemTemplate>
                     <asp:Label ID="Txtdis" runat="server"  class="form-control uppercase" Width="100%" Text='<%# Eval("column3","{0:n}") %>' placeholder="0.00"   style="text-align:right;"    ></asp:Label>
                </ItemTemplate>
                 <FooterStyle HorizontalAlign="Right" />
                <FooterTemplate>
...
<asp:gridview ID="Gridview12" runat="server"  class="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="20" ShowFooter="true" GridLines="None" OnRowDeleting="grvStudentDetails_RowDeleting" onrowdatabound="Gridview3_RowDataBound" >
            <Columns>
             ...
             <asp:TemplateField HeaderText="Kod Akaun" Visible="false" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
               ...
               <div class="box-body">&nbsp;</div>
                                                                          <div class="row">
                                                                                ...
                                                                                <asp:Button ID="Button22" runat="server" class="btn btn-danger" Text="Print" Type="submit"
                                                                                    ...
                                                                                    />
                                                                                                <asp:Button ID="Button25" Visible="false" runat="server" onclick="Button22_Click"  Text="Cetak (M)" class="btn btn-warning" UseSubmitBehavior="false"/>
                                                                                              <asp:Button ID="Button26" Visible="false" runat="server" onclick="ENG_Button22_Click" Text="Cetak (E)" class="btn btn-warning" UseSubmitBehavior="false"/>
  ...
  <asp:gridview ID="Gridview14" runat="server" CssClass="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="20" ShowFooter="true" GridLines="None" onrowdatabound="Gridview14_RowDataBound" >
         <Columns>
           ...
           <asp:TemplateField HeaderText="Caj Perkhidmatan (%)" ItemStyle-HorizontalAlign="Center">
            ...
            <Triggers>
               <asp:PostBackTrigger ControlID="Button25"  />
               <asp:PostBackTrigger ControlID="Button26"  />
           </Triggers>
    </asp:UpdatePanel>
        <!-- /.row -->
    </section>
