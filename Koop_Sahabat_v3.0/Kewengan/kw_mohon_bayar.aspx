<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_mohon_bayar.aspx.cs" Inherits="kw_mohon_bayar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1><asp:Label ID="ps_lbl1" Visible="false" runat="server"></asp:Label>Daftar Mohon Bayar</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i><asp:Label ID="ps_lbl2" Visible="false" runat="server"></asp:Label></a> Kewangan</li>
                            <li class="active"><asp:Label ID="ps_lbl3" Visible="false" runat="server"></asp:Label>Daftar Mohon Bayar</li>
                        </ol>
                    </section>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><asp:Label ID="ps_lbl4" Visible="false" runat="server"></asp:Label> <asp:Label Visible="false" ID="hd_txt" runat="server"></asp:Label>Daftar Mohon Bayar</h3>
                        </div>
                                                                 ...
                                                                 />
                                                                    ...
                                                                    <fieldset class="col-md-12">
                                                                     <legend style="width:4%"><asp:Label ID="ps_lbl11" runat="server"></asp:Label></legend>
                                                                        ...
                                                                        <div class="col-md-3 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-5 control-label"><asp:Label Visible="false" ID="ps_lbl12" runat="server"></asp:Label>No Mohon Bayar</label>
                                                                                <div class="col-sm-7">
                                                                            ...
                                                                            <div class="form-group">
                                                                              ...
                                                                              <div class="col-md-3 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-5 control-label"><asp:Label ID="ps_lbl14" Visible="false"  runat="server"></asp:Label> No Rujukan</label>
                                                                                <div class="col-sm-7">
           ...
           <div class="col-md-12 box-body">
            ...
            <Columns>
                <asp:TemplateField HeaderText="BIL">  
                 ...
                 <asp:TemplateField HeaderText="No Mohon Bayar" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                  <asp:Label ID="no_permohonan" runat="server" Text='<%# Eval("no_permohonan") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
                <asp:BoundField DataField="tarkih_permohonan" HeaderText="Tarkih Mohon" ItemStyle-HorizontalAlign="Center" />            
                ...
                <asp:BoundField DataField="no_ruj" HeaderText="No Rujukan" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                <asp:BoundField DataField="mhn_keterangan" HeaderText="Perkara" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
 ...
 <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center">  
                    <ItemStyle HorizontalAlign="Center" />
                                            <ItemTemplate>  
<asp:Label ID="lbl_mohon_no" runat="server" Text='<%# Eval("no_permohonan") %>' Visible="false"></asp:Label>
    <asp:Label ID="Label17" runat="server" Text='<%# Eval("kat_penerima") %>' Visible="false"></asp:Label>
                                                <asp:Label ID="Label18" runat="server" Text='<%# Eval("Bayar_kepada") %>' Visible="false"></asp:Label>
                                                <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("no_permohonan")%>' CommandName="Add" ToolTip='<%# Eval("no_permohonan")%>'  onclick="lblSubbind_Click" Font-Bold Font-Underline><i class='fa fa-search'></i></asp:LinkButton>
                                                &nbsp;&nbsp;
                                                                     ...
                                                                     <div class="row">
                                                                        ...
                                                                        <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                              ...
                                                                              <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"><asp:Label ID="ps_lbl21" Visible="false" runat="server"></asp:Label>Jenis Perolehan <span class="style1">*</span></label>                     
                                                                                <div class="col-sm-8">
        ...
        <asp:DropDownList ID="ddbkepada" style="width:100%; font-size:13px;" runat="server" class="form-control select2 validate[optional]" >
                                                                    ...
                                                                    UseSubmitBehavior="false" onclick="btncarian_Click"  />
                                                                      ...
                                                                      <div class="row">
                                                                        ...
                                                                        <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"><asp:Label ID="ps_lbl24" Visible="false" runat="server"></asp:Label> No Rujukan / No Invois</label>
                                                                                <div class="col-sm-8">
   ...
   <div class="input-group">
       <asp:TextBox ID="txtname" runat="server" class="form-control uppercase"></asp:TextBox> 
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"><asp:Label ID="ps_lbl19" Visible="false" runat="server"></asp:Label> No Mohon Bayar <span class="style1">*</span></label>
                                                                                <div class="col-sm-8">
                                                                        ...
                                                                        <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"> Cara Bayaran <span class="style1">*</span></label>
                                                                                <div class="col-sm-8">
   ...
   <div class="input-group">
         <asp:DropDownList ID="dd_terma" runat="server"  Width="100%" class="form-control select2">
                                                                                      <asp:ListItem Value="">--- PILIH ---</asp:ListItem>
                                                                ...
                                                                <div class="box-body">&nbsp;</div>
                                                                    ...
                                                                    <div class="row">
                                                                         <div class="col-md-12">
                                                                                <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label">Perkara <span class="style1">*</span></label>
                                                                                <div class="col-sm-8">
                                                                                     <div class="input-group">
                                                                                  <asp:TextBox ID="TextBox16" runat="server" class="form-control uppercase validate[optional]"></asp:TextBox> 
                                                                                           <span class="input-group-addon"><i class="fa fa-edit"></i></span>
                                             </div>
                                                                 ...
                                                                 <div class="row" style="display:none;">
                                                                        ...
                                                                        <div class="col-md-6 box-body">
                                                                            ...
                                                                            <div id="mak_dok_shw" runat="server" Visible="false">
                                                                         <fieldset class="col-md-12">
                                                                     <legend style="width:12%">Maklumat Dokumen</legend>                                                                     
                                                                    
                                                                    <div class="row">
                                                                         <div class="col-md-12">
                                                                        <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label">Tarikh Dokumen </label>
                                                                                <div class="col-sm-8">
                                                                                  <div class="input-group">
                                                                        ...
                                                                        <div class="col-md-6 box-body">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                  <asp:TextBox ID="TextBox14" runat="server" class="form-control validate[optional]"></asp:TextBox> 
                                                                       ...
                                                                       <div class="box-body">&nbsp;</div>
                                                                     <div class="box-header with-border">
                            <h3 class="box-title">Butiran Mohon Bayar</h3>
                        </div>
                                                                       <div class="dataTables_wrapper form-inline dt-bootstrap" >
                                      <div class="row" style="overflow:auto;">
           <div class="col-md-12 box-body">
          <asp:gridview ID="grdmohon" runat="server"  class="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="20" ShowFooter="true" GridLines="None" OnRowDeleting="Mohon_grvStudentDetails_RowDeleting" onrowdatabound="grdmohon_RowDataBound" >
            ...
            <asp:TemplateField HeaderText="Bayar Kepada" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    <asp:DropDownList ID="TextBox11" runat="server" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="bind_bank_details" class="form-control uppercase select2"></asp:DropDownList>
                </ItemTemplate>
                 <FooterTemplate>
                ...
                <ItemTemplate>
                  ...
                  <asp:TemplateField HeaderText="Projek" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    <asp:DropDownList ID="dd_projek" class="form-control uppercase select2" Width="100%" runat="server"></asp:DropDownList>
                </ItemTemplate>
            </asp:TemplateField>
                   <asp:TemplateField HeaderText="Nama Bank" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    <asp:DropDownList ID="dd_bank" class="form-control uppercase select2" Width="100%"  runat="server"></asp:DropDownList>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="No Akaun Bank" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    <asp:TextBox ID="TextBox12" class="form-control uppercase" Width="100%" MaxLength="20" runat="server"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
            
             <asp:TemplateField HeaderText="Jumlah Kecil (RM)" ItemStyle-Width="8%" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
             ...
             <asp:TemplateField HeaderText="Kuantiti" ItemStyle-Width="10%" Visible="false" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                 ...
                 <asp:TemplateField HeaderText="Disk (RM)" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <asp:TextBox ID="Txtdis" runat="server"  CssClass="form-control"  Width="70px"  placeholder="0.00" style="text-align:right;"  OnTextChanged="Mohon_disChangedBil" AutoPostBack="true"   ></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
             <asp:TemplateField HeaderText="Jumlah (RM)" Visible="false" ItemStyle-HorizontalAlign="right">
                <ItemTemplate>
           ...
           <FooterTemplate>
            ...
            <asp:TemplateField HeaderText="Jenis Cukai %" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
                ...
                <FooterTemplate>
                 ...
                 <asp:TemplateField HeaderText="Amaun (RM)" ItemStyle-HorizontalAlign="right">
                <ItemTemplate>
...
<br>
          ...
          <%--  <asp:BoundField DataField="kepada" HeaderText="Bayar Kepada" ItemStyle-HorizontalAlign="Center" />--%>
            ...
            <asp:BoundField DataField="Keteragan" HeaderText="Keterangan" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
             <asp:BoundField DataField="projek" HeaderText="Projek" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
...
<asp:BoundField DataField="acc_no" HeaderText="No Akaun Bank" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
             <asp:BoundField DataField="jumlah" HeaderText="Jumlah Kecil (RM)" HeaderStyle-HorizontalAlign="Right" DataFormatString="{0:n}" ItemStyle-HorizontalAlign="Right" />
...
<asp:BoundField DataField="amount" HeaderText="Amaun (RM)" HeaderStyle-HorizontalAlign="Right" DataFormatString="{0:n}" ItemStyle-HorizontalAlign="Right" />
           ...
           <FooterStyle BackColor="#BDC4C7" Font-Bold="True" ForeColor="black" />
                ...
                <div class="row">
                                                                       ...
                                                                       <div class="col-md-6 box-body">&nbsp;</div>
                                                                        ...
                                                                        <%--   <div class="box-body">&nbsp;</div>--%>
                                                 <div id="sts" runat="server" visible="false" style="pointer-events:none;">
                                                                              <fieldset class="col-md-12">
                                                                     <legend style="width:7%">Semakan</legend> 
                                                                                   <div class="row">
                                                                         <div class="col-md-12">
                                                                        <div class="col-md-6 box-body">
                                                                            <div class="form-group" style="display:none;">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label">Akaun Syarikat </label>
                                                                                <div class="col-sm-8">
                                                                             ...
                                                                             <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label">Status Mohon Bayar </label>
                                                                                <div class="col-sm-8">
                                                                                ...
                                                                                <asp:ListItem Value="">--- PILIH ---</asp:ListItem>
                                                                                     ...
                                                                                     <asp:ListItem Value="T">Tidak Lulus</asp:ListItem>
                                                                                       <asp:ListItem Value="P">Tangguh</asp:ListItem>
                                                                                </asp:DropDownList>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                   <asp:TextBox ID="TextBox29" runat="server" class="form-control uppercase" TextMode="MultiLine" Height="70px"></asp:TextBox> 
                                                                   ...
                                                                   <div class="row">
                                                                                 <div class="col-md-12" style="text-align:center;">
                                                                                   ...
                                                                                   OnClientClick="if (!confirm('Adakah Anda pasti?')) return false;" onclick="Button2_Click" 
                                                                                    />
                                                                                    <asp:Button ID="kem_Button2" Visible="false" runat="server" class="btn btn-danger" Text="Kemaskini" Type="submit" onclick="btnkem_Click" />

                                                                                  <asp:Button ID="btnprintmoh" runat="server" class="btn btn-warning" Text="Cetak" Type="submit"
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-12 box-body" style="text-align:center;">
                               ...
                               <asp:TextBox ID="pel_lbl_name" runat="server" class="form-control validate[optional] uppercase" Visible="false"></asp:TextBox>
                                ...
                                <asp:Button ID="Button23" runat="server" class="btn btn-default" Text="Kembali" UseSubmitBehavior="false" OnClick="pel_Click_bck" />
