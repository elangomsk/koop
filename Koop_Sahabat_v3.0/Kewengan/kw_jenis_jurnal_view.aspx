<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master"  CodeFile="../Kewengan/kw_jenis_jurnal_view.aspx.cs" Inherits="kw_jenis_jurnal_view" %>
                ...
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Jenis Jurnal</li>
                        </ol>
                    </section>
                                   ...
                                   <asp:GridView ID="gv_refdata" runat="server" CssClass="table table-bordered table-hover dataTable uppercase"  AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="1000000">
                                                       <%-- <HeaderStyle ForeColor="#ffffff" />--%>
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="JENIS KOD">
                                                                <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnkView" runat="server" OnClick="lnkView_Click" Font-Bold Font-Underline>
                                                                    <asp:Label ID="Label3" runat="server" Text='<%# Eval("jur_type_cd") %>' CssClass="uppercase"></asp:Label>
                                                                        </asp:LinkButton>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="JENIS JURNAL">
                                                                <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="Jenis_nam" runat="server" Text='<%# Eval("jur_desc") %>' CssClass="uppercase"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="JENIS ITEM">
                                                                <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="Jenis_item" runat="server" Text='<%# Eval("item") %>' CssClass="uppercase"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
