<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_pelanggan_view.aspx.cs" Inherits="kw_pelanggan_view" %>
                ...
                <div class="col-md-12">
                     <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><asp:Label ID="hd_txt" Visible="false" runat="server"></asp:Label>Debtor Pelanggan</h3>
                             <div class="type-1 ">
                              <div class="type-in">
                                ...
                                <div class="form-group">
                                     <div class="col-sm-12" style="text-align:right;">
                                        <%--<asp:Button ID="button4" runat="server" Text="Carian"  class="align-center btn btn-primary" UseSubmitBehavior="false" OnClick="btn_search_Click"></asp:Button>--%>
                                         ...
                                         <%--  <div class="type-1 ">
                              <div class="type-in">
                                <a href="../Kewengan/Fin_module.aspx?edit=P0201" title="Debtor" class="btn btn-1">
                                  <span class="txt">Close</span>
                                  <span class="round"><i class="fa fa-times"></i></span>
                                </a>
                              </div>
                                                        ...
                                                        <asp:TemplateField HeaderText="NAMA SYARIKAT">
                                                           <ItemStyle HorizontalAlign="Left" Width="15%"></ItemStyle>
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lbl1" runat="server" Text='<%# Eval("Ref_nama_syarikat") %>'></asp:Label>
                                                                      <asp:Label ID="lbl_id" Visible="false" runat="server" Text='<%# Bind("Id") %>' CssClass="uppercase"></asp:Label>
                                                                      </asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="ALAMAT EMAIL">
                                                            <ItemStyle HorizontalAlign="Left" Width="15%"></ItemStyle>
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl2" runat="server" Text='<%# Eval("Ref_email") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="NOMBOR TELEFON">
                                                            <ItemStyle HorizontalAlign="center" Width="15%"></ItemStyle>
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl3" runat="server" Text='<%# Eval("Ref_no_telefone") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField> 
