...
public partial class kw_Kelulusan_Kewangan : System.Web.UI.Page
{
        ...
        if (txtnoper.Text != "")
        {
            if (txttarkihmo.Text != "")
            {
                ...
                if (ddsts.SelectedValue != "")
                {
                    ...
                    if (DropDownList6.SelectedValue == "L")
                    {
                        semsts = ddsts.SelectedValue;
                    }
                    else if (DropDownList6.SelectedValue == "T")
                    {
                        semsts = ddsts.SelectedValue;
                    }
                    else
                    ...
                    {
                        Inssql_main = "update KW_Pembayaran_mohon  set kel_nota='"+ txt_nota.Text +"',lulus_id='" + userid + "',lulus_dt='" + DateTime.Now.ToString("yyyy-MM-dd") + "',lulus_sts='" + semsts + "',upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy-MM-dd hh: mm:ss") + "' where no_permohonan='" + txtnoper.Text + "' and Status='A'";
                    }
                    else if (TextBox16.Text == "01")
                    {
                        Inssql_main = "update KW_Pembayaran_invois  set kel_nota='" + txt_nota.Text + "',lulus_id='" + userid + "',lulus_dt='" + DateTime.Now.ToString("yyyy-MM-dd") + "',lulus_sts='" + semsts + "',upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy-MM-dd hh: mm:ss") + "' where no_invois='" + txtnoper.Text + "' and Status='A'";
                    }
                    else if (TextBox16.Text == "05")
                    {
                        Inssql_main = "update KW_Pembayaran_Credit  set kel_nota='" + txt_nota.Text + "',lulus_id='" + userid + "',lulus_dt='" + DateTime.Now.ToString("yyyy-MM-dd") + "',lulus_sts='" + semsts + "',upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy-MM-dd hh: mm:ss") + "' where no_Rujukan='" + txtnoper.Text + "' and Status='A'";                        
                    }
                    else if (TextBox16.Text == "06")
                    {
                        Inssql_main = "update KW_Pembayaran_Dedit  set kel_nota='" + txt_nota.Text + "',lulus_id='" + userid + "',lulus_dt='" + DateTime.Now.ToString("yyyy-MM-dd") + "',lulus_sts='" + semsts + "',upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy-MM-dd hh: mm:ss") + "' where no_Rujukan='" + txtnoper.Text + "' and Status='A'";
                    }
                    else if (TextBox16.Text == "09")
                    {
                        Inssql_main = "update kw_penerimaan_invois  set kel_nota='" + txt_nota.Text + "',lulus_id='" + userid + "',lulus_dt='" + DateTime.Now.ToString("yyyy-MM-dd") + "',lulus_sts='" + semsts + "',upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy-MM-dd hh: mm:ss") + "' where no_invois='" + txtnoper.Text + "' and Status='A'";
                    }
                    else if (TextBox16.Text == "10")
                    {
                        Inssql_main = "update KW_Penerimaan_Credit  set kel_nota='" + txt_nota.Text + "',lulus_id='" + userid + "',lulus_dt='" + DateTime.Now.ToString("yyyy-MM-dd") + "',lulus_sts='" + semsts + "',upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy-MM-dd hh: mm:ss") + "' where no_notakredit='" + txtnoper.Text + "' and Status='A'";                        
                    }
                    else if (TextBox16.Text == "11")
                    {
                        Inssql_main = "update KW_Penerimaan_Debit  set kel_nota='" + txt_nota.Text + "',lulus_id='" + userid + "',lulus_dt='" + DateTime.Now.ToString("yyyy-MM-dd") + "',lulus_sts='" + semsts + "',upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy-MM-dd hh: mm:ss") + "' where no_notadebit='" + txtnoper.Text + "' and Status='A'";                        
                    }
                    else
                    {
                        Inssql_main = "update KW_jurnal_inter  set kel_nota='" + txt_nota.Text + "',lulus_id='" + userid + "',lulus_dt='" + DateTime.Now.ToString("yyyy-MM-dd") + "',lulus_sts='" + semsts + "',upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy-MM-dd hh: mm:ss") + "' where no_permohonan='" + txtnoper.Text + "' and Status='A'";                        
                    }
                    Status = DBCon.Ora_Execute_CommamdText(Inssql_main);
                    double ss1 = 0;
                    if (Status == "SUCCESS")
                    {
                        ...
                        {
                            string bajet_cd = (g1.FindControl("dd_bajet") as DropDownList).SelectedValue;
                            string bajet_amn = (g1.FindControl("jumlah") as Label).Text;

                            DataTable get_bjt = new DataTable();
                            get_bjt = Dbcon.Ora_Execute_table("select a.ubjt,a.ref_bjt_year from (select case when ISNULL(ref_shadow_bajet,'0.00') ='' then '0.00' else ISNULL(ref_shadow_bajet,'0.00') end as ubjt,ref_bjt_year from KW_Ref_Bajet where  Ref_kod_bajet='" + bajet_cd +"' and Status='A' ) as a outer apply(select fin_year from KW_financial_Year where Status='1') as b where a.ref_bjt_year=b.fin_year ");
                            ...
                            if (get_bjt.Rows.Count != 0)
                            {
                                ...
                                if (bajet_amn != "0.00")
                                {
                                    ss1 = double.Parse(get_bjt.Rows[0]["ubjt"].ToString()) + double.Parse(bajet_amn);
                                }
                               
                                string upd_bjt = "Update KW_Ref_Bajet SET ref_shadow_bajet='" + ss1 + "' where Ref_kod_bajet='" + bajet_cd + "' and ref_bjt_year='"+ get_bjt.Rows[0]["ref_bjt_year"].ToString() + "' and Status='A'";
                                Status = Dbcon.Ora_Execute_CommamdText(upd_bjt);
                            }
                        ...
                        reset();
                        tab1();
                        ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "$.Zebra_Dialog('Kelulusan Kewangan Berjaya Dikemaskini.',{'type': 'confirmation','title': 'Success','auto_close': 2000});", true);
                    }
                }
                else
                {
    ...
    void lod_bajet()
    {
        ...
        DataTable dt1 = new DataTable();
        dt1 = Dbcon.Ora_Execute_table("SELECT nama_bajet, Ref_jumlah_bajet,isnull(cast(Ref_used_bajet as money),'0.00') Ref_used_bajet, sum(isnull(cast(Ref_jumlah_bajet as money),'0.00') - isnull(cast(Ref_used_bajet as money),'0.00')) as baki FROM KW_Ref_kod_bajet as table1 LEFT JOIN  KW_Ref_Bajet as table2 ON table1. kod_bajet = table2.Ref_kod_bajet WHERE kod_bajet IN ('" + Session["bajt_det_cd"].ToString().Replace(",","','") + "') and '" + DateTime.Now.ToString("yyyy-MM-dd") + "' BETWEEN Ref_tk_mula AND Ref_tk_akhir group by nama_bajet, Ref_jumlah_bajet, Ref_used_bajet");
    ...
    protected void lblSubbind_Click(object sender, EventArgs e)
    {
        ...
        {
            dt = Dbcon.Ora_Execute_table("select kel_nota,kod_bajet,no_invois as no_permohonan,perkara Catatan,id_profile_syarikat,semak_sts,lulus_sts,semak_id,Format(semak_dt,'dd/MM/yyyy') semakdt,'' ID_pemohon,PO_no,DO_no, Overall jumlah,Format(tarikh_invois,'dd/MM/yyyy') as tk_invois, Format(tarkih_mohon,'dd/MM/yyyy') as tk_mohon,'' Jenis_permohonan,PO_no as no_ruj,cara_bayaran,kat_penerima,Terma from KW_Pembayaran_invois where no_invois='" + CommandArgument1 + "' and Status='A'");
        }
        else if (CommadArgument[1] == "03")
        {
            dt = Dbcon.Ora_Execute_table("select kel_nota,kod_bajet,no_permohonan,perkara as Catatan,id_profile_syarikat,semak_sts,lulus_sts,semak_id,Format(semak_dt,'dd/MM/yyyy') semakdt,ID_pemohon,PO_no,DO_no,jumlah,Format(tarkih_invois,'dd/MM/yyyy') as tk_invois,Format(tarkih_permohonan,'dd/MM/yyyy') as tk_mohon,Jenis_permohonan,no_ruj,cara_bayaran,kat_penerima,Terma from KW_Pembayaran_mohon where no_permohonan='" + CommandArgument1 + "' and Status='A'");
        }
        else if (CommadArgument[1] == "05")
        {
            dt = Dbcon.Ora_Execute_table("select kel_nota,'' kod_bajet,'' PO_no,'' DO_no,'' no_ruj,'' Jenis_permohonan,'' cara_bayaran,'' ID_pemohon,no_Rujukan no_permohonan,perkera Catatan,id_profile_syarikat,semak_sts,lulus_sts,semak_id,Format(semak_dt,'dd/MM/yyyy') semakdt,overall as jumlah,'' as tk_invois,Format(tarkih_mohon,'dd/MM/yyyy') as tk_mohon,'02' kat_penerima,Terma from KW_Pembayaran_Credit where no_Rujukan='" + CommandArgument1 + "' and Status='A'");
        }
        ...
        {
            dt = Dbcon.Ora_Execute_table("select kel_nota,'' kod_bajet,no_invois as no_permohonan,perkera Catatan,id_profile_syarikat,semak_sts,lulus_sts,semak_id,Format(semak_dt,'dd/MM/yyyy') semakdt,'' ID_pemohon,PO_no,DO_no, Overall jumlah,Format(tarikh_invois,'dd/MM/yyyy') as tk_invois, Format(tarikh_invois,'dd/MM/yyyy') as tk_mohon,'' Jenis_permohonan,PO_no as no_ruj,'' cara_bayaran,'03' kat_penerima,Terma from kw_penerimaan_invois where no_invois='" + CommandArgument1 + "' and Status='A'");
        }
        else if (CommadArgument[1] == "10")
        {
            dt = Dbcon.Ora_Execute_table("select kel_nota,'' kod_bajet,'' PO_no,'' DO_no,'' no_ruj,'' Jenis_permohonan,'' cara_bayaran,'' ID_pemohon,no_notakredit no_permohonan,perkara Catatan,id_profile_syarikat,semak_sts,lulus_sts,semak_id,Format(semak_dt,'dd/MM/yyyy') semakdt,overall as jumlah,'' as tk_invois,Format(tarikh_kredit,'dd/MM/yyyy') as tk_mohon,'03' kat_penerima,Terma from KW_Penerimaan_Credit where no_notakredit='" + CommandArgument1 + "' and Status='A'");
        }
        else if (CommadArgument[1] == "11")
        {
            dt = Dbcon.Ora_Execute_table("select kel_nota,'' kod_bajet,'' PO_no,'' DO_no,'' no_ruj,'' Jenis_permohonan,'' cara_bayaran,'' ID_pemohon,no_notadebit no_permohonan,perkara Catatan,id_profile_syarikat,semak_sts,lulus_sts,semak_id,Format(semak_dt,'dd/MM/yyyy') semakdt,overall as jumlah,'' as tk_invois,Format(tarikh_debit,'dd/MM/yyyy') as tk_mohon,'03' kat_penerima,Terma from KW_Penerimaan_Debit where no_notadebit='" + CommandArgument1 + "' and Status='A'");
        }
        else
        {
            dt = Dbcon.Ora_Execute_table("select kel_nota,'' kod_bajet,'' PO_no,'' DO_no,no_Rujukan no_ruj,'' Jenis_permohonan,'' cara_bayaran,'' ID_pemohon,no_permohonan,perkara Catatan,id_profile_syarikat,semak_sts,lulus_sts,semak_id,Format(semak_dt,'dd/MM/yyyy') semakdt,overall as jumlah,'' as tk_invois,Format(tarikh_lulus,'dd/MM/yyyy') as tk_mohon,'03' kat_penerima,Terma from KW_jurnal_inter where no_permohonan='" + CommandArgument1 + "' and Status='A'");
        }
        //tab1();
        if (dt.Rows.Count != 0)
        {
            ...
            {
                kem_Button2.Visible = false;
                DropDownList6.SelectedValue = dt.Rows[0]["lulus_sts"].ToString();
            ...
            txt_nota.Text = dt.Rows[0]["kel_nota"].ToString();
            ...
            {
                query1 = "select kod_bajet kod_bajet,s1.Id,m1.nama_pelanggan_code as kepada,Keterangan as Keteragan,'' as projek,'' as bank,'' as acc_no,s1.overall as jumlah, '' as Disk "
    ...
    {
        Response.Redirect("../kewengan/kw_Kelulusan_Kewangan.aspx");
    }
    ...
    protected void BindMohon()
    {
        ...
        string gt_kat = string.Empty;
        DataTable ddokdicno_1 = new DataTable();
        ddokdicno_1 = DBCon.Ora_Execute_table("select m1.kel_kategory,s1.ctrl_type from KK_Role_skrins m1 left join KK_PID_Kumpulan s1 on s1.KK_kumpulan_id=Role_id  where psub_skrin_id='P0024' and Role_id IN ('" + ddokdicno.Rows[0]["KK_roles"].ToString().Replace(",", "','") + "') order by Role_id");

        if(Session["userid"].ToString() != "admin")
        {
            gt_kat = "and a.kel_kat='" + ddokdicno_1.Rows[0]["kel_kategory"].ToString() + "'";
        }
        else
        {
            gt_kat = "";
        ...
        {
            condtion = "where a.v1 >=DATEADD(day, DATEDIFF(day, 0, '"+ fmdate + "'), 0) and a.v1<=DATEADD(day, DATEDIFF(day, 0, '" + tmdate + "'), +0) and a.jen_txi='"+ jenis_trxn.SelectedValue + "' and a.lul_sts_cd='" + DropDownList4.SelectedValue + "'";
        }
        else if (TextBox15.Text != "" && txttarikhinvois.Text != "" && jenis_trxn.SelectedValue == "" && DropDownList4.SelectedValue != "")
        {
            condtion = "where a.v1 >=DATEADD(day, DATEDIFF(day, 0, '" + fmdate + "'), 0) and a.v1<=DATEADD(day, DATEDIFF(day, 0, '" + tmdate + "'), +0) and a.lul_sts_cd='" + DropDownList4.SelectedValue + "'";
        }
        else if (TextBox15.Text != "" && txttarikhinvois.Text != "" && jenis_trxn.SelectedValue == "" && DropDownList4.SelectedValue == "")
        {
        ...
        {
            condtion = "where a.jen_txi='" + jenis_trxn.SelectedValue + "' and a.lul_sts_cd='" + DropDownList4.SelectedValue + "'";
        }
        else if (TextBox15.Text == "" && txttarikhinvois.Text == "" && jenis_trxn.SelectedValue != "" && DropDownList4.SelectedValue == "")
        {
            condtion = "where a.jen_txi='" + jenis_trxn.SelectedValue + "' and a.lul_sts_cd='" + DropDownList4.SelectedValue + "'";
