<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_bajet_view.aspx.cs" Inherits="kw_bajet_view" %>
                                            ...
                                            <ItemTemplate>  
                                                <asp:Label ID="lblRowNumber" Text='<%# Container.DataItemIndex + 1 %>' runat="server" ItemStyle-Width="3%"/> 
                                                         ...
                                                         <asp:TemplateField HeaderText="KUMPULAN">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl2_kump" runat="server" Text='<%# Eval("kump") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="KOD BAJET">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lbl1" runat="server" Text='<%# Eval("Ref_kat_bajet") %>'></asp:Label>
                                                                       <asp:Label ID="lbl_id" Visible="false" runat="server" Text='<%# Bind("baj_sq_no") %>' CssClass="uppercase"></asp:Label>
                                                                      </asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Tarikh Mula">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl2" runat="server" Text='<%# Eval("Ref_tk_mula") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Tarikh Akhir">
                                                                <ItemStyle HorizontalAlign="center" Width="10%"></ItemStyle>
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl2_1" runat="server" Text='<%# Eval("Ref_tk_akhir") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Jumlah Bajet (RM)" HeaderStyle-HorizontalAlign="Right">
                                                             <ItemStyle HorizontalAlign="right" Width="10%"></ItemStyle>
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl3" runat="server" Text='<%# "RM " + Eval("Ref_jumlah_bajet") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>  
