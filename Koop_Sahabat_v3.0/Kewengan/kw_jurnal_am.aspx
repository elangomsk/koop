<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_jurnal_am.aspx.cs" Inherits="kw_jurnal_am" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
        ...
        function ValidateEmail(button) {
            ...
            var lbl_amt1 = GetChildControl(row, "Col4").value.replace(",","");
            var lbl_amt2 = GetChildControl(row, "Col5").value.replace(",", "");
            var vv_amt1;
            var vv_amt2;
            if (lbl_amt1 != "")
            {
            ...
            $(".txtAmount_bk").each(function () {
               ...
               // if ($(this).val() != '') {
                ...
                GetChildControl(row, "Col4").value = addCommas(parseFloat(vv_amt1).toFixed(2));
                GetChildControl(row, "Col5").value = "";
            ...
            $(".txtAmount_bk1").each(function () {
                ...
                GetChildControl(row, "Col5").value = addCommas(parseFloat(vv_amt2).toFixed(2));
                //}
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><asp:Label ID="ps_lbl4" Visible="false" runat="server"></asp:Label>Maklumat Jurnal AM</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label"><asp:Label ID="ps_lbl5" Visible="false" runat="server"></asp:Label>No Jurnal <span class="style1">*</span></label>
                                    <div class="col-sm-8">
                                         <div class="input-group">
                                      <asp:TextBox ID="TextBox1" runat="server" class="form-control validate[optional] uppercase" MaxLength="15"></asp:TextBox>
                                             <asp:TextBox ID="TextBox3" runat="server" class="form-control validate[optional] uppercase" Visible="false" MaxLength="15"></asp:TextBox>
                                   ...
                                   <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label"> GL No <span class="style1">*</span></label>
                                    <div class="col-sm-8">
                                          <div class="input-group">
                                     <asp:TextBox ID="TextBox5" runat="server" class="form-control validate[optional] uppercase" ReadOnly="true" MaxLength="500"></asp:TextBox>
                                                <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                             </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label"><asp:Label ID="ps_lbl7" Visible="false" runat="server"></asp:Label> Tarikh Jurnal <span class="style1">*</span></label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                 ...
                                 <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label"><asp:Label ID="ps_lbl6" Visible="false" runat="server"></asp:Label> Perkara </label>
                                    <div class="col-sm-8">
                                          <div class="input-group">
                                   ...
                                   <asp:GridView ID="grvStudentDetails" runat="server" class="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" ShowFooter="True" AllowPaging="true" GridLines="None" PageSize="20" onrowdatabound="gvEmp_RowDataBound" OnRowDeleting="grvStudentDetails_RowDeleting">
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="KOD AKAUN">
                                                                ...
                                                                <FooterTemplate>
                                                                    <asp:Button ID="ButtonAdd" runat="server" Text="Tambah Baru" style="width:100%;" CssClass="btn btn-success" OnClick="ButtonAdd_Click" />
                                                                </FooterTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="KETERANGAN">
                                                                <ItemTemplate>
                                                                   <asp:TextBox ID="Col2" CssClass="form-control uppercase" runat="server" Text='<%# Eval("column2") %>'></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                              <asp:TemplateField HeaderText="Projek">
                                                                 <ItemStyle HorizontalAlign="Left" Width="20%"></ItemStyle>
                                                                <ItemTemplate>
                                                                    <asp:DropDownList ID="Col3" style="width:100%; font-size:13px;" runat="server" CssClass="form-control select2 validate[optional]"></asp:DropDownList>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="DEBIT (RM)">
                                                                <ItemStyle HorizontalAlign="Right" />
                                                                <ItemTemplate>
                                                                   <asp:TextBox ID="Col4" style="text-align:right;" CssClass="form-control txtAmount_bk" placeholder="0.00" Text='<%# Eval("column4","{0:n}") %>' OnTextChanged="QtyChanged_deb" AutoPostBack="true" onblur="ValidateEmail(this)" runat="server"></asp:TextBox>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="KREDIT (RM)">
                                                                <ItemStyle HorizontalAlign="Right" />
                                                                <ItemTemplate>
                                                                   <asp:TextBox ID="Col5" style="text-align:right;" CssClass="form-control txtAmount_bk1" placeholder="0.00" Text='<%# Eval("column5","{0:n}") %>' OnTextChanged="QtyChanged_kre" AutoPostBack="true" onblur="ValidateEmail(this)" runat="server"></asp:TextBox>
                                                                </ItemTemplate>
                                                                <FooterStyle HorizontalAlign="Right" />
                                                                 <FooterTemplate>
