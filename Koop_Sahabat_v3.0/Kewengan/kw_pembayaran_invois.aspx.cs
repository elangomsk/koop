...
public partial class kw_pembayaran_invois : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        //{
            ...
            if (txtnoper.Text != "")
            {
                if (txttarkihmo.Text != "" && DropDownList2.SelectedValue != "" && DropDownList1.SelectedValue != "" && TextBox7.Text != "" && TextBox16.Text != "")
                {
                ...
                userid = Session["New"].ToString();
                                        ...
                                        gen_invkd = Dbcon.Ora_Execute_table("select no_invois from KW_Pembayaran_invois where no_invois='" + txtnoper.Text + "'");
                if (gen_invkd.Rows.Count == 0)
                {
                    //DataTable dtmb_db1 = Dbcon.Ora_Execute_table("select doc_type_cd,format as fmt,SUBSTRING(cur_format, 1, 12) as lfrmt1,SUBSTRING(cur_format, 13, 4) as lfrmt2,cur_format as cfmt from KW_Format_Nombor_rujukan where doc_type_cd='03' and Status='A'");
                    ...
                    //else
                    //{
                    //    DataTable dtmb_db2 = Dbcon.Ora_Execute_table("select   ISNULL(max(SUBSTRING(no_invois,13,3000)),'0') from KW_Pembayaran_invois");
                    //    if (dtmb_db2.Rows.Count > 0)
                    //    {
                    //        int seqno = Convert.ToInt32(dtmb_db2.Rows[0][0].ToString());
                    //        int newNumber = seqno + 1;
                    //        uniqueId = newNumber.ToString("KS-INV" + " - " + DateTime.Now.ToString("yyyy") + " - " + "0000");
                    //        txtnoper_1.Text = uniqueId;                                                    
                    ...
                    //        uniqueId = newNumber.ToString("KS-INV" + " - " + DateTime.Now.ToString("yy") + " - " + "0000");
                    //        txtnoper_1.Text = uniqueId;                                                    
                    //    }
                    //}
                    ...
                    string Inssql_main = "insert into KW_Pembayaran_invois (tarkih_mohon,kat_penerima,tarikh_invois,Bayar_kepada,no_invois,project_kod,Cara_Bayaran,Terma,PO_no,DO_no,Overall,crt_id,cr_dt,Status,id_profile_syarikat,perkara) values('" + tDate.ToString("yyyy-MM-dd") + "','" + DropDownList1.SelectedValue + "','" + doc_dt + "','" + dd_kepada.SelectedValue + "','" + txtnoper_1.Text + "','" + ddbkepada.SelectedValue + "','" + DropDownList2.SelectedValue + "','" + dd_terma.SelectedValue + "','" + TextBox9.Text + "','" + TextBox14.Text + "','" + TextBox17.Text + "','" + userid + "','" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "','A','" + DropDownList3.SelectedValue + "','"+ TextBox16.Text +"')";
                    ...
                    if (Status == "SUCCESS")
                    {
                        ...
                        foreach (GridViewRow g1 in grdmohon.Rows)
                        {
                            ...
                            string Inssql = "insert into KW_Pembayaran_invoisBil_item (no_invois,keterangan,inv_bank,nv_noacc_bank,unit,quantiti,jumlah,discount,tax,gstjumlah,Overall,crt_id,cr_dt,Status) values('" + txtnoper_1.Text + "','" + ket + "','" + bank + "','" + no_akaun + "','" + unit + "','" + c_qty + "','" + jum + "','" + disk + "','" + jen_cukai + "','" + cukai_amt + "','" + overall + "','" + userid + "','" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "','A')";
                            Status = Dbcon.Ora_Execute_CommamdText(Inssql);
                        }
                ...
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "$.Zebra_Dialog('Kreditor No Invois Already Exist.',{'type': 'warning','title': 'warning','auto_close': 2000});", true);
                }
    ...
    protected void btnkem_Click(object sender, EventArgs e)
    {
        if (txtnoper.Text != "")
        {
            if (txttarkihmo.Text != "" && DropDownList2.SelectedValue != "" && DropDownList1.SelectedValue != "" && TextBox7.Text != "")
            {
                string doc_dt = string.Empty;
                DateTime tDate = DateTime.ParseExact(txttarkihmo.Text, "dd/MM/yyyy", null);
                if (TextBox7.Text != "")
                ...
                userid = Session["New"].ToString();
                DataTable dt = new DataTable();
                string Inssql_main = "update KW_Pembayaran_invois  set id_profile_syarikat='"+ DropDownList3.SelectedValue +"',tarkih_mohon='" + tDate.ToString("yyyy-MM-dd") + "',Terma='" + dd_terma.SelectedValue + "',cara_bayaran='" + DropDownList2.SelectedValue + "',kat_penerima='" + DropDownList1.SelectedValue + "',tarikh_invois='" + doc_dt + "',PO_no='" + TextBox9.Text + "',DO_no='" + TextBox14.Text + "',project_kod='"+ ddbkepada.SelectedValue + "',upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy / MM / dd hh: mm:ss") + "' where no_invois='" + txtnoper.Text + "'";
                Status = DBCon.Ora_Execute_CommamdText(Inssql_main);
                if (Status == "SUCCESS")
                {
                    BindMohon();
                    ...
                    reset();
                    tab1();
                    ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "$.Zebra_Dialog('Invois Berjaya Dikemaskini.',{'type': 'confirmation','title': 'Success','auto_close': 2000});", true);
                }
    ...
    protected void lblSubbind_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = new DataTable();
        dt = Dbcon.Ora_Execute_table("select semak_sts,no_invois,perkara,id_profile_syarikat,project_kod,bayar_kepada,Status,PO_no,DO_no,Overall as jumlah,Format(tarikh_invois,'dd/MM/yyyy') as tk_invois,Format(tarkih_mohon,'dd/MM/yyyy') as tk_mohon,cara_bayaran,kat_penerima,Terma from KW_Pembayaran_invois where no_invois='" + CommandArgument1 +"' and Status='A'");
        //tab1();
        if (dt.Rows.Count != 0)
        {
           ...
           TextBox7.Text = dt.Rows[0]["tk_invois"].ToString();
            ...
            //get_sum_item = Dbcon.Ora_Execute_table("select sum(Overall) amt from KW_Pembayaran_invoisBil_item where no_invois='" + CommandArgument1 + "' and Status='A'");
            ...
            query1 = "select UPPER(keterangan) as Keteragan,s3.Bank_Name as bank,s1.nv_noacc_bank as acc_no,unit as jumlah, discount as Disk,s1.quantiti as qty, "
                           + " UPPER(ISNULL(s4.Ref_nama_cukai,'')) as jen_cukai, s1.gstjumlah as cukai_amt, s1.Overall as amount,s1.jumlah as tot  from KW_Pembayaran_invoisBil_item s1  "
                           + " left join Ref_Nama_Bank s3 on s3.Bank_Code=s1.inv_bank  "
                           + " left join KW_Ref_Tetapan_cukai s4 on s4.Ref_kod_cukai=s1.tax where no_invois='"+ CommandArgument1 +"' and s1.Status='A'";
    ...
    protected void BindMohon()
    {
       ...
       //if (txtnoinvois.Text != "" && txttarikhinvois.Text == "" && TextBox13.Text == "")
       // {
       //     qry1 = "select Format(tarkih_permohonan,'dd/MM/yyyy')tarkih_permohonan,no_permohonan,b.mhn_byr_kepada as  Bayar_kepada,a.jumlah as  jumlah,CASE ISNULL(a.semak_sts,'')  WHEN '' THEN 'WAITING'  WHEN 'P' THEN 'PROSES' WHEN 'SA' THEN 'SAH' END  as status,a.no_ruj,b.mhn_keterangan  from KW_Pembayaran_mohon a OUTER APPLY (select top(1)* from KW_Pembayaran_mohon_item s2 where s2.Status='A' and s2.mhn_no_permohonan=a.no_permohonan order by cr_dt asc) as b where a.Status='A'";
       // }
       ...
       // }
        ...
        qry1 = "select kat_penerima,Format(tarkih_mohon,'dd/MM/yyyy') tarkih_permohonan,a.no_invois,Bayar_kepada as  Bayar_kepada,a.Overall as  jumlah,CASE ISNULL(a.semak_sts,'')  WHEN '' THEN 'WAITING'  WHEN 'P' THEN 'PROSES' WHEN 'L' THEN 'LULUS' END  as status,ISNULL(lulus_sts,'') lul_sts_cd,CASE ISNULL(lulus_sts,'')  WHEN '' THEN 'WAITING'  WHEN 'P' THEN 'PROSES' WHEN 'L' THEN 'LULUS' END  as lul_status,a.po_no,perkara keterangan  from KW_Pembayaran_invois a OUTER APPLY (select top(1)* from KW_Pembayaran_invoisBil_item s2 where s2.Status='A' and s2.no_invois=a.no_invois order by cr_dt asc) as b  where a.Status='A'";
    ...
    {
        //DataTable dt1 = Dbcon.Ora_Execute_table("select doc_type_cd,format as fmt,SUBSTRING(cur_format, 1, 12) as lfrmt1,SUBSTRING(cur_format, 13, 4) as lfrmt2,cur_format as cfmt from KW_Format_Nombor_rujukan where doc_type_cd='01' and Status='A'");
        //if (dt1.Rows.Count != 0)
        //{
        //    if (dt1.Rows[0]["cfmt"].ToString() == "")
        //    {
        ...
        //else
        //{
        //    DataTable dt = Dbcon.Ora_Execute_table("select   ISNULL(max(SUBSTRING(no_invois,13,3000)),'0') from KW_Pembayaran_invois");
        //    if (dt.Rows.Count > 0)
        //    {
        //        int seqno = Convert.ToInt32(dt.Rows[0][0].ToString());
        //        int newNumber = seqno + 1;
    ...
    void shw_grd_info()
    {
        if (DropDownList1.SelectedValue != "")
        {
            ...
            {
            dd_kepada.DataSource = GetData("select Ref_nama_syarikat as val1,Ref_no_syarikat as val2 from KW_Ref_Pembekal where Status='A' ");
            }
            else if (DropDownList1.SelectedValue == "03")
            {
