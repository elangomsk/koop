<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_penerimaan_debit.aspx.cs" Inherits="kw_penerimaan_debit" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1><asp:Label ID="ps_lbl1" runat="server"></asp:Label>Debtor Nota Debit</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i><asp:Label ID="ps_lbl2" runat="server"></asp:Label></a>Kewangan</li>
                            <li class="active"><asp:Label ID="ps_lbl3" runat="server"></asp:Label>Debtor Nota Debit</li>
                        </ol>
                    </section>
          ...
          <asp:TemplateField HeaderText="BIL">  
           ...
           <div class="col-md-12 box-body">
            ...
            <asp:TemplateField HeaderText="BIL">  
             ...
             <asp:TemplateField HeaderText="No Nota Debit" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                                        ...
                                        <asp:TextBox ID="end_dt1" runat="server" Visible="false"></asp:TextBox>
                                                                    ...
                                                                    <div class="row">
                                                                         <div class="col-md-12">
                                                                                <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"><asp:Label Visible="false" ID="ps_lbl90" runat="server"></asp:Label>No Nota Debit <span class="style1">*</span></label>
                                                                                <div class="col-sm-8">
...
<asp:BoundField DataField="amount" HeaderText="Amaun (RM)" HeaderStyle-HorizontalAlign="Right" DataFormatString="{0:n}" ItemStyle-HorizontalAlign="Right" />
  ...
  <asp:gridview ID="Gridview10" runat="server"  class="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="20" ShowFooter="true" GridLines="None" OnRowDeleting="grvStudentDetails_RowDeleting" onrowdatabound="Gridview9_RowDataBound" >
            ...
            <asp:TemplateField HeaderText="Keterangan" ItemStyle-HorizontalAlign="Center">
                ...
                <ItemTemplate>
                     <asp:Label ID="Txtdis" runat="server"  class="form-control uppercase" Width="100%"  placeholder="0.00" Text='<%# Eval("column3","{0:n}") %>'   style="text-align:right;"    ></asp:Label>
                </ItemTemplate>
                 <FooterStyle HorizontalAlign="Right" />
                <FooterTemplate>
               ...
               <div class="box-body">&nbsp;</div>
                                                                          <div class="row">
                                                                                ...
                                                                                <asp:Button ID="Button22" runat="server" class="btn btn-danger" Text="Print" Type="submit"
                                                                                    ...
                                                                                    />
                                                                                                <asp:Button ID="Button25" Visible="false" runat="server" Text="Cetak (M)" onclick="Button22_Click" class="btn btn-warning" UseSubmitBehavior="false"/>
                                                                                              <asp:Button ID="Button26" Visible="false" runat="server" Text="Cetak (E)" onclick="ENG_Button22_Click" class="btn btn-warning" UseSubmitBehavior="false"/>
