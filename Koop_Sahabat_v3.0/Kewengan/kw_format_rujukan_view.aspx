<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_format_rujukan_view.aspx.cs" Inherits="kw_format_rujukan_view" %>
        ...
        <ContentTemplate>
          ...
          <%-- <div class="col-md-3 box-body">
                                ...
                                <div class="form-group">
                                     ...
                                     <%--   <asp:Button ID="button4" runat="server" Text="Carian"  class="align-center btn btn-primary" UseSubmitBehavior="false" OnClick="btn_search_Click" />--%>
                                   ...
                                   <asp:GridView ID="gv_refdata" runat="server" class="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="1000000">
                                                       <%-- <HeaderStyle ForeColor="#ffffff" />--%>
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="JENIS RUJUKAN" HeaderStyle-Width="40%">
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="Label3" runat="server" Text='<%# Eval("frm_type") %>' CssClass="uppercase"></asp:Label>
                                                                        </asp:LinkButton>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="FORMAT" HeaderStyle-Width="20%">
                                                                <ItemStyle HorizontalAlign="center"></ItemStyle>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="Label4" runat="server" Text='<%# Eval("format") %>' CssClass="uppercase"></asp:Label>
                                                                    <asp:Label ID="og_genid" Visible="false" runat="server" Text='<%# Eval("Id") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Jujukan Semasa"  HeaderStyle-Width="20%">
                                                                <ItemStyle HorizontalAlign="center"></ItemStyle>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="Label5" runat="server" Text='<%# Eval("cur_format") %>' CssClass="uppercase"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="STATUS" HeaderStyle-Width="20%">
                                                             ...
                                                             <asp:TemplateField HeaderText="Hapus" HeaderStyle-Width="10%" ControlStyle-CssClass="panel-heading">
                                                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                                <ItemTemplate>
