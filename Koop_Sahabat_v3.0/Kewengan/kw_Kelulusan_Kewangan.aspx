<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_Kelulusan_Kewangan.aspx.cs" Inherits="kw_Kelulusan_Kewangan" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1><asp:Label ID="ps_lbl1" Visible="false" runat="server"></asp:Label>Kelulusan Kewangan</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i><asp:Label ID="ps_lbl2" Visible="false" runat="server"></asp:Label></a> Kewangan</li>
                            <li class="active"><asp:Label ID="ps_lbl3" Visible="false" runat="server"></asp:Label>Kelulusan Kewangan</li>
                        </ol>
                    </section>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><asp:Label ID="ps_lbl4" Visible="false" runat="server"></asp:Label> <asp:Label Visible="false" ID="hd_txt" runat="server"></asp:Label>Kelulusan Kewangan</h3>
                        </div>
                                                                      ...
                                                                      <div class="row">
                                                                        ...
                                                                        <div class="col-md-6 box-body">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                 <asp:TextBox ID="TextBox19" runat="server" class="form-control uppercase" ReadOnly="true"  ></asp:TextBox>
                                                                                </div>
                                                                                </div>
                                                                            </div>
                                                                     ...
                                                                     <legend style="width:11%">Semakan Kewangan</legend> 
                                                                        ...
                                                                        <div class="col-md-6 box-body">
                                                                            ...
                                                                            <div class="form-group" style="pointer-events:none;">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label">Status Semakan </label>
                                                                                <div class="col-sm-8">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="baki" HeaderText="Baki (RM)" HeaderStyle-HorizontalAlign="Right" DataFormatString="{0:n}"  ItemStyle-HorizontalAlign="Right" />
                                                                        ...
                                                                        <div id="Div17" runat="server">
                                                                              <fieldset class="col-md-12">
                                                                     <legend style="width:11%">Kelulusan Kewangan</legend> 
                                                                                   <div class="row">
                                                                         <div class="col-md-12">
                                                                        <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label">Status Kelulusan <span class="style1">*</span></label>
                                                                                <div class="col-sm-8">
                                                                             ...
                                                                             <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label">Nota </label>
                                                                                <div class="col-sm-8">
                                                                                <asp:TextBox ID="txt_nota" runat="server" CssClass="form-control uppercase" MaxLength="1000"></asp:TextBox>                                                                                  
                                                                                </div>
                                                                                </div>
                                                                            </div>
                                                                      </div>
