...
public partial class KW_Pembayaraan : System.Web.UI.Page
{
    string qry1 = string.Empty, qry2 = string.Empty;
    SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["KoopConnectionString"].ConnectionString);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string script = "  $().ready(function () { $(" + pp6.ClientID + ").click(function() { $(" + hd_txt.ClientID + ").text('MOHON BAYAR'); }); $(" + pp4.ClientID + ").click(function() { $(" + hd_txt.ClientID + ").text('INVOIS / BIL');});$(" + pp1.ClientID + ").click(function() {$(" + hd_txt.ClientID + ").text('PAYMENT VOUCHER');});$(" + pp2.ClientID + ").click(function() {$(" + hd_txt.ClientID + ").text('NOTA KREDIT');});$(" + pp3.ClientID + ").click(function() {$(" + hd_txt.ClientID + ").text('NOTA DEBIT');});});";
        ScriptManager.RegisterStartupScript(this, this.GetType(), "", script, true);
        if (!Page.IsPostBack)
        {
            if (Session["New"] != null)
            {
                if (Session["description"].ToString() == "MHR" || Session["description"].ToString() == "MAS")
                {
                    pp1.Attributes.Add("Style", "pointer-events:None;");
                    pp2.Attributes.Add("Style", "pointer-events:None;");
                    pp3.Attributes.Add("Style", "pointer-events:None;");
                    pp4.Attributes.Add("Style", "pointer-events:None;");
                }
                else
                {
                    pp1.Attributes.Remove("Style");
                    pp2.Attributes.Remove("Style");
                    pp3.Attributes.Remove("Style");
                    pp4.Attributes.Remove("Style");
                }
    ...
    void invois_view()
    {
        ...
        try
        {
            string com = " select UPPER(no_invois) no_invois from KW_Pembayaran_invoisBil_item group by no_invois";
    ...
    private void GrandTotalt1()
    {
        ...
        for (int i = 0; i < grdmohon.Rows.Count; i++)
        {
            ...
            jum.Text = GTotal.ToString("C").Replace("$", "");
            jum1.Text = ITotal.ToString("C").Replace("$", "");
            TextBox17.Text = ITotal.ToString("C").Replace("$", "");
    ...
    private void GrandTotalt2()
    {
        ...
        for (int i = 0; i < grdmohon.Rows.Count; i++)
        {
            ...
            jum.Text = ITotal.ToString("C").Replace("$", "");
            tot.Text = GTotal.ToString("C").Replace("$", "");
            TextBox17.Text = GTotal.ToString("C").Replace("$", "");
        ...
        for (int i = 0; i < Gridview5.Rows.Count; i++)
        {
            ...
            if (chk == "True")
            {
                ...
                if (tgst != "--- PILIH ---")
                {
                    ...
                    string ggst = cuk.ToString("C").Replace("$", "");
                    Gst += (float)Convert.ToDecimal(ggst);
                    jum.Text = GTotal.ToString("C").Replace("$", "");
                    jum1.Text = Gst.ToString("C").Replace("$", "");
                    gmt1.Text = Gst.ToString("C").Replace("$", "");
                    jumI.Text = ITotal.ToString("C").Replace("$", "");
                    TextBox37.Text = ITotal.ToString("C").Replace("$", "");
                }
                else
                {
                    gmt = "0";
        ...
        for (int i = 0; i < grdbilinv.Rows.Count; i++)
        {
            ...
            if (chk == "True")
            {
                ...
                if (tgst != "--- PILIH ---")
                {
                    ...
                    jum.Text = GTotal.ToString("C").Replace("$", "");
                    jum1.Text = Gst.ToString("C").Replace("$", "");
                    gamt1.Text = Gst.ToString("C").Replace("$", "");
                    jumI.Text = ITotal.ToString("C").Replace("$", "");
                    TextBox37.Text = ITotal.ToString("C").Replace("$", "");
                }
                else
        ...
        for (int i = 0; i < Gridview10.Rows.Count; i++)
        {
            ...
            if (chk == "True")
            {
                ...
                if (tgst != "--- PILIH ---")
                {
                    ...
                    gamt1.Text = Gst.ToString("C").Replace("$", "");
                    jumI.Text = ITotal.ToString("C").Replace("$", "");
                    TextBox18.Text = ITotal.ToString("C").Replace("$", "");
                }
                else
                {
                    gamt = "0";
    ...
    protected void disChangedBil(object sender, EventArgs eventArgs)
    {
        ...
        {
            numTotal = Jum1 - dis1;
            jum.Text = numTotal.ToString("C").Replace("$", "");
            JUMI.Text = numTotal.ToString("C").Replace("$", "");
    ...
    void project()
    {
        ...
        try
        {
            string com = "select Ref_Projek_code,UPPER(Ref_Projek_name) Ref_Projek_name from  KW_Ref_Projek";
            SqlDataAdapter adpt = new SqlDataAdapter(com, con);
            DataTable dt = new DataTable();
            adpt.Fill(dt);
            ...
            if (dt.Rows.Count > 0)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    else if (ddl1.SelectedItem.Text == "SEMUA COA")
                    {
                        ...
                        try
                        {
                            string com = "select nama_akaun,kod_akaun   from KW_Ref_Carta_Akaun ";
                            SqlDataAdapter adpt = new SqlDataAdapter(com, con);
                            DataTable dt1 = new DataTable();
                            adpt.Fill(dt1);
    ...
    protected void ddpela3_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            string com = "select UPPER(no_invois) as no_invois from KW_Pembayaran_invoisBil_item where cre_kod_akaun='" + ddpela3.SelectedItem.Value + "' group by no_invois";
            SqlDataAdapter adpt = new SqlDataAdapter(com, con);
            DataTable dt = new DataTable();
            adpt.Fill(dt);
            ddinv2.DataSource = dt;
    ...
    void lnk_clk_Deb()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            txtdtinvois.Text = dt.Rows[0][2].ToString().Trim();
            ddpro2.SelectedValue = dt.Rows[0][3].ToString().Trim();
            if (dt.Rows[0][4].ToString().Trim() != "")
            {
                ddinvday2.SelectedValue = dt.Rows[0][4].ToString().Trim();
            }
            else
            {
        ...
        {
            DataTable dt1 = new DataTable();
            dt1 = Dbcon.Ora_Execute_table("select m1.deb_kod_akaun as kod_akauan,s1.nama_akaun,s2.Ref_nama_cukai as othgstname,s3.Ref_nama_cukai as gstname,m1.no_invois as rujukan,m1.item,m1.keterangan,m1.unit  unit,m1.quantiti,m1.gst,case when m1.discount = '0.00' then '0.00' else m1.discount end as discount,m1.jumlah jumlah,m1.Overall as Overall,m1.gstjumlah as gstjum,m1.othgstjumlah as othgst,CAST(CASE m1.tax WHEN 'Y' THEN 1 ELSE 0 END AS BIT) AS tax,m1.gsttype,m1.othgsttype from KW_Pembayaran_invoisBil_item  m1 left join KW_Ref_Carta_Akaun s1 on s1.kod_akaun=m1.deb_kod_akaun left join KW_Ref_Tetapan_cukai s2 on s2.Ref_kod_cukai=m1.othgsttype left join KW_Ref_Tetapan_cukai s3 on s3.Ref_kod_cukai=m1.gsttype where m1.no_invois='" + ssv1 + "' ");
            Gridview7.DataSource = dt1;
            Gridview7.DataBind();
    ...
    {
        string conString = ConfigurationManager.ConnectionStrings["KoopConnectionString"].ConnectionString;
    ...
    private void AddNewRowToGrid1()
    {
        ...
        if (ViewState["CurrentTable2"] != null)
        {
            ...
            if (dtCurrentTable2.Rows.Count > 0)
            {
                ...
                ((Label)grdmohon.FooterRow.Cells[4].FindControl("Label11")).Text = total.ToString("C").Replace("$", "");
                ((Label)grdmohon.FooterRow.Cells[5].FindControl("Label12")).Text = total1.ToString("C").Replace("$", "");
                ((Label)grdmohon.FooterRow.Cells[5].FindControl("Label13")).Text = total2.ToString("C").Replace("$", "");
    ...
    private void AddNewRowToMohbIL()
    {
        ...
        if (ViewState["CurrentTable6"] != null)
        {
            ...
            if (dtCurrentTable.Rows.Count > 0)
            {
                ...
                Gridview5.FooterRow.Cells[2].HorizontalAlign = HorizontalAlign.Right;
                ((Label)grdbilinv.FooterRow.Cells[7].FindControl("Label2")).Text = total1.ToString("C").Replace("$", "");
                ((Label)grdbilinv.FooterRow.Cells[9].FindControl("Label7")).Text = total2.ToString("C").Replace("$", "");
                ((Label)grdbilinv.FooterRow.Cells[11].FindControl("Label4")).Text = total3.ToString("C").Replace("$", "");
                ((Label)grdbilinv.FooterRow.Cells[12].FindControl("Label6")).Text = total4.ToString("C").Replace("$", "");
    ...
    private void AddNewRowToGridcredit()
    {
        ...
        if (ViewState["CurrentTable3"] != null)
        {
            ...
            if (dtCurrentTable3.Rows.Count > 0)
            {
                ...
                ((Label)Gridview10.FooterRow.Cells[2].FindControl("Label3")).Text = total1.ToString("C").Replace("$", "");
                ((Label)Gridview10.FooterRow.Cells[5].FindControl("Label11")).Text = total3.ToString("C").Replace("$", "");
                ((Label)Gridview10.FooterRow.Cells[7].FindControl("Label9")).Text = total2.ToString("C").Replace("$", "");
                ((Label)Gridview10.FooterRow.Cells[8].FindControl("Label6")).Text = total4.ToString("C").Replace("$", "");
    ...
    private void AddNewRowToGriddebit()
    {
        ...
        if (ViewState["CurrentTable4"] != null)
        {
            ...
            if (dtCurrentTable4.Rows.Count > 0)
            {
                ...
                ((Label)Gridview11.FooterRow.Cells[2].FindControl("Label3")).Text = total1.ToString("C").Replace("$", "");
                ((Label)Gridview11.FooterRow.Cells[5].FindControl("Label11")).Text = total2.ToString("C").Replace("$", "");
                ((Label)Gridview11.FooterRow.Cells[7].FindControl("Label9")).Text = total4.ToString("C").Replace("$", "");
                ((Label)Gridview11.FooterRow.Cells[8].FindControl("Label6")).Text = total3.ToString("C").Replace("$", "");
    ...
    void akaun()
    {
        ...
        try
        {
            string com = "select kod_syarikat,nama_syarikat from KW_Profile_syarikat";
            SqlDataAdapter adpt = new SqlDataAdapter(com, con);
            DataTable dt = new DataTable();
            adpt.Fill(dt);
    ...
    void noper_pv()
    {
        ...
        try
        {
            ...
            string com = "select* from (select upper(no_invois) no_invois, cre_kod_akaun from KW_Pembayaran_invoisBil_item where Status = 'B' ) as a union all (select upper(no_rujukan) no_rujukan, nama_pelanggan from KW_Pembayaran_Credit_item )";
            SqlDataAdapter adpt = new SqlDataAdapter(com, con);
            DataTable dt = new DataTable();
            adpt.Fill(dt);
            //ddbkepada.DataSource = dt;
            ...
            if (txtnoper.Text != "")
            {
                if (txtid.Text != "--- PILIH ---")
                {
                    if (txttarkihmo.Text != "")
                    {
                            ...
                            if (txtname.Text != "" || ddbkepada.SelectedValue == "KAKITANGAN")
                            {
                                    ...
                                    if (txtcatatan.Text != "")
                                    {
                                        ...
                                        foreach (GridViewRow g1 in grdmohon.Rows)
                                        {
                                            ...
                                            dt = Dbcon.Ora_Execute_table("insert into KW_Pembayaran_mohon values('" + ddakaun.SelectedItem.Value + "','" + txtnoper_1.Text + "','" + txtid.Text + "','" + tDate.ToString("yyyy/MM/dd hh:mm:ss") + "','" + ddbkepada.SelectedItem.Value + "','" + txticno.Text + "','" + txtname.Text + "','" + txtbname.Text + "','" + txtbno.Text + "','" + txtterma.Text + "','" + txtjenis.SelectedValue + "','','" + ddstatus.SelectedItem.Value + "','" + txtcatatan.Text + "','" + tDate2.ToString("yyyy/MM/dd hh:mm:ss") + "','" + ruju + "','" + ket + "','" + jum + "','" + gst + "','" + ttotal + "','" + userid + "','" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "','','','N','"+ dd_kplist.SelectedValue + "','"+ jurnal_no.SelectedValue +"')");
                                        }
                                        ...
                                        Bindcredit();
                                        Binddedit();
                                        ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "alert('Mohan Bayar Berjaya Dibuat');", true);
                                                        }
                                                        else
                                                        {
                                                            ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "alert('Sila Pilih Catatan');", true);
                                                        }
                                                    }
                                                    else
                                                    {
                                                        ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "alert('Sila Pilih Status');", true);
                                                    }
                        ...
                        {
                            ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "alert('Sila Masukkan Jumlah');", true);
                        }
                    }
                    else
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "alert('Sila Pilih Tarikh Mohon.');", true);
                    }
                }
                else
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "alert('Sila Pilih Jenis Permohonan');", true);
                }
            }
            else
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "alert('Sila Masukkan No Permohonan');", true);
            }
        }
        else
        {
            ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "alert('Sila Masukkan Untuk Akuan');", true);
        }
    }
    ...
    protected void btnkem_Click(object sender, EventArgs e)
    {
        if(ddsts.SelectedItem.Text != "--- PILIH ---")
        {
            ...
            //{
                ...
                Bindcredit();
                Binddedit();
                ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "alert('Mohon Bayar Berjaya Dikemaskini.');", true);
            //}
    ...
    void reset()
    {
        ...
        txtjenis.SelectedValue = "";
        txtjenis.Attributes.Remove("disabled");


        dd_kplist.SelectedValue = "";
        dd_kplist.Attributes.Remove("disabled");
    ...
    protected void lblSubbind_Click(object sender, EventArgs e)
    {
        ...
        dd_kplist.Attributes.Add("disabled", "disabled");
    ...
    void ss_frmgrid()
    {
        ...
        if (dt.Rows.Count > 0)
        {
           ...
           if(dt.Rows[0]["Bayar_kepada"].ToString() == "kakitangan")
            ...
            TextBox1_2.Text = dt.Rows[0]["no_Invois"].ToString();
            ddakaun.SelectedValue = dt.Rows[0][0].ToString().Trim();
            ddakaun.Attributes.Add("disabled", "disabled");
            ...
            txtjenis.SelectedValue = dt.Rows[0][12].ToString();
            txtjenis.Attributes.Add("disabled", "disabled");

            dd_kplist.SelectedValue = dt.Rows[0]["mohon_kp"].ToString();
            dd_kplist.Attributes.Add("disabled", "disabled");
    ...
    void crt_pvlink()
    {
        ...
        DataTable dt = new DataTable();
        dt = Dbcon.Ora_Execute_table("select untuk_akaun,Data,Pv_no,UPPER(no_invois) no_invois,Format(tarkih_pv,'dd/MM/yyyy') tarkih_pv,kat_akaun,Deb_kod_akaun,Bayar_kepada,Cara_Bayaran,Cre_kod_akaun,Terma,No_cek,status,Akaun_name from KW_Pembayaran_Pay_voucer where pv_no='" + ssv2 + "'");
        ...
        if (dt.Rows.Count > 0)
        {
            if (level == "6")
            {
                ...
                else
                {
                    ...
                    {
                        sqry11 = "select a.tarkih_mohon,a.tarkih_invois,a.no_invois,a.no_permohonan,a.jumlah,a.gstjumlah,a.othgstjumlah,a.Overall,isnull(b.Baki,0) as Baki,no_po from (select Format(tarkih_mohon,'dd/MM/yyyy')tarkih_mohon,Format(tarkih_invois,'dd/MM/yyyy')tarkih_invois,no_invois,no_permohonan,REPLACE(CONVERT(varchar(20), (CAST(SUM(jumlah) AS money)), 1), '.00', '.00') jumlah, REPLACE(CONVERT(varchar(20), (CAST(SUM(gstjumlah) AS money)), 1), '.00', '.00') gstjumlah, REPLACE(CONVERT(varchar(20), (CAST(SUM(othgstjumlah) AS money)), 1), '.00', '.00') othgstjumlah, REPLACE(CONVERT(varchar(20), (CAST(SUM(Overall) AS money)), 1), '.00', '.00') Overall from KW_Pembayaran_invoisBil_item where no_invois='" + dt.Rows[0][3].ToString() + "' and  Status='B' group by  tarkih_mohon,tarkih_invois,no_invois,no_permohonan) a left join (select  no_Permohonan,no_invois,format( sum(Payamt) ,'#,##,###.00') Baki   from KW_Pembayaran_Pay_voucer group by no_permohonan,no_invois) b on a.no_permohonan=b.no_Permohonan and a.no_invois=b.no_invois";
                    }
                    else
                    {
                        sqry11 = "select a.tarkih_mohon,a.tarkih_invois,a.no_invois,(a.no_Rujukan) as no_permohonan,a.jumlah,a.gstjumlah,a.othgstjumlah,a.Overall,isnull(b.Baki,0) as Baki,no_po from (select Format(tarikh_credit,'dd/MM/yyyy')tarkih_mohon,Format(tarikh_invois,'dd/MM/yyyy')tarkih_invois,no_invois,no_Rujukan,REPLACE(CONVERT(varchar(20), (CAST(SUM(jumlah) AS money)), 1), '.00', '.00') jumlah, REPLACE(CONVERT(varchar(20), (CAST(SUM(gstjumlah) AS money)), 1), '.00', '.00') gstjumlah, REPLACE(CONVERT(varchar(20), (CAST(SUM(othgstjumlah) AS money)), 1), '.00', '.00') othgstjumlah, REPLACE(CONVERT(varchar(20), (CAST(SUM(Overall) AS money)), 1), '.00', '.00') Overall from KW_Pembayaran_Credit_item where no_Rujukan='" + dt.Rows[0][3].ToString() + "' group by  tarikh_credit,tarikh_invois,no_invois,no_Rujukan) a left join (select  no_Permohonan,no_invois,format( sum(Payamt) ,'#,##,###.00') Baki   from KW_Pembayaran_Pay_voucer group by no_permohonan,no_invois) b on a.no_Rujukan=b.no_Permohonan and a.no_invois=b.no_invois";
                    }


                    DataTable dt1 = new DataTable();
                    dt1 = Dbcon.Ora_Execute_table(sqry11);
    ...
    protected void lblSubItemInv_Click(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            if (CommandArgument2 == "MOHON BAYAR")
            {
                ...
                {
                    TextBox37.Text = double.Parse(dt1_jum.Rows[0]["Overall"].ToString()).ToString("C").Replace("$","");
                }
                else
                {
                    TextBox37.Text = "0.00";
            ...
            else
            {
                ...
                DataTable dt1 = new DataTable();
                dt1 = Dbcon.Ora_Execute_table("select deb_kod_akaun,item,keterangan,unit,quantiti,REPLACE(CONVERT(varchar(20), (CAST((discount) AS money)), 1), '.00', '.00') discount, REPLACE(CONVERT(varchar(20), (CAST((jumlah) AS money)), 1), '.00', '.00') jumlah,CAST(CASE tax WHEN 'Y' THEN 1 ELSE 0 END AS BIT) AS tax,othgsttype,gsttype,REPLACE(CONVERT(varchar(20), (CAST((Overall) AS money)), 1), '.00', '.00') Overall from KW_Pembayaran_invoisBil_item where no_permohonan='" + CommandArgument1 + "' and data='Baru'");
                ...
                {
                    TextBox37.Text = double.Parse(dt1_jum1.Rows[0]["Overall"].ToString()).ToString("C").Replace("$", "");
                }
                else
                {
                    TextBox37.Text = "0.00";
    ...
    protected void ddpela2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            string com = "select UPPER(no_invois) no_invois from KW_Pembayaran_invoisBil_item where cre_kod_akaun='" + ddpela2.SelectedItem.Value + "' group by no_invois";
            SqlDataAdapter adpt = new SqlDataAdapter(com, con);
            DataTable dt = new DataTable();
            adpt.Fill(dt);
            ddinv.DataSource = dt;
    ...
    void crt_notelink()
    {
        ...
        DataTable dt = new DataTable();
        dt = Dbcon.Ora_Execute_table("select untuk_akaun,nama_pelanggan,no_Rujukan,Format(tarikh_invois,'dd/MM/yyyy') tarikh_invois ,Format(tarikh_credit,'dd/MM/yyyy') tarikh_credit,project_kod,jumlah as jumlah,UPPER(no_invois) as no_invois,inv_day from KW_Pembayaran_Credit_item  where no_Rujukan='" + ssv2 + "'");
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            txtnoruju.Text = dt.Rows[0][2].ToString().Trim();
            txtnoruju.Attributes.Add("disabled", "disabled");

            txttcinvois.Text = dt.Rows[0][3].ToString().Trim();
            ...
            ddpro1.SelectedValue = dt.Rows[0][5].ToString().Trim();
            ddpro1.Attributes.Add("disabled", "disabled");
            invois_view();
            ddinv.SelectedValue = dt.Rows[0][7].ToString();
            ddinv.Attributes.Add("disabled", "disabled");

            if (dt.Rows[0][8].ToString().Trim() != "--- PILIH ---" || dt.Rows[0][8].ToString().Trim() != "")
            {
                ddinvday.SelectedValue = dt.Rows[0][8].ToString().Trim();
            }
            else
            {
            ...
            dt2 = Dbcon.Ora_Execute_table("select m1.deb_kod_akaun as kod_akauan,s1.nama_akaun,s2.Ref_nama_cukai as othgstname,s3.Ref_nama_cukai as gstname,m1.no_invois as rujukan,m1.item,m1.keterangan,Format(m1.unit,'#,##,###.00') unit,m1.quantiti,m1.gst,case when m1.discount = '0.00' then '0.00' else Format(m1.discount,'#,##,###.00') end as discount,Format(m1.jumlah,'#,##,###.00') jumlah,Format(m1.Overall,'#,##,###.00') Overall,Format(m1.gstjumlah,'#,##,###.00') gstjum,Format(m1.othgstjumlah,'#,##,###.00') othgst,CAST(CASE m1.tax WHEN 'Y' THEN 1 ELSE 0 END AS BIT) AS tax,m1.gsttype,m1.othgsttype from KW_Pembayaran_invoisBil_item  m1 left join KW_Ref_Carta_Akaun s1 on s1.kod_akaun=m1.deb_kod_akaun left join KW_Ref_Tetapan_cukai s2 on s2.Ref_kod_cukai=m1.othgsttype left join KW_Ref_Tetapan_cukai s3 on s3.Ref_kod_cukai=m1.gsttype where m1.no_invois='" + dt.Rows[0][7].ToString().Trim() + "' and m1.cre_kod_akaun='" + dt.Rows[0][1].ToString() + "' ");
            ...
            if (dt1_jum.Rows.Count != 0)
            {
                TextBox18.Text = double.Parse(dt1_jum.Rows[0]["Overall"].ToString()).ToString("C").Replace("$", "");
            }
            else
            {
                TextBox18.Text = "0.00";
    ...
    void lnk_clk_crt()
    {
        ...
        DataTable dt = new DataTable();
        dt = Dbcon.Ora_Execute_table("select untuk_akaun,cre_kod_akaun,Format(tarkih_invois,'dd/MM/yyyy') tarikh_invois,project_kod,Terma,deb_kod_akaun,item,keterangan,Format(unit,'#,##,###.00') unit,quantiti,gst,Format(Overall,'#,##,###.00') jumlah,tax from KW_Pembayaran_invoisBil_item where no_invois='" + ssv1 + "' and cre_kod_akaun='" + ddpela2.SelectedItem.Value + "' ");
        DataTable dt1 = new DataTable();
        if (dt.Rows.Count > 0)
        {
            ...
            txttcinvois.Text = dt.Rows[0][2].ToString().Trim();
            ddpro1.SelectedValue = dt.Rows[0][3].ToString().Trim();
    ...
    void debit_link()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            txtnoruj2.Text = dt.Rows[0][2].ToString().Trim();
            txtnoruj2.Attributes.Add("disabled", "disabled");

            txtdtinvois.Text = dt.Rows[0][3].ToString().Trim();
            txtdtinvois.Attributes.Add("disabled", "disabled");

            txtdeb.Text = dt.Rows[0][4].ToString().Trim();
            txtdeb.Attributes.Add("disabled", "disabled");

            ddpro2.SelectedValue = dt.Rows[0][5].ToString().Trim();
            ddpro2.Attributes.Add("disabled", "disabled");

            ddinv2.SelectedValue = dt.Rows[0][6].ToString().Trim();
            ddinv2.Attributes.Add("disabled", "disabled");

            if (dt.Rows[0][7].ToString().Trim() != "")
            {
                ddinvday2.SelectedValue = dt.Rows[0][7].ToString().Trim();
            }
            ...
            dt2 = Dbcon.Ora_Execute_table("select m1.deb_kod_akaun as kod_akauan,s1.nama_akaun,s2.Ref_nama_cukai as othgstname,s3.Ref_nama_cukai as gstname,m1.no_invois as rujukan,m1.item,m1.keterangan,m1.unit  unit,m1.quantiti,m1.gst,case when m1.discount = '0.00' then '0.00' else m1.discount end as discount,m1.jumlah as jumlah,m1.Overall as Overall,m1.gstjumlah as gstjum,m1.othgstjumlah as othgst,CAST(CASE m1.tax WHEN 'Y' THEN 1 ELSE 0 END AS BIT) AS tax,m1.gsttype,m1.othgsttype from KW_Pembayaran_invoisBil_item  m1 left join KW_Ref_Carta_Akaun s1 on s1.kod_akaun=m1.deb_kod_akaun left join KW_Ref_Tetapan_cukai s2 on s2.Ref_kod_cukai=m1.othgsttype left join KW_Ref_Tetapan_cukai s3 on s3.Ref_kod_cukai=m1.gsttype where m1.no_invois='" + dt.Rows[0][6].ToString().Trim() + "' and m1.cre_kod_akaun='" + dt.Rows[0][1].ToString() + "' ");
            ...
            if (dt1_jum.Rows.Count != 0)
            {
                TextBox1.Text = double.Parse(dt1_jum.Rows[0]["Overall"].ToString()).ToString("C").Replace("$", "");
            }
            else
            {
                TextBox1.Text = "0.00";
    ...
    protected void btnprintmoh_Click(object sender, EventArgs e)
    {
        if (Session["Invoisno"].ToString() != "")
        {
            ...
            ss_frmgrid();
            Session["Invoisno"] = txtnoper.Text;
            Session["Invoisno_11"] = TextBox1_2.Text;
            //Response.Redirect("KW_Pembayaran_Mohon_prtview.aspx");
    ...
    private void GetUniqueInv()
    {
        ...
        else
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                int newNumber = seqno + 1;
                uniqueId = newNumber.ToString("KS-PVC" + "-" + DateTime.Now.ToString("yy") + "-" + "0000");
                txtpvno.Text = uniqueId;
                txtpvno.Attributes.Add("disabled", "disabled");
                            ...
                            if (ddpvcara.SelectedValue != "")
                            {
                                if (DDbank.SelectedValue != "" || ddpvcara.SelectedValue == "001")
                                {
                                    ...
                                    if (ddpvstatus1.SelectedItem.Text == "LULUS")
                                    {
                                        ...
                                        Dtpv = Dbcon.Ora_Execute_table("select Deb_kod_akaun, Cre_kod_akaun, payamt,No_cek, Format(tarkih_pv,'dd/MM/yyyy') tarkih_pv from KW_Pembayaran_Pay_voucer where no_invois = '" + ddnoperpv_PV1.Text + "'");
                                        ...
                                        for (int i = 0; i < Dtpv.Rows.Count; i++)
                                        {
                                            ...
                                            get_ket = Dbcon.Ora_Execute_table("select * from KW_Pembayaran_invoisBil_item where no_invois='" + ddnoperpv_PV1.Text + "'");
                                            ...
                                            dtGK = Dbcon.Ora_Execute_table("insert into KW_General_Ledger values('" + Dtpv.Rows[i][0].ToString() + "','" + Dtpv.Rows[i][2].ToString() + "','','" + userid + "','" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "','" + vv2 + "','" + txtpvno.Text + "','" + ddnoperpv_PV1.Text + "','','" + Dtpv.Rows[i][2].ToString() + "','" + tDate3.ToString("yyyy/MM/dd hh:mm:ss") + "','" + pv_ket + "','" + Dtpv.Rows[i][3].ToString() + "','" + Dtpv.Rows[i][0].ToString() + "','','','A','')");
                                            ...
                                            dtGK = Dbcon.Ora_Execute_table("insert into KW_General_Ledger values('" + Dtpv.Rows[i][1].ToString() + "','','" + Dtpv.Rows[i][2].ToString() + "','" + userid + "','" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "','" + vv3 + "','" + txtpvno.Text + "','" + ddnoperpv_PV1.Text + "','','" + Dtpv.Rows[i][2].ToString() + "','" + tDate3.ToString("yyyy/MM/dd hh:mm:ss") + "','" + pv_ket + "','" + Dtpv.Rows[i][3].ToString() + "','" + Dtpv.Rows[i][1].ToString() + "','','','A','')");
                                        ...
                                        dtGK = Dbcon.Ora_Execute_table("update KW_Pembayaran_invoisBil_item set Status='L' where no_invois='" + ddnoperpv_PV1.Text + "'");
                                        dtGK = Dbcon.Ora_Execute_table("update KW_Pembayaran_Pay_voucer set Status='L' where no_invois='" + ddnoperpv_PV1.Text + "'");
                                        //
                                        DataTable get_ket1 = new DataTable();
                                        get_ket1 = Dbcon.Ora_Execute_table("select * from KW_Pembayaran_invoisBil_item where no_invois='" + ddnoperpv_PV1.Text + "'");
                    ...
                    if (txttcinvois.Text != "")
                    {
                        if (txttcre.Text != "")
                        {
                            ...
                            foreach (GridViewRow g1 in Gridview10.Rows)
                            {
                                ...
                                dt2 = Dbcon.Ora_Execute_table("update KW_Opening_Balance set ending_amt=" + TextBox18.Text + " ,upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "' where kod_akaun='" + DD + "' and opening_year='" + DateTime.Now.ToString("yyyy") + "' ");
                                if (tgst1 != 0)
                                {
                            ...
                            dt2 = Dbcon.Ora_Execute_table("update KW_Pembayaran_invoisBil_item set jumlah='" + TextBox18.Text + "' , Overall= '" + TextBox18.Text + "' ,upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "' where no_invois='" + ddinv.SelectedItem.Text + "' and  cre_kod_akaun='" + ddpela2.SelectedItem.Value + "'");
    ...
    //    DateTime dateOfMonthToDisable = currentDate.AddMonths(-2);
                ...
                if (txtnoruj2.Text != "")
                {
                    if (txtdtinvois.Text != "")
                    {
                        if (txtdeb.Text != "")
                        {
                            ...
                            dt2 = Dbcon.Ora_Execute_table("update KW_Pembayaran_invoisBil_item set jumlah=" + TextBox1.Text + " , Overall= Overall + " + TextBox1.Text + "  ,upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "' where no_invois='" + ddinv2.SelectedItem.Text + "' and  cre_kod_akaun='" + ddpela3.SelectedItem.Value + "'");
    ...
    protected void QtyChangeddeb(object sender, EventArgs eventArgs)
    {
        ...
        {
            ITotal += (decimal)Convert.ToDecimal(qty.Text);
            qty.Text = ITotal.ToString("C").Replace("$", "");
            jum.Text = ITotal.ToString("C").Replace("$", "");
        ...
        for (int i = 0; i < Gridview11.Rows.Count; i++)
        {
            ...
            if (chk == "True")
            {
                ...
                if (tgst != "--- PILIH ---")
                {
                    ...
                    gamt1.Text = Gst.ToString("C").Replace("$", "");
                    jumI.Text = ITotal.ToString("C").Replace("$", "");
                    TextBox1.Text = ITotal.ToString("C").Replace("$", "");
                }
                else
                {
                    gamt = "0";
    ...
    private void GetUniqueId()
     {
        ...
        {
            DataTable dt = Dbcon.Ora_Execute_table("select    ISNULL(max(SUBSTRING(Replace(no_Rujukan, ' ', ''),13,2000)),'0') from KW_Pembayaran_Credit_item");
            if (dt.Rows.Count > 0)
            {
                int seqno = Convert.ToInt32(dt.Rows[0][0].ToString());
                int newNumber = seqno + 1;
                uniqueId = newNumber.ToString("KS-KRD" + "-" + DateTime.Now.ToString("yy") + "-" + "0000");
                txtnoruju.Text = uniqueId;
                txtnoruju.Attributes.Add("disabled", "disabled");
            }
            else
    ...
    {
        DataTable dt1 = Dbcon.Ora_Execute_table("select doc_type_cd,format as fmt,SUBSTRING(cur_format, 1, 10) as lfrmt1,SUBSTRING(cur_format, 11, 4) as lfrmt2,cur_format as cfmt from KW_Format_Nombor_rujukan where doc_type_cd='03' and Status='A'");
        if (dt1.Rows.Count != 0)
        {
            if (dt1.Rows[0]["cfmt"].ToString() == "")
            {
        ...
        {
            DataTable dt = Dbcon.Ora_Execute_table("select   ISNULL(max(SUBSTRING(Replace(no_permohonan, ' ', ''),13,3000)),'0') from KW_Pembayaran_mohon");
            if (dt.Rows.Count > 0)
            {
                int seqno = Convert.ToInt32(dt.Rows[0][0].ToString());
                int newNumber = seqno + 1;
                uniqueId = newNumber.ToString("KS-MHN" + "-" + DateTime.Now.ToString("yy") + "-" + "0000");
                txtnoper.Text = uniqueId;
                txtnoper.Attributes.Add("disabled", "disabled");
    ...
    private void GetUniqueIddeb()
     {
        ...
        {
            DataTable dt = Dbcon.Ora_Execute_table("select   ISNULL(max(SUBSTRING(Replace(no_Rujukan, ' ', ''),13,2000)),'0') from KW_Pembayaran_Dedit_item");
            if (dt.Rows.Count > 0)
            {
                int seqno = Convert.ToInt32(dt.Rows[0][0].ToString());
                int newNumber = seqno + 1;
                uniqueId = newNumber.ToString("KS-DBT" + "-" + DateTime.Now.ToString("yy") + "-" + "0000");
                txtnoruj2.Text = uniqueId;
                txtnoruj2.Attributes.Add("disabled", "disabled");
             ...
             if (chk.Checked == true)
             {
                 if (dd != "")
                 {
                    ...
                    dt2 = Dbcon.Ora_Execute_table("update KW_Pembayaran_invois set jumlah=jumlah - " + dd + " , Overall= Overall - " + dd + "  ,upd_id='" + userid + "',upd_dt='" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "' where no_permohonan='" + inv + "'");
                     ...
                     dt5 = Dbcon.Ora_Execute_table("insert into KW_General_Ledger values('" + dt.Rows[0][0].ToString() + "','" + dd + "','','" + userid + "','" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "','" + tDate.ToString("yyyy/MM/dd hh:mm:ss") + "','" + txtnoruju.Text + "','" + inv + "','" + dt.Rows[0][0].ToString() + "','','','A','')");
                     dt6 = Dbcon.Ora_Execute_table("insert into KW_General_Ledger values('" + ddpela2.SelectedItem.Value + "','','" + dd + "','" + userid + "','" + DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss") + "','" + tDate.ToString("yyyy/MM/dd hh:mm:ss") + "','" + txtnoruju.Text + "','" + inv + "','" + ddpela2.SelectedItem.Value + "','','','A','')");
    ...
    protected void Gridview5_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            ddlCountries3.DataSource = GetData("select Ref_Projek_code,UPPER(Ref_Projek_name) as Ref_Projek_name from KW_Ref_Projek where Status='A'");
    ...
    protected void ddbkepada_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddbkepada.SelectedItem.Text != "--- PILIH ---")
        {
            ...
            {
                //jurnal_qry = "select pur_po_no as val1,'Aset | ' +pur_po_no as val2 from ast_purchase where pur_approve_sts_cd='01' and pur_mp_sts='Proses' group by pur_po_no except select jornal_no, +'Aset | '+ jornal_no from KW_Pembayaran_mohon where Bayar_kepada='PEMBEKAL (PENGURUSAN ASET)'";
                jurnal_qry = "select pur_po_no +'_'+pur_supplier_id as val1,'Aset | ' +pur_po_no +'_'+pur_supplier_id as val2 from ast_purchase where pur_approve_sts_cd='01' and pur_mp_sts='Proses' group by pur_po_no,pur_supplier_id except select jornal_no, +'Aset | '+ jornal_no from KW_Pembayaran_mohon where Bayar_kepada='PEMBEKAL (PENGURUSAN ASET)'";
                bind_jurnal();
                jurnal_show.Visible = true;
                txticno.Attributes.Add("disabled", "disabled");
                btncarian.Attributes.Add("disabled", "disabled");
    ...
    protected void jurnal_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddbkepada.SelectedItem.Text != "--- PILIH ---")
        {
            ...
            else if (ddbkepada.SelectedItem.Text == "PEMBEKAL (PENGURUSAN ASET)")
            {
                ...
                get_jumlah = Dbcon.Ora_Execute_table("select pur_po_no,sum(pur_asset_tot_amt) po_amt from ast_purchase where pur_approve_sts_cd='01' and pur_mp_sts='Proses' and pur_po_no='"+ ss_sp1[0].ToString() + "' and pur_supplier_id='" + ss_sp1[1].ToString() + "' group by pur_po_no");
    ...
    protected void ddpvkod_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddpvkod.SelectedItem.Text != "--- PILIH ---")
        {
            //string com = "select no_invois from KW_Pembayaran_invoisBil_item where cre_kod_akaun='" + ddpvkod.SelectedItem.Value + "' and  Status='B' ";
            string com = "select * from (select upper(no_invois) no_invois,cre_kod_akaun from KW_Pembayaran_invoisBil_item where cre_kod_akaun='" + ddpvkod.SelectedItem.Value + "' and  Status='B' ) as a union all (select upper(no_rujukan) no_rujukan,nama_pelanggan from KW_Pembayaran_Credit_item where nama_pelanggan='" + ddpvkod.SelectedItem.Value + "')";
            SqlDataAdapter adpt = new SqlDataAdapter(com, con);
            DataTable dt = new DataTable();
            adpt.Fill(dt);
            ddnoperpv.DataSource = dt;
    ...
    protected void GridView1_RowDataBound1(object sender, GridViewRowEventArgs e)
    {
        ...
        //    if (lblctrl.Text != "LULUS")
        //    {
        //        LinkButton Hlnk = e.Row.FindControl("LinkButton1") as LinkButton;
        //        Hlnk.Visible = true;
        //    }
        //    else
        //    {
