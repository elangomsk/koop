<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_lep_gst_ringkasan.aspx.cs" Inherits="kw_lep_gst_ringkasan" %>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="form-horizontal">
                           ...
                           <%-- <div class="row">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Perkara </label>
                                    <div class="col-sm-8">
                                          <asp:DropDownList id="DropDownList2" runat="server" class="form-control uppercase"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                                 </div>
