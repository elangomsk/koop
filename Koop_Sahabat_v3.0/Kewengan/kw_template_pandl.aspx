<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KSAIMB.master" CodeFile="../Kewengan/kw_template_pandl.aspx.cs" Inherits="kw_template_pandl" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1 id="h1_tag" runat="server">  P&L Templat  </h1>
                        <ol class="breadcrumb">
                            <li id="bb1_text" runat="server"><a href="#"><i class="fa fa-dashboard"></i>Kewangan</a></li>
                            <li class="active" id="bb2_text" runat="server"> P&L Templat  </li>
                        </ol>
                    </section>
        ...
        <ContentTemplate>
                        ...
                        <div class="box-header">
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label" id="lbl1_text" runat="server">Kategori <span class="style1">*</span></label>
                                    <div class="col-sm-8">
                                          <asp:DropDownList ID="sel_rt" CssClass=" form-control uppercase" runat="server" AutoPostBack="true" OnSelectedIndexChanged="dd_SelectedIndexChanged">
                                              ...
                                              <asp:ListItem Value="00">P&L KATEGORI</asp:ListItem>                 
                                              <asp:ListItem Value="01">P&L HEADER</asp:ListItem>
                                                                <%--<asp:ListItem Value="02">ALIRAN TUNAI ITEM</asp:ListItem>--%>
                                                            </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
           ...
           <div class="col-md-12 box-body">
                                   <asp:GridView ID="gv_refdata" runat="server" class="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="1000000" ShowFooter="true" GridLines="None" OnRowCommand="gv_refdata_RowCommand"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="BIL" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="2%">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRowNumber" Text='<%# Container.DataItemIndex + 1 %>' runat="server"
                                                                        ItemStyle-Width="150" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="KATEGORI" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left">

                        <ItemTemplate>
                            <asp:Label ID="lbl_hdr" class="uppercase" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "c8") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>           
                            <asp:DropDownList ID="lbledit_hdr" runat="server" style="width:100%;" onselectedindexchanged="bind_header" AutoPostBack="true" class="form-control uppercase"></asp:DropDownList>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:DropDownList ID="lbladd_hdr" runat="server" style="width:100%;" onselectedindexchanged="bind_header" AutoPostBack="true" class="form-control uppercase"></asp:DropDownList>
                        </FooterTemplate>
                    </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="HEADER" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left">

                        <ItemTemplate>
                            <asp:Label ID="lbl_hdr1" class="uppercase" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "c5") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>           
                            <asp:DropDownList ID="lbledit_hdr1" runat="server" style="width:100%;" class="form-control uppercase"></asp:DropDownList>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:DropDownList ID="lbladd_hdr1" runat="server" style="width:100%;" class="form-control uppercase"></asp:DropDownList>
                        </FooterTemplate>
                    </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Item" ItemStyle-Width="10%">
                                                             ...
                                                             <asp:TemplateField HeaderText="JENIS TANSAKSI" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="jen_txi" class="uppercase" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "c31").ToString() == "R" ? "REVERSE" : "NORMAL" %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <EditItemTemplate>
                                                                    <asp:DropDownList ID="editddljen_txi" Width="100%" SelectedValue='<%#Eval("c31") %>' runat="server"
                                                                        class="form-control uppercase">
                                                                        <asp:ListItem Text="NORMAL" Value="N"></asp:ListItem>
                                                                        <asp:ListItem Text="REVERSE" Value="R"></asp:ListItem>
                                                                    </asp:DropDownList>
                                                                </EditItemTemplate>
                                                                <FooterTemplate>
                                                                    <asp:DropDownList ID="ddljen_txi" runat="server" Width="100%" class="form-control uppercase">
                                                                        <asp:ListItem Text="NORMAL" Value="N"></asp:ListItem>
                                                                        <asp:ListItem Text="REVERSE" Value="R"></asp:ListItem>
                                                                    </asp:DropDownList>
                                                                </FooterTemplate>
