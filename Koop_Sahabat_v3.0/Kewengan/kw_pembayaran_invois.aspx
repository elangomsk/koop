<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_pembayaran_invois.aspx.cs" Inherits="kw_pembayaran_invois" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1><asp:Label ID="ps_lbl1" Visible="false" runat="server"></asp:Label>Invois</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i><asp:Label ID="ps_lbl2" Visible="false" runat="server"></asp:Label></a> Kewangan</li>
                            <li class="active"><asp:Label ID="ps_lbl3" Visible="false" runat="server"></asp:Label>Invois</li>
                        </ol>
                    </section>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><asp:Label ID="ps_lbl4" Visible="false" runat="server"></asp:Label> <asp:Label Visible="false" ID="hd_txt" runat="server"></asp:Label>Kreditor Invois</h3>
                             <div class="type-1 ">
                              <div class="type-in">
                                                                 ...
                                                                 />
                                                                    ...
                                                                    <fieldset class="col-md-12">
                                                                     <legend style="width:4%"><asp:Label ID="ps_lbl11" runat="server"></asp:Label></legend>
                                                                        ...
                                                                        <div class="col-md-3 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-5 control-label"><asp:Label Visible="false" ID="ps_lbl12" runat="server"></asp:Label>No Invois</label>
                                                                                <div class="col-sm-7">
           ...
           <div class="col-md-12 box-body">
            ...
            <Columns>
                <asp:TemplateField HeaderText="BIL">  
                 ...
                 <asp:TemplateField HeaderText="No Invois" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
                ...
                <asp:BoundField DataField="po_no" HeaderText="No Rujukan" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <asp:TextBox ID="end_dt1" runat="server" Visible="false"></asp:TextBox>
                                                                 ...
                                                                 <fieldset class="col-md-12">
                                                                     <legend style="width:10%">Maklumat Invois</legend>     
                                                                      ...
                                                                      <div class="row">
                                                                         <div class="col-md-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                              ...
                                                                              <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"><asp:Label ID="Label20" Visible="false" runat="server"></asp:Label>Bayar Kepada</label>                     
                                                                                <div class="col-sm-8">
                                                                                    <div class="input-group">
                                                                        ...
                                                                        <div class="row">
                                                                         <div class="col-md-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"><asp:Label ID="ps_lbl19" Visible="false" runat="server"></asp:Label> No Invois <span class="style1">*</span></label>
                                                                                <div class="col-sm-8">
         ...
         <asp:DropDownList ID="DropDownList3" style="width:100%; font-size:13px;" runat="server" class="form-control select2 validate[optional]" >
                                                                ...
                                                                <div class="box-body">&nbsp;</div>
                                                                 ...
                                                                 <div class="row" style="display:none;">
                                                                     ...
                                                                     <div class="box-header with-border">
                            <h3 class="box-title">Butiran Invois</h3>
                        </div>
                                                                       <div class="dataTables_wrapper form-inline dt-bootstrap" >
                                      <div class="row" style="overflow:auto;">
           <div class="col-md-12 box-body">
          <asp:gridview ID="grdmohon" runat="server"  class="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="20" ShowFooter="true" GridLines="None" OnRowDeleting="Mohon_grvStudentDetails_RowDeleting" onrowdatabound="grdmohon_RowDataBound" >
            ...
            <asp:TemplateField HeaderText="Bayar Kepada" Visible="false" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
                 ...
                 <asp:TemplateField HeaderText="Keterangan" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="No Akaun Bank" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
             ...
             <asp:TemplateField HeaderText="Harga / Unit" ItemStyle-Width="8%" ItemStyle-HorizontalAlign="right">
                <ItemTemplate>
