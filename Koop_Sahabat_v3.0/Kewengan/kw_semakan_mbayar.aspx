<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_semakan_mbayar.aspx.cs" Inherits="kw_semakan_mbayar" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1><asp:Label ID="ps_lbl1" Visible="false" runat="server"></asp:Label>Semakan Mohon Bayar</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i><asp:Label ID="ps_lbl2" Visible="false" runat="server"></asp:Label></a> Kewangan</li>
                            <li class="active"><asp:Label ID="ps_lbl3" Visible="false" runat="server"></asp:Label>Semakan Mohon Bayar</li>
                        </ol>
                    </section>
        ...
        <ContentTemplate>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><asp:Label ID="ps_lbl4" Visible="false" runat="server"></asp:Label> <asp:Label Visible="false" ID="hd_txt" runat="server"></asp:Label>Semakan Mohon Bayar</h3>
                        </div>
                                                                 ...
                                                                 />
                                                                    ...
                                                                    <fieldset class="col-md-12">
                                                                     <legend style="width:4%"><asp:Label ID="ps_lbl11" runat="server"></asp:Label></legend>
                                                                        ...
                                                                        <div class="col-md-3 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-5 control-label"><asp:Label ID="ps_lbl12" Visible="false" runat="server"></asp:Label>No Mohon Bayar</label>
                                                                                <div class="col-sm-7">
           ...
           <div class="col-md-12 box-body">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="mhn_keterangan" HeaderText="Keterangan" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
      <%--      <asp:BoundField DataField="nama" HeaderText="Nama" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />--%>
                ...
                <asp:TemplateField HeaderText="Status Semakan" ItemStyle-HorizontalAlign="Center">  
                    ...
                    <ItemStyle HorizontalAlign="Center" Font-Bold />
                                            <ItemTemplate>  
                                                <asp:Label ID="lul_status" Width="100%" runat="server" Text='<%# Eval("lul_status") %>'></asp:Label>
                                            </ItemTemplate>  
                                                </asp:TemplateField>
                  <asp:TemplateField HeaderText="Action">
                                                ...
                                                <asp:Label ID="Label18" runat="server" Text='<%# Eval("Bayar_kepada") %>' Visible="false"></asp:Label>
                                                                       <asp:LinkButton ID="LinkButton1" runat="server"  CommandArgument='<%# Eval("no_permohonan")%>' CommandName="Add"  onclick="lblSubbind_Click" ToolTip='<%# Eval("no_permohonan").ToString().ToUpper() %>' ><i class='fa fa-search'></i></asp:LinkButton>                                                                    
                                                                 &nbsp;          
                                                <asp:LinkButton ID="LinkButton2" runat="server" ToolTip="Delete" Visible="false" CommandArgument='Cancel' OnClick="lnkView_Click"  OnClientClick="if (!confirm('Are you sure to Delete?')) return false;" Font-Bold>
                                                                                                    Hapus
                                                                                                </asp:LinkButton> 
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                 ...
                                                                 <fieldset class="col-md-12">
                                                                       ...
                                                                       <div class="row">
                                                                         <div class="col-md-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label"><asp:Label ID="ps_lbl19" Visible="false" runat="server"></asp:Label> No Mohon Bayar</label>
                                                                                <div class="col-sm-8">
                                                                      ...
                                                                      <div class="row">
                                                                        ...
                                                                        <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                  <asp:DropDownList ID="dd_terma" runat="server" class="form-control select2">
                                                                                      <asp:ListItem Value="">--- PILIH ---</asp:ListItem>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6 box-body">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                  <asp:TextBox ID="TextBox9" runat="server" ReadOnly="true" class="form-control uppercase validate[optional]"></asp:TextBox> 
          ...
          <asp:gridview ID="grdmohon" runat="server"  class="table table-bordered table-hover dataTable uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="20" ShowFooter="true" GridLines="None" OnRowDeleting="Mohon_grvStudentDetails_RowDeleting" onrowdatabound="grdmohon_RowDataBound" >
            ...
            <asp:TemplateField HeaderText="Bayar Kepada" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Left">
                ...
                <ItemTemplate>
                  ...
                  <asp:TemplateField HeaderText="Projek" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <asp:DropDownList ID="dd_projek" class="form-control uppercase select2" Width="100%" runat="server"></asp:DropDownList>
                </ItemTemplate>
            </asp:TemplateField>
                   <asp:TemplateField HeaderText="Nama Bank" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <asp:DropDownList ID="dd_bank" class="form-control uppercase select2" Width="100%"  runat="server"></asp:DropDownList>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="No Akaun Bank" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                                                                     ...
                                                                     <legend style="width:7%">Semakan</legend> 
                                                                        ...
                                                                        <div class="col-md-6 box-body">
                                                                            <div class="form-group" style="display:none;">
                                                                             ...
                                                                             <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-4 control-label">Status Mohon Bayar <span class="style1">*</span></label>
                                                                                <div class="col-sm-8">
                                                                                   <asp:DropDownList ID="ddsts" style="width:100%; font-size:13px;" runat="server" AutoPostBack="true" OnSelectedIndexChanged="change_sts" class="form-control select2 validate[optional]" >
                                                                                <asp:ListItem Value="">--- PILIH ---</asp:ListItem>
                                                                                     <asp:ListItem Value="L">Lulus</asp:ListItem>
                            ...
                            <div class="col-md-6 box-body">
                             ...
                             <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:DropDownList ID="pel_ddnegeri" style="width:100%; font-size:13px;" runat="server" class="form-control validate[optional]" >
                                                                                </asp:DropDownList>  
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8 form-droupdown-index">
                                        <asp:DropDownList ID="pel_dd_kodind" style="width:100%; font-size:13px;" runat="server" class="form-control validate[optional]"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                                <%--  <div class="col-md-6 box-body">
                             ...
                             <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                         <asp:DropDownList ID="pel_dd_negera" style="width:100%; font-size:13px;" runat="server" class="form-control validate[optional]">
                                                                                </asp:DropDownList> 
                                    </div>
                                </div>
                            </div>
