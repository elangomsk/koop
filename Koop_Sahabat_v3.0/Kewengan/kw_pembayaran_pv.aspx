<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Kewengan/kw_pembayaran_pv.aspx.cs" Inherits="kw_pembayaran_pv" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" >
                    ...
                    <section class="content-header">
                        <h1><asp:Label ID="ps_lbl1" runat="server"></asp:Label>Buku Tunai</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i><asp:Label ID="ps_lbl2" runat="server"></asp:Label></a>Kewangan</li>
                            <li class="active"><asp:Label ID="ps_lbl3" runat="server"></asp:Label>Buku Tunai</li>
                        </ol>
                    </section>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><asp:Label ID="ps_lbl4" Visible="false" runat="server"></asp:Label> <asp:Label ID="hd_txt" Visible="false" runat="server"></asp:Label>Pembayaran (PV)</h3>
                        </div>
                                                    ...
                                                    <div class="panel" style="width: 100%;">
                                                        <div id="Div1" class="nav-tabs-custom" role="tabpanel" runat="server">
                                                            ...
                                                            <li id="pp6" runat="server"><a href="#ContentPlaceHolder1_p6" aria-controls="p6" role="tab" data-toggle="tab"><strong><asp:Label ID="ps_lbl6" runat="server"></asp:Label></strong></a>
                                                                ...
                                                                <li id="pp1" runat="server" class="active"><a href="#ContentPlaceHolder1_p1" aria-controls="p1" role="tab" data-toggle="tab"><strong><asp:Label ID="ps_lbl8" runat="server"></asp:Label></strong></a></li>
        ...
        <FooterStyle BackColor="white" Font-Bold="True" ForeColor="black" />
         ...
         <FooterStyle BackColor="#BDC4C7" Font-Bold="True" ForeColor="black" />
                                                        ...
                                                        <AlternatingRowStyle BackColor="White" />                                                            
                                                            ...
                                                            <div role="tabpanel1" class="tab-pane active" runat="server" id="p1">
                                                                <div class="col-md-12 table-responsive"  style="overflow:auto;">
           ...
           <div class="col-md-12 box-body">
            ...
            <asp:TemplateField HeaderText="BIL">  
             ...
             <asp:BoundField DataField="tarkih_pv" HeaderText="Tarikh Payment" ItemStyle-HorizontalAlign="Center" />
                ...
                <asp:BoundField DataField="Akaun_name" HeaderText="Beneficiary" ItemStyle-HorizontalAlign="Left" />
     ...
     <FooterStyle BackColor="#BDC4C7" Font-Bold="True" ForeColor="black" />
                                                       ...
                                                       <%-- <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />--%>
                                                        ...
                                                        <AlternatingRowStyle BackColor="White" />
                                                            ...
                                                            <!-- Nav tabs -->
                                                            <ul class="s1 nav nav-tabs" style="display:none;" role="tablist1">
                                                                       ...
                                                                       <div class="row">
                                                                         <div class="col-md-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                              ...
                                                                              <div class="col-md-4 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-5 control-label"><asp:Label ID="ps_lbl88" runat="server"></asp:Label> <span class="style1">*</span></label>
                                                                                <div class="col-sm-7">
                                                                                      <div class="input-group">
                                                       ...
                                                       <%-- <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />--%>
                                                        ...
                                                        <AlternatingRowStyle BackColor="White" />
                                                                     ...
                                                                     <div id="fr2" runat="server">
                                                                        ...
                                                                        <div class="col-md-4 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-5 control-label"><asp:Label ID="ps_lbl102" runat="server"></asp:Label> <span class="style1">*</span></label>
                                                                                <div class="col-sm-7">
                                                                              ...
                                                                              <div class="col-md-4 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-5 control-label"><asp:Label ID="ps_lbl103" runat="server"></asp:Label> <span class="style1">*</span></label>
                                                                                <div class="col-sm-7">
                                                                       ...
                                                                       <div class="row">
                                                                        ...
                                                                        <div class="col-md-4 box-body">
                                                                            <div class="form-group">
                                                                              ...
                                                                              <div class="col-md-4 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-5 control-label"><asp:Label ID="ps_lbl106" runat="server"></asp:Label> <span class="style1">*</span></label>
                                                                                <div class="col-sm-7">
                                                                                      <div class="input-group">
                                                                      ...
                                                                      <div class="row" id="debit_tab5" runat="server" visible="false">
                                                                         <div class="col-md-12">
                                                                              <div class="col-md-4 box-body">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="col-sm-5 control-label"><asp:Label ID="ps_lbl108" runat="server"></asp:Label> <span class="style1">*</span></label>
                                                                                <div class="col-sm-7">
