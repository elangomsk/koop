...
public partial class Ast_kerosakan_kelulusan_view : System.Web.UI.Page
{
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../Aset/Ast_kerosakan_kelulusan.aspx?edit={0}", name));
            }
            else
            {
                Session["validate_success"] = "";
