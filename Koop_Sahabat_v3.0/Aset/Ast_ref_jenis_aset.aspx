<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Aset/Ast_ref_jenis_aset.aspx.cs" Inherits="Ast_ref_jenis_aset" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                ...
                <div class="content-wrapper" style="height: 895px;">
                    ...
                    <section class="content-header">
                        <h1>Selenggara Jenis Aset</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>Pengurusan Aset</a></li>
                            <li class="active">Selenggara Jenis Aset</li>
                        </ol>
                    </section>
       ...
       <asp:UpdatePanel ID="UpdatePanel3" runat="server">
        <ContentTemplate>
           ...
           <div class="col-md-12 box-body">
                                   <asp:GridView ID="gv_refdata" runat="server" class="table table-bordered table-striped uppercase" AutoGenerateColumns="false" HeaderStyle-BackColor="#BDC4C7" HeaderStyle-ForeColor="black" CellPadding="3" CellSpacing="2" Font-Size="12px" Width="100%" AllowPaging="true" PageSize="1000000" ShowFooter="true"
                ...
                <Columns>           
                    ...
                    <asp:TemplateField HeaderText="JENIS ASET">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblkawasan" class="uppercase" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "ast_jeniaset_desc") %>'></asp:Label>

                        </ItemTemplate>

                        <EditItemTemplate>           

                            <asp:TextBox ID="txtEditkawasan" class="form-control uppercase" Width="100%" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "ast_jeniaset_desc") %>'></asp:TextBox>           

                        </EditItemTemplate>

                        <FooterTemplate>

                            <asp:TextBox ID="txtAddkawasan" placeholder="sila masukkan nilai" Width="100%" class="form-control uppercase" runat="server" ></asp:TextBox>

                        </FooterTemplate>

                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="KOD JENIS ASET">

                        <ItemTemplate>

                            <asp:Label ID="lblName" class="uppercase" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "ast_jeniaset_Code") %>'></asp:Label>

                        </ItemTemplate>

                        <EditItemTemplate>           

                            <asp:TextBox ID="txtEditcode" class="form-control validate[optional,custom[onlyLetterNumberSp],minSize[3]] uppercase" Width="100%" MaxLength="3" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "ast_jeniaset_Code") %>'></asp:TextBox>           
