<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Aset/ast_report_keseluruhan.aspx.cs" Inherits="ast_report_keseluruhan" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" style="height: 895px;">
                    ...
                    <section class="content-header">
                        <h1>Laporan Nilai Keseluruhan Aset</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>Pengurusan Aset</a></li>
                            <li class="active">Laporan Nilai Keseluruhan Aset</li>
                        </ol>
                    </section>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="form-horizontal">
                           ...
                           <div class="row">
                            ...
                            <h3 class="box-title">Laporan Nilai Keseluruhan Aset</h3>
                        </div>
                             <div class="box-body">&nbsp;</div>
