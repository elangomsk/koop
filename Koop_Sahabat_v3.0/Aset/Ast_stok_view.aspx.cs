...
public partial class Ast_stok_view : System.Web.UI.Page
{
    ...
    protected void BindData_jenis()
    {
        ...
        SqlCommand cmd = new SqlCommand("select AST.ID,ke.ast_kategori_desc,SKE.ast_subkateast_desc,JE.ast_jeniaset_desc,cas_asset_desc From ast_cmn_asset as AST left join Ref_ast_kategori as KE on KE.ast_kategori_Code=AST.cas_asset_cat_cd left join Ref_ast_sub_kategri_Aset as SKE on SKE.ast_subkateast_Code=AST.cas_asset_sub_cat_cd left join Ref_ast_jenis_aset as JE on JE.ast_jeniaset_Code=AST.cas_asset_type_cd  and JE.ast_cat_Code=cas_asset_cat_cd  and JE.ast_sub_cat_Code=cas_asset_sub_cat_cd", con);
        ...
        if (ds.Tables[0].Rows.Count == 0)
        {
            ...
            //if (DD_Kategori.SelectedValue != "" || DD_Sub_Kateg.SelectedValue != "" || DD_Jenis_ast.SelectedValue != "" || DD_NAMAAST.Text != "")
            //{
    ...
    protected void btn_hups_Click(object sender, EventArgs e)
    {
        ...
        if (rcount != "0")
        {
            ...
            //ddokdicno1 = DBCon.Ora_Execute_table("select pur_asset_cat_cd,pur_asset_sub_cat_cd,pur_asset_type_cd,pur_asset_cd From ast_purchase ");
            ...
            try
            {
                foreach (GridViewRow row in GridView1.Rows)
                {
                    ...
                    if (rbn.Checked)
                    {
                        ...
                        string varName1 = ((System.Web.UI.WebControls.Label)row.FindControl("Label4")).Text.ToString(); //this store the  value in varName1
                        SqlCommand ins_peng = new SqlCommand("delete from ast_cmn_asset where ID='" + varName1 + "'", con);
                        con.Open();
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            System.Web.UI.WebControls.Label lblTitle = (System.Web.UI.WebControls.Label)gvRow.FindControl("Label4");
            ...
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../Aset/Ast_stok.aspx?edit={0}", name));
            }
            else
            {
                Session["validate_success"] = "";
