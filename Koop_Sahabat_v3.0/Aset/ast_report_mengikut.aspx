<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Aset/ast_report_mengikut.aspx.cs" Inherits="ast_report_mengikut" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" style="height: 895px;">
                    ...
                    <section class="content-header">
                        <h1>Laporan Nilai Mengikut Organisasi</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>Pengurusan Aset</a></li>
                            <li class="active">Laporan Nilai Mengikut Organisasi</li>
                        </ol>
                    </section>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="form-horizontal">
                           ...
                           <div class="row">
                            ...
                            <h3 class="box-title">Laporan Nilai Mengikut Organisasi</h3>
                        </div>
                             <div class="box-body">&nbsp;</div>
