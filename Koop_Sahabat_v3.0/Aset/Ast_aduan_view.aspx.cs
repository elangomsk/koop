...
public partial class Ast_aduan_view : System.Web.UI.Page
{
    ...
    protected void BindData_jenis()
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("select s1.cmp_id,s1.cmp_asset_id,hrs.stf_name,s1.cmp_remark,case when s1.cmp_sts_cd='01' then 'BARU' else '' end cmp_sts from ast_complaint s1 left join hr_staff_profile as HRS on HRS.stf_staff_no=s1.cmp_staff_no", con);
