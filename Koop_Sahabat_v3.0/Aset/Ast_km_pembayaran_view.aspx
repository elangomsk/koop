<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Aset/Ast_km_pembayaran_view.aspx.cs" Inherits="Ast_km_pembayaran_view" %>
                                                         ...
                                                         <asp:TemplateField HeaderText="TARIKH TINDAKAN" ItemStyle-HorizontalAlign="Center">
                                                                        ...
                                                                        <asp:TemplateField HeaderText="No Invois">
                                                                         <ItemStyle HorizontalAlign="center"/>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="Label9" runat="server" Text='<%# Eval("cmp_invois_no") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Amaun Invois (RM)">
                                                                         <ItemStyle HorizontalAlign="Right"/>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="Label10" runat="server" Text='<%# Eval("cmp_invois_amt","{0:n}") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="No Dafter Syarikat">
                                                                         <ItemStyle HorizontalAlign="Left"/>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="Label11" runat="server" Text='<%# Eval("cmp_supplier_id") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
