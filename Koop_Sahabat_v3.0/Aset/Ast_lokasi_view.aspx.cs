...
public partial class Ast_lokasi_view : System.Web.UI.Page
{
    ...
    protected void BindData_jenis()
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("select ho.org_name,loc_cd,rl.org_gen_id,rl.loc_desc,rl.ID from ref_location rl left join hr_organization ho on ho.org_gen_id=rl.org_gen_id order by ho.org_name,loc_cd", con);
