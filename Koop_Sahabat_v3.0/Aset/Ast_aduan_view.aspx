<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Aset/Ast_aduan_view.aspx.cs" Inherits="Ast_aduan_view" %>
     ...
     <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper" style="height: 895px;">
                    ...
                    <section class="content-header">
                        <h1>Senarai Aduan Kerosakan</h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-dashboard"></i>Pengurusan Aset</a></li>
                            <li class="active">Senarai Aduan Kerosakan</li>
                        </ol>
                    </section>
