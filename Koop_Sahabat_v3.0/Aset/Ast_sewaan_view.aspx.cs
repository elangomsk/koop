...
public partial class Ast_sewaan_view : System.Web.UI.Page
{
    ...
    {
        con.Open();
        qry1 = "select Id,ren_comp_reg_no,ren_ownership_no,ren_state_cd,ren_rental_lot,UPPER(ren_ctc_address) ren_ctc_address,ren_level,ren_rental_lot,UPPER(ren_comp_name) ren_comp_name From ast_rental as R";
