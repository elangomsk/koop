<%@ Page Title="" Language="C#" MasterPageFile="~/KSAIMB.master" AutoEventWireup="true" CodeFile="../Aset/Ast_kerosakan_kelulusan.aspx.cs" Inherits="Ast_kerosakan_kelulusan" %>
                           ...
                           <%--  <div class="box-header with-border">
                            ...
                            <div class="col-md-6 box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                                         <asp:TextBox ID="txtnp" runat="server" class="form-control validate[optional,custom[number]] uppercase" ></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                                 </div>
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                                          <div class="input-group">
                                          <asp:TextBox ID="txttarikh" runat="server" class="form-control validate[optional] datepicker mydatepickerclass"></asp:TextBox>
                                              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                             </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:DropDownList style="width:100%; font-size:13px;" runat="server" class="form-control select2 validate[optional]" ID="DropDownList4">
                                                            ...
                                                            <asp:ListItem Value="TL">TIDAK LULUS</asp:ListItem>
                                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                                         <textarea id="Textarea3" runat="server" rows="3" class="form-control uppercase"></textarea>
                                    </div>
                                </div>
                            </div>
                                 </div>
