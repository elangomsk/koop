...
public partial class Ast_penges_terimaan_view : System.Web.UI.Page
{
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddokdicno.Rows.Count != 0)
            {
                ...
                Response.Redirect(string.Format("../Aset/Ast_penges_terimaan.aspx?edit={0}", name));
            }
            else
            {
                Session["validate_success"] = "";
